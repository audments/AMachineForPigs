...
cIconEntityPS::~cIconEntityPS() { DestroyPS(); }
...
cEntityWrapperTypeParticleSystem::cEntityWrapperTypeParticleSystem()
    : iEntityWrapperType(eEditorEntityType_ParticleSystem, _W("Particle System"), "ParticleSystem") {
...
cEntityWrapperDataParticleSystem::cEntityWrapperDataParticleSystem(iEntityWrapperType *apType)
...
void cEntityWrapperParticleSystem::Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
...
iEngineEntity *cEntityWrapperParticleSystem::CreateSpecificEngineEntity() { return hplNew(cIconEntityPS, (this)); }
