...
cEntityWrapperTypeJointSlider::cEntityWrapperTypeJointSlider()
    : iEntityWrapperTypeJoint(eEditorEntityJointType_Slider, "JointSlider") {
...
cEntityWrapperDataJointSlider::cEntityWrapperDataJointSlider(iEntityWrapperType *apType)
    : iEntityWrapperDataJoint(apType) {
    // msName = "SliderJoint";
