...
cEditorWindowOptions::cEditorWindowOptions(iEditorBase *apEditor)
    : iEditorWindowPopUp(apEditor, "Options Window", true, false, false, cVector2f(640, 240)) {}
...
void cEditorWindowOptions::OnInitLayout() {
    ...
    cWidgetTabFrame *pFrame =
        mpSet->CreateWidgetTabFrame(cVector3f(10, 35, 0.1f), mpWindow->GetSize() - cVector2f(20, 45), _W(""), mpWindow);
    ...
    // General options
    {
        ...
        // Resolution
        mpInpResolution = CreateInputVec2(vPos - cVector3f(0, 3, 0), _W("Resolution"), "", pTab, 50, lstLabels,
    ...
    mpInpCamPlanes = CreateInputVec2(vPos, _W("Camera Clip Planes:"), "", pTab, 50, lstPlaneLabels,
                                     eEditorInputLayoutStyle_RowLabelOnLeft, 1);
...
void cEditorWindowOptions::PostInitLayout() { OnUpdate(0); }
