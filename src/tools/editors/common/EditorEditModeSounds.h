...
class cEditorEditModeSounds : public iEditorEditModeObjectCreator {
  public:
    cEditorEditModeSounds(iEditorBase *apEditor, iEditorWorld *apEditorWorld);

    // void DrawObjectPreview(cEditorWindowViewport* apViewport, cRendererCallbackFunctions *apFunctions, const
    // cVector3f& avPos){}
