...
cEditorEditModeSounds::cEditorEditModeSounds(iEditorBase *apEditor, iEditorWorld *apEditorWorld)
    : iEditorEditModeObjectCreator(apEditor, "Sounds", apEditorWorld) {}
...
void cEditorEditModeSounds::CreateTypes() { mvTypes.push_back(hplNew(cEntityWrapperTypeSound, ())); }

//-----------------------------------------------------------------

iEditorWindow *cEditorEditModeSounds::CreateSpecificWindow() { return hplNew(cEditorWindowSounds, (this)); }
