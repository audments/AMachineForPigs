...
cEditorEditModeLights::cEditorEditModeLights(iEditorBase *apEditor, iEditorWorld *apEditorWorld)
    : iEditorEditModeObjectCreator(apEditor, "Lights", apEditorWorld) {
...
void cEditorEditModeLights::DrawObjectPreview(cEditorWindowViewport *apViewport,
...
void cEditorEditModeLights::OnSetSubType(int alX) { mpCurrentCreator = mvShapeCreators[alX]; }

//-----------------------------------------------------------------

iEditorWindow *cEditorEditModeLights::CreateSpecificWindow() { return hplNew(cEditorWindowLights, (this)); }
