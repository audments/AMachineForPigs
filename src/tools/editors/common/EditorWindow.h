...
class iEditorWindow : public iWidgetContainer {
  public:
    ...
    ////////////////////////////////////////////
    // Editor Inputs
    cEditorInputBool *CreateInputBool(const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                                      iWidget *apParent = NULL);
    cEditorInputText *CreateInputString(const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                                        iWidget *apParent = NULL, float afBoxWidth = 100);
    cEditorInputFile *CreateInputFile(const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                                      iWidget *apParent = NULL, float afBoxWidth = 75);
    cEditorInputNumber *CreateInputNumber(const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                                          iWidget *apParent = NULL, float afBoxWidth = 50, float afNumericAdd = 0);
    cEditorInputEnum *CreateInputEnum(const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                                      const tWStringList &alstValues, iWidget *apParent = NULL, float afBoxWidth = 100);
    cEditorInputVec2 *CreateInputVec2(const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                                      iWidget *apParent = NULL, float afBoxWidth = 50,
    ...
    cEditorInputVec3 *CreateInputVec3(const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                                      iWidget *apParent = NULL, float afBoxWidth = 50,
                                      const tWStringList &alstLabels = tWStringList(),
                                      eEditorInputLayoutStyle aStyle = eEditorInputLayoutStyle_RowLabelOnTop,
                                      float afNumericAdd = 0);
    // cEditorInputColor* CreateInputColor(const cVector3f& avPos, const tWString& asLabel, const tString& asName,
    // iWidget* apParent=NULL, float afBoxWidth=50);
    cEditorInputColorFrame *CreateInputColorFrame(const cVector3f &avPos, const tWString &asLabel,
...
class iEditorWindowPopUp : public iEditorWindow {
  public:
    iEditorWindowPopUp(iEditorBase *apEditor, const tString &asName, bool abGetEditorAttention = true,
                       bool abGetGuiAttention = false, bool abDestroyOnDisable = false,
                       const cVector2f &avSize = cVector2f(800, 600));
