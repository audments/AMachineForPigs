...
class cEditorActionSelectionTranslate : public iEditorActionWorldModifier {
  public:
    cEditorActionSelectionTranslate(cEditorEditModeSelect *apEditMode, const cVector3f &avTranslate, bool abUseSnap);
...
class cEditorActionSelectionRotate : public iEditorActionWorldModifier {
  public:
    cEditorActionSelectionRotate(cEditorEditModeSelect *apEditMode, iEditorWorld *apEditorWorld,
                                 const cVector3f &avRotate, bool abUseSnap, bool abRelativeTransform = true);
...
class cEditorActionSelectionScale : public iEditorActionWorldModifier {
  public:
    cEditorActionSelectionScale(cEditorEditModeSelect *apEditMode, iEditorWorld *apEditorWorld,
