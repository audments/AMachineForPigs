...
cEditorWindowEntityEditBoxBillboard::cEditorWindowEntityEditBoxBillboard(cEditorEditModeSelect *apEditMode,
                                                                         cEntityWrapperBillboard *apBillboard)
    : cEditorWindowEntityEditBox(apEditMode, apBillboard) {
...
void cEditorWindowEntityEditBoxBillboard::AddPropertySetBillboard(cWidgetTab *apParentTab) {
    ...
    mpInpSize = CreateInputVec2(vPos, _W("Size"), "", apParentTab, 50, tWStringList(),
    ...
    mpBConnectLight = mpSet->CreateWidgetButton(vPos + cVector3f(mpInpConnectedLight->GetSize().x + 5, 12, 0),
                                                cVector2f(50, 20), _W("Connect"), apParentTab);
    ...
    mpInpHaloSourceSize = CreateInputVec3(vPos, _W("Halo Source Size"), "", apParentTab, 50, tWStringList(),
...
bool cEditorWindowEntityEditBoxBillboard::WindowSpecificInputCallback(iEditorInput *apInput) {
    ...
    if (apInput == mpInpMaterial) {
        ...
        // pAction = mpEntity->CreateSetPropertyActionString(eBillboardStr_ConnectedLight,
        // cString::To8Char(mpInpConnectedLight->GetValue()));
        ...
        pAction =
            mpEntity->CreateSetPropertyActionVector3f(eBillboardVec3f_HaloSourceSize, mpInpHaloSourceSize->GetValue());
    }
