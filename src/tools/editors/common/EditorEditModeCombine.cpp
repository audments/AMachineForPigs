...
void cEditorEditModeCombine::OnEditorUpdate(float afTimeStep) {
    ...
    if (bRayPicking) {
        ...
        if (pPick)
            mlstEntsToBePicked.push_back(pPick);
    } else if (mbPressed) {
...
void cEditorEditModeCombine::DrawPostGrid(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
...
iEditorWindow *cEditorEditModeCombine::CreateSpecificWindow() { return hplNew(cEditorWindowCombine, (this)); }

//-------------------------------------------------------------

void cEditorEditModeCombine::DoRayPicking(cLevelEditorStaticObjectCombo *apCombo, cEditorWindowViewport *apViewport,
...
void cEditorEditModeCombine::DoBoxPicking(cLevelEditorStaticObjectCombo *apCombo, cEditorWindowViewport *apViewport,
                                          cEntityPicker *apPicker) {
...
iEditorAction *cEditorEditModeCombine::CreateProperAction(cLevelEditorStaticObjectCombo *apCombo, iEntityWrapper *apObj,
