...
cEditorWindowEntityEditBoxCompound::cEditorWindowEntityEditBoxCompound(cEditorEditModeSelect *apEditMode,
                                                                       cEntityWrapperCompoundObject *apObject)
...
bool cEditorWindowEntityEditBoxCompound::InputCallback(iWidget *apWidget, const cGuiMessageData &aData) { return true; }
