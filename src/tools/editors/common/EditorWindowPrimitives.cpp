...
cEditorWindowPrimitives::cEditorWindowPrimitives(cEditorEditModePrimitives *apEditMode)
...
void cEditorWindowPrimitives::Reset() { ResetInputs(); }
...
cVector3f cEditorWindowPrimitives::GetTileAmount() { return mpInputTileAmount->GetValue(); }

//-------------------------------------------------------------------

cVector3f cEditorWindowPrimitives::GetTileOffset() { return mpInputTileOffset->GetValue(); }

//-------------------------------------------------------------------

float cEditorWindowPrimitives::GetTextureAngle() { return mpInpTextureAngle->GetValue(); }

//-------------------------------------------------------------------

bool cEditorWindowPrimitives::GetAlignToWorld() { return mpInputAlignToWorld->GetValue(); }

//-------------------------------------------------------------------

bool cEditorWindowPrimitives::GetCollides() { return mpInpCollides->GetValue(); }

bool cEditorWindowPrimitives::GetCastShadows() { return mpInputCastShadows->GetValue(); }
