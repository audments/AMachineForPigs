...
cVector3f iEditorAxisAlignedPlane::mvPlaneNormals[3] = {cVector3f(1, 0, 0), cVector3f(0, 1, 0), cVector3f(0, 0, 1)};

tWString iEditorAxisAlignedPlane::mvPlaneStrings[3] = {_W("YZ"), _W("XZ"), _W("XY")};
...
float iEditorAxisAlignedPlane::GetHeight() { return mvHeights.v[mNormal]; }
...
const cVector3f &iEditorAxisAlignedPlane::GetHeights() { return mvHeights; }

const tWString &iEditorAxisAlignedPlane::GetPlaneString() { return mvPlaneStrings[mNormal]; }
