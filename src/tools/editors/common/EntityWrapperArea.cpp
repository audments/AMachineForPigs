...
cEntityWrapperTypeArea::cEntityWrapperTypeArea(cEditorUserClassSubType *apType)
    : iEntityWrapperTypeUserDefinedEntity(eEditorEntityType_Area, _W("Area"), "Area", apType) {
...
tString cEntityWrapperTypeArea::ToString() { return iEntityWrapperType::ToString() + " " + GetAreaType(); }
...
iEntityWrapperData *cEntityWrapperTypeArea::CreateSpecificData() { return hplNew(cEntityWrapperDataArea, (this)); }

//------------------------------------------------------------------------------

iEntityWrapper *cEntityWrapperDataArea::CreateSpecificEntity() { return hplNew(cEntityWrapperArea, (this)); }

//------------------------------------------------------------------------------
//------------------------------------------------------------------------------

cEntityWrapperDataArea::cEntityWrapperDataArea(iEntityWrapperType *apType)
    : iEntityWrapperDataUserDefinedEntity(apType, eUserClassDefinition_Area) {
...
void cEntityWrapperArea::UpdateEntity() {
    ...
    if (mpMesh) {
        cMatrixf mtxRT = cMath::MatrixMul(mmtxTranslate, mmtxRotate);
...
const tString &cEntityWrapperArea::GetAreaType() { return ((cEntityWrapperTypeArea *)mpType)->GetAreaType(); }
...
void cEntityWrapperArea::Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
    ...
    cMatrixf mtxRT =
        cMath::MatrixMul(cMath::MatrixTranslate(mvPosition), cMath::MatrixRotate(mvRotation, eEulerRotationOrder_XYZ));
