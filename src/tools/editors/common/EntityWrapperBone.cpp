...
iEntityWrapperData *cEntityWrapperTypeBone::CreateSpecificData() { return hplNew(cEntityWrapperDataBone, (this)); }

cEntityWrapperDataBone::cEntityWrapperDataBone(iEntityWrapperType *apType) : iEntityWrapperData(apType) {}

//----------------------------------------------------------------------

iEntityWrapper *cEntityWrapperDataBone::CreateSpecificEntity() { return hplNew(cEntityWrapperBone, (this)); }
...
bool cEntityWrapperBone::CheckRayIntersect(cEditorWindowViewport *apViewport, cVector3f *apPos,
...
void cEntityWrapperBone::DrawBone(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
...
void cEntityWrapperBone::CreateLinkToParent() {
    ...
    mpVBBone = pMesh->GetSubMesh(0)->GetVertexBuffer()->CreateCopy(
        eVertexBufferType_Hardware, eVertexBufferUsageType_Dynamic,
        eVertexElementFlag_Normal | eVertexElementFlag_Position | eVertexElementFlag_Color0 |
            eVertexElementFlag_Texture0);
    ...
    mpVBBone->Transform(
        cMath::MatrixMul(cMath::MatrixTranslate(mvPosition),
                         cMath::MatrixMul(mtxRotation, cMath::MatrixTranslate(cVector3f(0, -fLength * 0.5f, 0)))));
