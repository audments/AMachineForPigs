...
iEntityWrapperTypePrimitive::iEntityWrapperTypePrimitive(const tString &asElementString, int alSubType)
    : iEntityWrapperType(eEditorEntityType_Primitive, _W("Primitive"), asElementString) {
    mlSubType = alSubType;
...
void iEntityWrapperPrimitive::SetCollides(bool abX) { mbCollides = abX; }
//------------------------------------------------------------------------

void iEntityWrapperPrimitive::SetIsOccluder(bool abX) { mbIsOccluder = abX; }

//------------------------------------------------------------------------

bool iEntityWrapperPrimitive::IsAffectedByDecal(bool abAffectsStaticObject, bool abAffectsPrimitive,
