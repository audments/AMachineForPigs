...
iEntityWrapperData *cEntityWrapperTypeSound::CreateSpecificData() { return hplNew(cEntityWrapperDataSound, (this)); }
...
iEntityWrapper *cEntityWrapperDataSound::CreateSpecificEntity() { return hplNew(cEntityWrapperSound, (this)); }
...
cEntityWrapperSound::cEntityWrapperSound(iEntityWrapperData *apData)
...
cEntityWrapperSound::~cEntityWrapperSound() {
    if (mpSoundEntityData) {
        cSoundEntityManager *pManager =
            GetEditorWorld()->GetEditor()->GetEngine()->GetResources()->GetSoundEntityManager();
...
cEntityIcon *cEntityWrapperSound::CreateIcon() { return hplNew(cEntityIcon, (this, "Sound")); }
...
void cEntityWrapperSound::Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
...
void cEntityWrapperSound::SaveToElement(cXmlElement* apElement)
{
    ...
    apElement->SetAttributeString("SoundEntityFile",
mpEditorWorld->GetEditor()->GetFilePathRelativeToWorkingDir(msSoundEntityFile));
