...
cEntityWrapperTypeJointHinge::cEntityWrapperTypeJointHinge()
    : iEntityWrapperTypeJoint(eEditorEntityJointType_Hinge, "JointHinge") {
...
cEntityWrapperDataJointHinge::cEntityWrapperDataJointHinge(iEntityWrapperType *apType)
