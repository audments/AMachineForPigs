...
class iEntityWrapperTypeLight : public iEntityWrapperType {
  ...
  public:
    iEntityWrapperTypeLight(const tString &asElementString, int alSubType)
        : iEntityWrapperType(eEditorEntityType_Light, _W("Light"), asElementString), mlSubType(alSubType) {
...
class iEntityWrapperLight : public iEntityWrapper {
  ...
  protected:
    ...
    ///////////////////////////
    // To be implemented
    virtual void DrawLightTypeSpecific(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
                                       iEditorEditMode *apEditMode, bool abIsSelectedc) = 0;
