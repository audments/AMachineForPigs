...
cEditorActionLightSetIntProperty::cEditorActionLightSetIntProperty(int alID,
                                                                   ...
                                                                   int alX) :
iEditorActionObjectSetProperty<cEntityWrapperLight,int>("Set light int prop", apEditorWorld, alID, aProp, alX,
FetchOldValue(apEditorWorld, alID, aProp))
{
}
...
cEditorActionLightSetStringProperty::cEditorActionLightSetStringProperty(iEditorWorld *apEditorWorld, int alID,
    ...
    : iEditorActionWorldModifier("Set Light string", apEditorWorld) {
...
cEditorActionLightSetFloatProperty::cEditorActionLightSetFloatProperty(iEditorWorld *apEditorWorld, int alID,
                                                                       eLightFloatProperty aType, float afNewValue,
                                                                       float afNewValueExt)
    : iEditorActionWorldModifier("Set light float property", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
    mlID = alID;
    mPropertyType = aType;
...
void cEditorActionLightSetFloatProperty::DoModify() { Apply(mfNewValue, mfNewValueExt); }

void cEditorActionLightSetFloatProperty::UndoModify() { Apply(mfOldValue, mfOldValueExt); }
...
cEditorActionLightSetColorProperty::cEditorActionLightSetColorProperty(iEditorWorld *apEditorWorld, int alID,
                                                                       eLightColorProperty aType, cColor acolNewValue)
    : iEditorActionWorldModifier("Set Light color", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
    mlID = alID;
    mPropertyType = aType;
...
cEditorActionLightSetBoolProperty::cEditorActionLightSetBoolProperty(iEditorWorld *apEditorWorld, int alID,
                                                                     eLightBoolProperty aType, bool abNewValue)
    : iEditorActionWorldModifier("Set light bool property", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
    mlID = alID;
    mPropertyType = aType;
...
cEditorActionLightBoxSetSizeProperty::cEditorActionLightBoxSetSizeProperty(iEditorWorld *apEditorWorld, int alID,
    ...
    : iEditorActionWorldModifier("Set box light size", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
    mlID = alID;
...
cEditorActionLightBoxSetBlendFuncProperty::cEditorActionLightBoxSetBlendFuncProperty(iEditorWorld *apEditorWorld,
                                                                                     int alID, eLightBoxBlendFunc aFunc)
    : iEditorActionWorldModifier("Set box light blend function", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
    mlID = alID;
    mNewValue = aFunc;
...
cEditorActionLightSpotSetFloatProperty::cEditorActionLightSpotSetFloatProperty(iEditorWorld *apEditorWorld, int alID,
                                                                               ...
                                                                               float afNewValue)
    : iEditorActionWorldModifier("Set Spotlight float property", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
    mlID = alID;
    mPropertyType = aType;
    mfNewValue = afNewValue;
