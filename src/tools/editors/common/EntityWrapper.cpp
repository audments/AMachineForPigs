...
tVertexVec iEntityWrapper::mvArrowQuads[4] = {tVertexVec(4), tVertexVec(4), tVertexVec(4), tVertexVec(4)};
...
iPropVal::iPropVal(iProp *apProp) { mpProp = apProp; }
...
iPropVal *cPropInt::CreateValue() { return hplNew(cPropValInt, (this)); }
...
void cPropValInt::GetFromEntity(iEntityWrapper *apEnt) { apEnt->GetProperty(mpProp->GetID(), mlVal); }

void cPropValInt::SetToEntity(iEntityWrapper *apEnt) { apEnt->SetProperty(mpProp->GetID(), mlVal); }

void cPropValInt::Load(cXmlElement *apElement) { mlVal = apElement->GetAttributeInt(mpProp->GetName(), mlVal); }

void cPropValInt::SaveSpecific(cXmlElement *apElement) { apElement->SetAttributeInt(mpProp->GetName(), mlVal); }
...
iPropVal *cPropFloat::CreateValue() { return hplNew(cPropValFloat, (this)); }
...
void cPropValFloat::GetFromEntity(iEntityWrapper *apEnt) { apEnt->GetProperty(mpProp->GetID(), mfVal); }

void cPropValFloat::SetToEntity(iEntityWrapper *apEnt) { apEnt->SetProperty(mpProp->GetID(), mfVal); }

void cPropValFloat::Load(cXmlElement *apElement) { mfVal = apElement->GetAttributeFloat(mpProp->GetName(), mfVal); }

void cPropValFloat::SaveSpecific(cXmlElement *apElement) { apElement->SetAttributeFloat(mpProp->GetName(), mfVal); }
...
iPropVal *cPropBool::CreateValue() { return hplNew(cPropValBool, (this)); }
...
void cPropValBool::GetFromEntity(iEntityWrapper *apEnt) { apEnt->GetProperty(mpProp->GetID(), mbVal); }

void cPropValBool::SetToEntity(iEntityWrapper *apEnt) { apEnt->SetProperty(mpProp->GetID(), mbVal); }

void cPropValBool::Load(cXmlElement *apElement) { mbVal = apElement->GetAttributeBool(mpProp->GetName(), mbVal); }

void cPropValBool::SaveSpecific(cXmlElement *apElement) { apElement->SetAttributeBool(mpProp->GetName(), mbVal); }
...
iPropVal *cPropStr::CreateValue() { return hplNew(cPropValStr, (this)); }
...
void cPropValStr::GetFromEntity(iEntityWrapper *apEnt) { apEnt->GetProperty(mpProp->GetID(), msVal); }

void cPropValStr::SetToEntity(iEntityWrapper *apEnt) { apEnt->SetProperty(mpProp->GetID(), msVal); }

void cPropValStr::Load(cXmlElement *apElement) { msVal = apElement->GetAttributeString(mpProp->GetName(), msVal); }

void cPropValStr::SaveSpecific(cXmlElement *apElement) { apElement->SetAttributeString(mpProp->GetName(), msVal); }
...
iPropVal *cPropVec2f::CreateValue() { return hplNew(cPropValVec2f, (this)); }
...
void cPropValVec2f::GetFromEntity(iEntityWrapper *apEnt) { apEnt->GetProperty(mpProp->GetID(), mvVal); }

void cPropValVec2f::SetToEntity(iEntityWrapper *apEnt) { apEnt->SetProperty(mpProp->GetID(), mvVal); }

void cPropValVec2f::Load(cXmlElement *apElement) { mvVal = apElement->GetAttributeVector2f(mpProp->GetName(), mvVal); }

void cPropValVec2f::SaveSpecific(cXmlElement *apElement) { apElement->SetAttributeVector2f(mpProp->GetName(), mvVal); }
...
iPropVal *cPropVec3f::CreateValue() { return hplNew(cPropValVec3f, (this)); }
...
void cPropValVec3f::GetFromEntity(iEntityWrapper *apEnt) { apEnt->GetProperty(mpProp->GetID(), mvVal); }

void cPropValVec3f::SetToEntity(iEntityWrapper *apEnt) { apEnt->SetProperty(mpProp->GetID(), mvVal); }

void cPropValVec3f::Load(cXmlElement *apElement) { mvVal = apElement->GetAttributeVector3f(mpProp->GetName(), mvVal); }

void cPropValVec3f::SaveSpecific(cXmlElement *apElement) { apElement->SetAttributeVector3f(mpProp->GetName(), mvVal); }
...
iPropVal *cPropCol::CreateValue() { return hplNew(cPropValCol, (this)); }
...
void cPropValCol::GetFromEntity(iEntityWrapper *apEnt) { apEnt->GetProperty(mpProp->GetID(), mVal); }

void cPropValCol::SetToEntity(iEntityWrapper *apEnt) { apEnt->SetProperty(mpProp->GetID(), mVal); }

void cPropValCol::Load(cXmlElement *apElement) { mVal = apElement->GetAttributeColor(mpProp->GetName(), mVal); }

void cPropValCol::SaveSpecific(cXmlElement *apElement) { apElement->SetAttributeColor(mpProp->GetName(), mVal); }
...
tString iEntityWrapperType::ToString() { return cString::To8Char(GetName()) + " <" + GetXmlElementName() + ">"; }

//------------------------------------------------------------------

bool iEntityWrapperType::IsAppropriateType(cXmlElement *apElement) { return msXmlElementName == apElement->GetValue(); }

bool iEntityWrapperType::IsAppropriateDefaultType(cXmlElement *apElement) { return false; }
...
cPropInt *iEntityWrapperType::GetPropInt(int alID) { return (cPropInt *)GetPropByTypeAndID(eVariableType_Int, alID); }
...
void iEntityWrapperType::AddFloat(int alPropID, const tString &asName, float afDefault, ePropCopyStep aStep,
                                  bool abSave) {
...
void iEntityWrapperType::AddBool(int alPropID, const tString &asName, bool abDefault, ePropCopyStep aStep,
                                 bool abSave) {
...
void iEntityWrapperType::AddString(int alPropID, const tString &asName, const tString &asDefault, ePropCopyStep aStep,
                                   bool abSave) {
...
void iEntityWrapperType::AddVec2f(int alPropID, const tString &asName, const cVector2f &avDefault, ePropCopyStep aStep,
                                  bool abSave) {
...
void iEntityWrapperType::AddVec3f(int alPropID, const tString &asName, const cVector3f &avDefault, ePropCopyStep aStep,
                                  bool abSave) {
    AddProperty(hplNew(cPropVec3f, (alPropID, asName, avDefault, abSave)), aStep);
}

void iEntityWrapperType::AddColor(int alPropID, const tString &asName, const cColor &aDefault, ePropCopyStep aStep,
                                  bool abSave) {
...
void iEntityWrapperType::AddProperty(iProp *apProp, ePropCopyStep aStep) { mvProperties[aStep].push_back(apProp); }
...
void iEntityWrapperData::AddValue(ePropCopyStep aX, iPropVal *apVal) { mvValues[aX].push_back(apVal); }
...
int iEntityWrapperData::GetID() { return GetInt(eObjInt_ID); }

const tString &iEntityWrapperData::GetName() { return GetString(eObjStr_Name); }

void iEntityWrapperData::SetID(int alX) { SetInt(eObjInt_ID, alX); }

void iEntityWrapperData::SetName(const tString &asX) { SetString(eObjStr_Name, asX); }
...
bool iEntityWrapper::Create() {
    ...
    mpIcon = CreateIcon();
    if (CreateEngineEntity() == false && mpIcon == NULL && mpEngineEntity == NULL &&
        mpType->AllowNullEngineEntity() == false) {
...
iEditorWorld *iEntityWrapper::GetEditorWorld() { return mpType->GetWorld(); }
...
void iEntityWrapper::SetWorldMatrix(const cMatrixf &amtxX) {
    ...
    cVector3f vScale = cVector3f(1.0f / mtxInvMatrix.GetRight().Length(), 1.0f / mtxInvMatrix.GetUp().Length(),
...
void iEntityWrapper::Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
                          iEditorEditMode *apEditMode, bool abIsSelected, const cColor &aHighlightCol,
                          const cColor &aDisabledCol) {
    if (mpIcon)
        mpIcon->DrawIcon(apViewport, apFunctions, apEditMode, mbSelected, mvPosition, mbActive && mpType->IsActive(),
                         aDisabledCol);
    if (mpEngineEntity)
...
void iEntityWrapper::DrawProgram(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
                                 iGpuProgram *apProg, const cColor &aCol) {
    if (mpEngineEntity)
...
bool iEntityWrapper::IsVisible() { return mpType->IsVisible() && mbCulledByPlane == false && mbVisible; }
...
bool iEntityWrapper::EntitySpecificFilterCheck(bool abPassAll, bool abPassType) { return abPassAll || abPassType; }
...
cRect2l iEntityWrapper::GetClipRectangle(cEditorWindowViewport *apViewport) {
    ...
    cRect2l clipRect;
    cMath::GetClipRectFromBV(clipRect, *(mpEngineEntity->GetPickBV(apViewport)), pFrustum,
                             apViewport->GetGuiViewportSizeInt(), pFrustum->GetFOV() * 0.5f);
...
bool iEntityWrapper::CheckRayIntersect(cEditorWindowViewport *apViewport, cVector3f *apPos, tVector3fVec *apTriangle,
                                       float *apT) {
    if (mpEngineEntity)
...
iEditorAction *iEntityWrapper::CreateModifyRotationAction(cEditorEditModeSelect *apEditMode,
...
bool iEntityWrapper::IsActive() { return mbActive; }
...
int iEntityWrapper::GetCompoundObjectID() {
    int lCompoundID = -1;
    if (mpCompoundObject)
        lCompoundID = mpCompoundObject->GetID();
...
bool iEntityWrapper::GetProperty(int alPropID, float &afX) { return false; }
...
bool iEntityWrapper::GetProperty(int alPropID, cVector2f &avX) { return false; }
...
bool iEntityWrapper::GetProperty(int alPropID, cColor &aX) { return false; }
...
bool iEntityWrapper::SetProperty(int alPropID, const float &afX) { return false; }
...
bool iEntityWrapper::SetProperty(int alPropID, const cVector2f &avX) { return false; }
...
bool iEntityWrapper::SetProperty(int alPropID, const cColor &aX) { return false; }
...
iEditorAction *iEntityWrapper::CreateSetPropertyActionInt(int alPropID, int alX) {
    ...
    cEditorActionSetInt *pAction = hplNew(cEditorActionSetInt, (GetEditorWorld(), tIntList(1, GetID()), pProp, alX));
...
iEditorAction *iEntityWrapper::CreateSetPropertyActionFloat(int alPropID, float afX) {
    ...
    cEditorActionSetFloat *pAction =
        hplNew(cEditorActionSetFloat, (GetEditorWorld(), tIntList(1, GetID()), pProp, afX));
...
iEditorAction *iEntityWrapper::CreateSetPropertyActionBool(int alPropID, bool abX) {
    ...
    cEditorActionSetBool *pAction = hplNew(cEditorActionSetBool, (GetEditorWorld(), tIntList(1, GetID()), pProp, abX));
    return SetUpAction(pAction);
}
...
iEditorAction *iEntityWrapper::CreateSetPropertyActionString(int alPropID, const tString &asX) {
    ...
    cEditorActionSetString *pAction =
        hplNew(cEditorActionSetString, (GetEditorWorld(), tIntList(1, GetID()), pProp, asX));
    return SetUpAction(pAction);
}
...
iEditorAction *iEntityWrapper::CreateSetPropertyActionVector2f(int alPropID, const cVector2f &avX) {
    ...
    cEditorActionSetVec2f *pAction =
        hplNew(cEditorActionSetVec2f, (GetEditorWorld(), tIntList(1, GetID()), pProp, avX));
    return SetUpAction(pAction);
}
...
iEditorAction *iEntityWrapper::CreateSetPropertyActionVector3f(int alPropID, const cVector3f &avX) {
    ...
    cEditorActionSetVec3f *pAction =
        hplNew(cEditorActionSetVec3f, (GetEditorWorld(), tIntList(1, GetID()), pProp, avX));
    return SetUpAction(pAction);
}
...
iEditorAction *iEntityWrapper::CreateSetPropertyActionColor(int alPropID, const cColor &aX) {
    ...
    cEditorActionSetColor *pAction = hplNew(cEditorActionSetColor, (GetEditorWorld(), tIntList(1, GetID()), pProp, aX));
    return SetUpAction(pAction);
}
...
iEditorAction *iEntityWrapper::SetUpAction(iEditorAction *apAction) {
    if (apAction && apAction->IsValidAction() == false) {
        Error("Entity %s with type %s created invalid action \"%s\"\n", GetName().c_str(),
              GetType()->ToString().c_str(), apAction->GetName().c_str());
        hplDelete(apAction);
        return NULL;
    }
...
void iEntityWrapper::DrawArrow(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
                               const cMatrixf &amtxTransform, float afLength, bool abKeepConstantSize,
                               const cVector2f &avHeadSizeRatio, const cColor &aCol, float afOrthoConstant,
...
iEntityWrapperTypeUserDefinedEntity::iEntityWrapperTypeUserDefinedEntity(int alID, const tWString &asName,
                                                                         const tString &asElementName,
                                                                         cEditorUserClassSubType *apUserType,
                                                                         const tString &asVarElementName)
    : iEntityWrapperType(alID, asName, asElementName) {
...
iEntityWrapperDataUserDefinedEntity::iEntityWrapperDataUserDefinedEntity(iEntityWrapperType *apType, int alDefID)
...
iEditorAction *iEntityWrapperUserDefinedEntity::CreateActionSetUserVariable(const tWString &asName,
                                                                            const tWString &asValue) {
    iEditorAction *pAction =
        hplNew(cEditorActionUserDefinedObjectSetVariable, (GetEditorWorld(), mlID, asName, asValue));
...
iEntityWrapperTypeAggregate::iEntityWrapperTypeAggregate(int alType, const tWString &asName,
                                                         const tString &asElementName,
                                                         const tString &asComponentElementName,
                                                         bool abDestroyComponentsOnDeletion)
    : iEntityWrapperType(alType, asName, asElementName)
...
iEntityWrapperDataAggregate::~iEntityWrapperDataAggregate() { STLDeleteAll(mvComponentsData); }
...
void iEntityWrapperAggregate::OnDestroy() {
    ...
    if (GetEditorWorld()->IsClearingEntities() == false) {
        ...
        for (; it != lstEntities.end(); ++it) {
            iEntityWrapper *pEnt = *it;
            if (pType->GetDestroyComponentsOnDeletion())
                pWorld->DestroyEntityWrapper(pEnt);
            else
                RemoveComponent(pEnt);
        }
    }
}
...
bool iEntityWrapperAggregate::IsCulledByFrustum(cCamera *apCamera) { return false; }

bool iEntityWrapperAggregate::CheckRayIntersect(cEditorWindowViewport *apViewport, cVector3f *apPos,
                                                tVector3fVec *apTriangle, float *apT) {
    ////////////////////////////////////////////////////
...
bool iEntityWrapperAggregate::Check2DBoxIntersect(cEditorWindowViewport *apViewport, const cRect2l &aBox,
                                                  cVector3f *apPos) {
    ////////////////////////////////////////////////////
    // Check intersection against all component shapes
    bool bIntersect = false;
...
/*
void iEntityWrapperAggregate::Draw(cEditorWindowViewport* apViewport, cRendererCallbackFunctions* apFunctions,
