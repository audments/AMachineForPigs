...
cEditorActionSubMeshAttachBody::cEditorActionSubMeshAttachBody(int alID, iEditorWorld *apEditorWorld, int alBodyID)
    : iEditorActionWorldModifier("Attach body", apEditorWorld) {
    mlID = alID;
