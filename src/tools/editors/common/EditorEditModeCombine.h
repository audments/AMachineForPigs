...
class cEditorEditModeCombine : public iEditorEditMode {
  ...
  protected:
     ...
     */
    void DoRayPicking(cLevelEditorStaticObjectCombo *apCombo, cEditorWindowViewport *apViewport,
                      cEntityPicker *apPicker);
    void DoBoxPicking(cLevelEditorStaticObjectCombo *apCombo, cEditorWindowViewport *apViewport,
                      cEntityPicker *apPicker);

    /**
     * Create an action according to pick mode
     */
    iEditorAction *CreateProperAction(cLevelEditorStaticObjectCombo *apCombo, iEntityWrapper *apObj,
