...
class iProp {
  public:
    iProp(int alID, eVariableType aType, const tString &asName, bool abSave)
        : mlID(alID), mType(aType), msName(asName), mbSave(abSave) {}
...
class cPropInt : public iProp {
  public:
    cPropInt(int alID, const tString &asName, int alX, bool abSave = true)
        : iProp(alID, eVariableType_Int, asName, abSave), mlVal(alX) {}
...
class cPropFloat : public iProp {
  public:
    cPropFloat(int alID, const tString &asName, float afX, bool abSave = true)
        : iProp(alID, eVariableType_Float, asName, abSave), mfVal(afX) {}
...
class cPropBool : public iProp {
  public:
    cPropBool(int alID, const tString &asName, bool abX, bool abSave = true)
        : iProp(alID, eVariableType_Bool, asName, abSave), mbVal(abX) {}
...
class cPropStr : public iProp {
  public:
    cPropStr(int alID, const tString &asName, const tString &asX, bool abSave = true)
        : iProp(alID, eVariableType_String, asName, abSave), msVal(asX) {}
...
class cPropVec2f : public iProp {
  public:
    cPropVec2f(int alID, const tString &asName, const cVector2f &avX, bool abSave = true)
        : iProp(alID, eVariableType_Vec2, asName, abSave), mvVal(avX) {}
...
class cPropVec3f : public iProp {
  public:
    cPropVec3f(int alID, const tString &asName, const cVector3f &avX, bool abSave = true)
        : iProp(alID, eVariableType_Vec3, asName, abSave), mvVal(avX) {}
...
class cPropCol : public iProp {
  public:
    cPropCol(int alID, const tString &asName, const cColor &aX, bool abSave = true)
        : iProp(alID, eVariableType_Color, asName, abSave), mVal(aX) {}
...
class iEntityWrapperType {
  ...
  protected:
    ...
    void AddInt(int, const tString &, int alDefault = -1, ePropCopyStep aStep = ePropCopyStep_PostEnt,
                bool abSave = true);
    void AddFloat(int, const tString &, float afDefault = 0.0f, ePropCopyStep aStep = ePropCopyStep_PostEnt,
                  bool abSave = true);
    void AddBool(int, const tString &, bool abDefault = true, ePropCopyStep aStep = ePropCopyStep_PostEnt,
                 bool abSave = true);
    void AddString(int, const tString &, const tString &asDefault = "", ePropCopyStep aStep = ePropCopyStep_PostEnt,
                   bool abSave = true);
    void AddVec2f(int, const tString &, const cVector2f &avDefault = 0, ePropCopyStep aStep = ePropCopyStep_PostEnt,
                  bool abSave = true);
    void AddVec3f(int, const tString &, const cVector3f &avDefault = 0, ePropCopyStep aStep = ePropCopyStep_PostEnt,
                  bool abSave = true);
    void AddColor(int, const tString &, const cColor &aDefault = cColor(1), ePropCopyStep aStep = ePropCopyStep_PostEnt,
                  bool abSave = true);
...
class iEntityWrapper {
  ...
  public:
    ...
    virtual bool IsAffectedByDecal(bool abAffectsStaticObject, bool abAffectsPrimitive, bool abAffectsEntity) {
        return false;
    }
    ...
    virtual bool CheckRayIntersect(cEditorWindowViewport *apViewport, cVector3f *apPos, tVector3fVec *apTriangle,
                                   float *apT = NULL);
    ...
    virtual cEditorWindowEntityEditBoxGroup *CreateGroupAllSameTypeEditBox(cEditorEditModeSelect *apEditMode,
    ...
    virtual int GetFileIndexForType(int alTypeID) {
        if (alTypeID == GetTypeID())
            return GetFileIndex();
        else
            return -1;
    }
    ...
    virtual void Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
                      iEditorEditMode *apEditMode, bool abIsSelected, const cColor &aHighlightCol = cColor(1, 1),
                      const cColor &aDisabledCol = cColor(0.5f, 1));
    virtual void DrawProgram(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
  ...
  protected:
     ...
     */
    void DrawArrow(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
                   const cMatrixf &amtxTransform, float afLength, bool abKeepConstantSize,
                   const cVector2f &avHeadSizeRatio, const cColor &aCol, float afOrthoConstant = 0.1f,
                   float afPerspConstant = 4);
...
class iEntityWrapperTypeUserDefinedEntity : public iEntityWrapperType {
  public:
    iEntityWrapperTypeUserDefinedEntity(int, const tWString &, const tString &, cEditorUserClassSubType *,
                                        const tString &asUserVarElement = "UserVariables");
...
class iEntityWrapperTypeAggregate : public iEntityWrapperType {
  public:
    iEntityWrapperTypeAggregate(int alType, const tWString &asName, const tString &asElementName,
                                const tString &asComponentElementName, bool abDestroyComponentsOnDeletion = true);
...
class iEntityWrapperAggregate : public iEntityWrapper {
  public:
    ...
    // void Draw(cEditorWindowViewport* apViewport, cRendererCallbackFunctions* apFunctions, iEditorEditMode*
    // apEditMode, bool abIsSelected); cEditorWindowEntityEditBox* CreateEditBox(cEditorEditModeSelect* apEditMode);
