...
cEditorWindowEntityEditBoxBone::cEditorWindowEntityEditBoxBone(cEditorEditModeSelect *apEditMode,
                                                               cEntityWrapperBone *apObject)
...
void cEditorWindowEntityEditBoxBone::OnUpdate(float afTimeStep) { cEditorWindowEntityEditBox::OnUpdate(afTimeStep); }
