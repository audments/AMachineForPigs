...
cEntityWrapperTypeJointScrew::cEntityWrapperTypeJointScrew()
    : iEntityWrapperTypeJoint(eEditorEntityJointType_Screw, "JointScrew") {
...
cEntityWrapperDataJointScrew::cEntityWrapperDataJointScrew(iEntityWrapperType *apType)
