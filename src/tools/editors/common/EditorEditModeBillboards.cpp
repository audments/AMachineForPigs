...
cEditorEditModeBillboards::cEditorEditModeBillboards(iEditorBase *apEditor, iEditorWorld *apEditorWorld)
    : iEditorEditModeObjectCreator(apEditor, "Billboards", apEditorWorld) {}
...
void cEditorEditModeBillboards::CreateTypes() { mvTypes.push_back(hplNew(cEntityWrapperTypeBillboard, ())); }
//-----------------------------------------------------------------

iEditorWindow *cEditorEditModeBillboards::CreateSpecificWindow() { return hplNew(cEditorWindowBillboards, (this)); }
