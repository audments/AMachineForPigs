...
iEntityWrapperTypeJoint::iEntityWrapperTypeJoint(eEditorEntityJointType aSubType, const tString &asElementName)
    : iEntityWrapperType(eEditorEntityType_Joint, _W("Joint"), asElementName) {
    mJointType = aSubType;
...
int iEntityWrapperJoint::GetJointType() { return ((iEntityWrapperTypeJoint *)mpType)->GetJointType(); }
...
bool iEntityWrapperJoint::GetProperty(int alPropID, float &afX) {
    ...
    case eJointFloat_MinMoveFreqSpeed:
        afX = GetMinMoveFreqSpeed();
        break;
    case eJointFloat_MinMoveVolume:
        afX = GetMinMoveVolume();
        break;
...
bool iEntityWrapperJoint::GetProperty(int alPropID, bool &abX) {
    ...
    case eJointBool_CollideBodies:
        abX = GetCollideBodies();
        break;
    case eJointBool_StickyMinLimit:
        abX = GetStickyMinLimit();
        break;
    case eJointBool_StickyMaxLimit:
        abX = GetStickyMaxLimit();
        break;
...
bool iEntityWrapperJoint::GetProperty(int alPropID, tString &asX) {
    ...
    case eJointStr_MinLimitSound:
        asX = GetMinLimitSound();
        break;
    case eJointStr_MaxLimitSound:
        asX = GetMaxLimitSound();
        break;
...
bool iEntityWrapperJoint::SetProperty(int alPropID, const float &afX) {
    ...
    case eJointFloat_MinMoveFreq:
        ...
        break;
    case eJointFloat_MinMoveFreqSpeed:
        SetMinMoveFreqSpeed(afX);
        break;
    case eJointFloat_MinMoveVolume:
        SetMinMoveVolume(afX);
        break;
    case eJointFloat_MaxMoveSpeed:
        SetMaxMoveSpeed(afX);
        break;
    case eJointFloat_MaxMoveFreq:
        ...
        break;
    case eJointFloat_MaxMoveFreqSpeed:
        SetMaxMoveFreqSpeed(afX);
        break;
    case eJointFloat_MaxMoveVolume:
        SetMaxMoveVolume(afX);
        break;
    case eJointFloat_MiddleMoveSpeed:
        SetMiddleMoveSpeed(afX);
        break;
    case eJointFloat_MiddleMoveVolume:
        SetMiddleMoveVolume(afX);
        break;
    case eJointFloat_MinLimitMinSpeed:
        SetMinLimitMinSpeed(afX);
        break;
    case eJointFloat_MinLimitMaxSpeed:
        SetMinLimitMaxSpeed(afX);
        break;
    case eJointFloat_MaxLimitMinSpeed:
        SetMaxLimitMinSpeed(afX);
        break;
    case eJointFloat_MaxLimitMaxSpeed:
        SetMaxLimitMaxSpeed(afX);
        break;
    case eJointFloat_BreakForce:
        SetBreakForce(afX);
        break;
...
bool iEntityWrapperJoint::SetProperty(int alPropID, const bool &abX) {
    switch (alPropID) {
    case eJointBool_CollideBodies:
        SetCollideBodies(abX);
        break;
    case eJointBool_StickyMinLimit:
        SetStickyMinLimit(abX);
        break;
    case eJointBool_StickyMaxLimit:
        SetStickyMaxLimit(abX);
        break;
    case eJointBool_Breakable:
        SetBreakable(abX);
        break;
...
bool iEntityWrapperJoint::SetProperty(int alPropID, const tString &asX) {
    ...
    case eJointStr_MoveType:
        ...
        break;
    case eJointStr_MinLimitSound:
        SetMinLimitSound(asX);
        break;
    case eJointStr_MaxLimitSound:
        SetMaxLimitSound(asX);
        break;
    case eJointStr_BreakSound:
        SetBreakSound(asX);
        break;
...
void iEntityWrapperJoint::Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
...
cEntityIcon *iEntityWrapperJoint::CreateIcon() { return hplNew(cEntityIcon, (this, mpType->GetXmlElementName())); }
