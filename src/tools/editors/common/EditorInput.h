...
class iEditorInput : public iWidgetContainer {
  public:
    iEditorInput(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                 iWidget *apParent = NULL, eEditorInputLayoutStyle aStyle = eEditorInputLayoutStyle_ColumnLabelOnTop);
...
class iEditorInputLabeled : public iEditorInput {
  public:
    iEditorInputLabeled(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
...
class cEditorInputBool : public iEditorInput {
  public:
    cEditorInputBool(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                     iWidget *apParent = NULL);
...
class cEditorInputText : public iEditorInputLabeled {
  public:
    cEditorInputText(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                     float afTextBoxWidth, int alAmount, bool abNumeric, float afNumericAdd = 0,
                     iWidget *apParent = NULL, const tWStringList &alstLabels = tWStringList());
...
class cEditorInputNumber : public cEditorInputText {
  public:
    cEditorInputNumber(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                       float afTextBoxWidth, iWidget *apParent = NULL, float afNumericAdd = 0)
        : cEditorInputText(apWindow, avPos, asLabel, asName, afTextBoxWidth, 1, true, afNumericAdd, apParent) {}
...
class cEditorInputVec2 : public cEditorInputText {
  public:
    cEditorInputVec2(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                     float afTextBoxWidth, const tWStringList &alstLabels = tWStringList(), iWidget *apParent = NULL,
                     float afNumericAdd = 0)
        : cEditorInputText(apWindow, avPos, asLabel, asName, afTextBoxWidth, 2, true, afNumericAdd, apParent,
                           alstLabels) {}
...
class cEditorInputVec3 : public cEditorInputText {
  public:
    cEditorInputVec3(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                     float afTextBoxWidth, const tWStringList &alstLabels = tWStringList(), iWidget *apParent = NULL,
                     float afNumericAdd = 0)
        : cEditorInputText(apWindow, avPos, asLabel, asName, afTextBoxWidth, 3, true, afNumericAdd, apParent,
                           alstLabels) {}
...
class cEditorInputFile : public cEditorInputText {
  public:
    cEditorInputFile(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                     float afTextBoxWidth, iWidget *apParent = NULL);
...
class cEditorInputEnum : public iEditorInputLabeled {
  public:
    cEditorInputEnum(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel, const tString &asName,
                     float afComboBoxWidth, iWidget *apParent = NULL);
...
class cEditorInputColorFrame : public iEditorInputLabeled {
  public:
    cEditorInputColorFrame(iEditorWindow *apWindow, const cVector3f &avPos, const tWString &asLabel,
                           const tString &asName, iWidget *apParent = NULL);
