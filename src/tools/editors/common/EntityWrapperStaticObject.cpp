...
cEntityWrapperDataStaticObject::cEntityWrapperDataStaticObject(iEntityWrapperType *apType)
...
bool cEntityWrapperStaticObject::IsAffectedByDecal(bool abAffectsStaticObject, bool abAffectsPrimitive,
