...
cEditorWindowEntityEditBoxBodyShape::cEditorWindowEntityEditBoxBodyShape(cEditorEditModeSelect *apEditMode,
                                                                         cEntityWrapperBodyShape *apObject)
...
bool cEditorWindowEntityEditBoxBodyShape::Button_OnPressed(iWidget *apWidget, const cGuiMessageData &aData) {
    ...
    if (apWidget == mvButtons[0]) {
        ...
        /*
        cEntityWrapperDataBody* pData =
        (cEntityWrapperDataBody*)pWorld->GetEntityTypeByID(eEditorEntityType_Body)->CreateData();
