...
cEntityWrapperTypePrimitivePlane::cEntityWrapperTypePrimitivePlane()
    : iEntityWrapperTypePrimitive("Plane", eEditorPrimitiveType_Plane) {
...
cEntityWrapperDataPrimitivePlane::cEntityWrapperDataPrimitivePlane(iEntityWrapperType *apType)
...
bool cEntityWrapperDataPrimitivePlane::Load(cXmlElement *apElement) {
    ...
    cVector3f vEnd = (GetVec3f(ePrimitivePlaneVec3f_EndCorner) - GetVec3f(ePrimitivePlaneVec3f_StartCorner)) *
                     GetVec3f(eObjVec3f_Scale);
...
cEntityWrapperPrimitivePlane::cEntityWrapperPrimitivePlane(iEntityWrapperData *apData)
    : iEntityWrapperPrimitive(apData) {
    mlNormalAxisIndex = -1;
...
void cEntityWrapperPrimitivePlane::Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
...
cMesh *cEntityWrapperPrimitivePlane::CreatePrimitiveMesh() {
    ...
    cMesh *pMesh = GetEditorWorld()->GetEditor()->GetEngine()->GetGraphics()->GetMeshCreator()->CreatePlane(
        "", 0, vEndCorner, cVector2f(1, 0), 0, cVector2f(0, 1), 1, msMaterial);
