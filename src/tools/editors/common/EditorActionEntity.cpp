...
cEditorActionObjectCreate::cEditorActionObjectCreate(iEditorWorld *apEditorWorld, iEntityWrapperData *apData)
    : iEditorActionWorldModifier("Create", apEditorWorld) {
    mpNewObjectData = apData;
}

cEditorActionObjectCreate::~cEditorActionObjectCreate() { hplDelete(mpNewObjectData); }
...
cEditorActionEntityDelete::cEditorActionEntityDelete(iEditorWorld *apEditorWorld, cEditorSelection *apSelection,
                                                     const tIntList &alstSelectedIDs)
    : iEditorActionWorldModifier("Delete", apEditorWorld) {
...
cEditorActionEntityClone::cEditorActionEntityClone(iEditorWorld *apEditorWorld, cEditorSelection *apSelection,
                                                   const tIntList &alstSelectedIDs)
    : iEditorActionWorldModifier("Clone", apEditorWorld) {
...
cEditorActionEntitySelect::cEditorActionEntitySelect(cEditorEditModeSelect *apEditMode, const tIntList &alstEntityIDs,
                                                     eSelectActionType aType)
    : iEditorAction("Select") {
...
cEditorActionEntityTranslate::cEditorActionEntityTranslate(iEditorWorld *apEditorWorld, tIntList &alstEntityIDs,
                                                           const cVector3f &avTranslate, bool abUseSnap,
                                                           bool abRelativeTransform)
    : iEditorActionWorldModifier("Translate", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
...
cEditorActionEntityRotate::cEditorActionEntityRotate(iEditorWorld *apEditorWorld, tIntList &alstEntityIDs,
                                                     const cVector3f &avRotate, bool abRelativeTransform)
    : iEditorActionWorldModifier("Rotate", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
...
cEditorActionEntityScale::cEditorActionEntityScale(iEditorWorld *apEditorWorld, tIntList &alstEntityIDs,
                                                   const cVector3f &avScale, bool abRelativeTransform)
    : iEditorActionWorldModifier("Scale", apEditorWorld) {
    mpEditorWorld = apEditorWorld;
...
cEditorActionEntityAttachChildren::cEditorActionEntityAttachChildren(iEditorWorld *apEditorWorld, int alID,
                                                                     const tIntList &alstChildIDs)
    : iEditorActionWorldModifier("Attach Children", apEditorWorld) {
    mlID = alID;
...
cEditorActionEntityDetachChildren::cEditorActionEntityDetachChildren(iEditorWorld *apEditorWorld, int alID,
                                                                     tIntList &alstChildIDs)
    : iEditorActionWorldModifier("Detach Children", apEditorWorld) {
    mlID = alID;
