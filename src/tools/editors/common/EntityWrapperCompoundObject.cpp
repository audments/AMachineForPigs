...
cEntityWrapperTypeCompoundObject::cEntityWrapperTypeCompoundObject()
    : iEntityWrapperTypeAggregate(eEditorEntityType_Compound, _W("Compound"), "Compound", "Component") {}
...
cEntityWrapperDataCompoundObject::cEntityWrapperDataCompoundObject(iEntityWrapperType *apType)
    : iEntityWrapperDataAggregate(apType) {}
...
cEntityWrapperCompoundObject::cEntityWrapperCompoundObject(iEntityWrapperData *apData)
...
bool cEntityWrapperCompoundObject::CheckRayIntersect(cEditorWindowViewport* apViewport, cVector3f* apPos, tVector3fVec*
apTriangle, float* apT)
{
    ////////////////////////////////////////////////////
...
bool cEntityWrapperCompoundObject::Check2DBoxIntersect(cEditorWindowViewport* apViewport, const cRect2l& aBox,
cVector3f* apPos)
{
    ////////////////////////////////////////////////////
    // Check intersection against all component shapes
...
void cEntityWrapperCompoundObject::OnAddComponent(iEntityWrapper *apEntity) { apEntity->SetCompoundObject(this); }
...
void cEntityWrapperCompoundObject::Draw(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
