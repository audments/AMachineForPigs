...
class cEditorActionPlaneChangeNormal : public iEditorActionAxisAlignedPlane {
  public:
    cEditorActionPlaneChangeNormal(iEditorAxisAlignedPlane *apPlane, int alNormal);
...
class cEditorActionPlaneChangeHeight : public iEditorActionAxisAlignedPlane {
  public:
    cEditorActionPlaneChangeHeight(iEditorAxisAlignedPlane *apPlane, const cVector3f &avX);
...
class cEditorActionGridChangeSnapSeparation : public iEditorAction {
  public:
    cEditorActionGridChangeSnapSeparation(cEditorGrid *apGrid, float afNewSnapSeparation);
...
class cEditorActionClipPlaneSetCullingOnPositiveSide : public iEditorAction {
  public:
    cEditorActionClipPlaneSetCullingOnPositiveSide(iEditorWorld *apWorld, int alIdx, bool abX);
...
class cEditorActionClipPlaneSetActive : public iEditorAction {
  public:
    cEditorActionClipPlaneSetActive(iEditorWorld *apWorld, int alIdx, bool abActive);
