...
cEditorEditModeSelect *cEditorEditModeFactory::CreateEditModeSelect(iEditorBase *apEditor, iEditorWorld *apEditorWorld,
                                                                    const cVector3f &avEditorWindowPos) {
...
cEditorEditModeLights *cEditorEditModeFactory::CreateEditModeLights(iEditorBase *apEditor, iEditorWorld *apEditorWorld,
                                                                    const cVector3f &avEditorWindowPos) {
...
cEditorEditModeBodies *cEditorEditModeFactory::CreateEditModeBodies(iEditorBase *apEditor, iEditorWorld *apEditorWorld,
                                                                    const cVector3f &avEditorWindowPos) {
...
cEditorEditModeJoints *cEditorEditModeFactory::CreateEditModeJoints(iEditorBase *apEditor, iEditorWorld *apEditorWorld,
                                                                    const cVector3f &avEditorWindowPos) {
...
cEditorEditModeAreas *cEditorEditModeFactory::CreateEditModeAreas(iEditorBase *apEditor, iEditorWorld *apEditorWorld,
                                                                  const cVector3f &avEditorWindowPos) {
...
cEditorEditModeBillboards *cEditorEditModeFactory::CreateEditModeBillboards(iEditorBase *apEditor,
                                                                            iEditorWorld *apEditorWorld,
                                                                            const cVector3f &avEditorWindowPos) {
...
cEditorEditModeSounds *cEditorEditModeFactory::CreateEditModeSounds(iEditorBase *apEditor, iEditorWorld *apEditorWorld,
                                                                    const cVector3f &avEditorWindowPos) {
...
cEditorEditModeParticleSystems *
cEditorEditModeFactory::CreateEditModeParticleSystems(iEditorBase *apEditor, iEditorWorld *apEditorWorld,
                                                      const cVector3f &avEditorWindowPos) {
    //	cEditorWindowParticleSystems* pWindow = cEditorWindowFactory::CreateWindowParticleSystems(apEditor,
    //avEditorWindowPos); 	pWindow->SetActive(false);
