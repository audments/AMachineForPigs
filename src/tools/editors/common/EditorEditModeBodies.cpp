...
cEditorEditModeBodies::cEditorEditModeBodies(iEditorBase *apEditor, iEditorWorld *apEditorWorld)
    : iEditorEditModeObjectCreator(apEditor, "Shapes", apEditorWorld) {}
...
void cEditorEditModeBodies::DrawObjectPreview(cEditorWindowViewport *apViewport,
    ...
    case eEditorBodyShape_Box:
        shapeBV.SetSize(cVector3f(1));
        break;
    case eEditorBodyShape_Sphere:
        shapeBV.SetSize(cVector3f(2)); // diameter = radius*2 = 2
        break;
    case eEditorBodyShape_Cylinder:
        shapeBV.SetSize(cVector3f(2, 1, 2)); // diameter = radius*2 = 2
        break;
...
iEditorWindow *cEditorEditModeBodies::CreateSpecificWindow() { return hplNew(cEditorWindowBodies, (this)); }
