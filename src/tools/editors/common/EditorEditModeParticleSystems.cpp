...
cEditorEditModeParticleSystems::cEditorEditModeParticleSystems(iEditorBase *apEditor, iEditorWorld *apEditorWorld)
    : iEditorEditModeObjectCreator(apEditor, "Particle Systems", apEditorWorld) {}
...
void cEditorEditModeParticleSystems::CreateTypes() { mvTypes.push_back(hplNew(cEntityWrapperTypeParticleSystem, ())); }
