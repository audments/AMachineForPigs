...
cEditorWindowJoints::cEditorWindowJoints(cEditorEditModeJoints *apEditMode)
...
void cEditorWindowJoints::Reset() { ResetInputs(); }
...
void cEditorWindowJoints::OnSetActive(bool abX) { Reset(); }
