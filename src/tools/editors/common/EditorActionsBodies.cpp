...
cEditorActionBodyAddShapes::cEditorActionBodyAddShapes(iEditorWorld *apWorld, int alBodyID,
                                                       const tIntList &alstShapeIDs)
    : iEditorActionAggregateAddComponents(apWorld, alBodyID, alstShapeIDs) {}
...
cEditorActionBodyRemoveShapes::cEditorActionBodyRemoveShapes(iEditorWorld *apEditorWorld,
                                                             const tIntList &alstBodyShapeIDs)
    : iEditorActionAggregateRemoveComponents(apEditorWorld, alstBodyShapeIDs) {
...
//-------------------------------------------------------------
/*
cEditorActionBodyRemoveShapes::cEditorActionBodyRemoveShapes(int alID, iEditorWorld* apEditorWorld, const tIntList&
alstBodyShapeIDs) : iEditorActionWorldModifier("Remove shapes", apEditorWorld)
{
    mlID = alID;
    mlstBodyShapeIDs = alstBodyShapeIDs;
}
