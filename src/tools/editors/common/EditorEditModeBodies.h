...
class cEditorEditModeBodies : public iEditorEditModeObjectCreator {
  public:
    cEditorEditModeBodies(iEditorBase *apEditor, iEditorWorld *apEditorWorld);

    void DrawObjectPreview(cEditorWindowViewport *apViewport, cRendererCallbackFunctions *apFunctions,
                           const cVector3f &avPos, bool abPreCreationActive);
