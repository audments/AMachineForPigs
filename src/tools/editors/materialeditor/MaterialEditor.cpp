...
cMaterialEditor::~cMaterialEditor() { OnSaveConfig(); }
...
void cMaterialEditor::OnInit() { mpEngine->GetPhysics()->LoadSurfaceData("materials.cfg"); }

//--------------------------------------------------------------------

void cMaterialEditor::OnInitLayout() {
    mpMaterialEditor =
        hplNew(cEditorWindowMaterialEditor, (this, NULL, cString::To16Char(msCommandLineFile), NULL, true));
