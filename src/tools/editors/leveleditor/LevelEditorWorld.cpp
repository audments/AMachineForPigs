...
cLevelEditorWorld::~cLevelEditorWorld() { ClearStaticObjectCombos(); }
...
void cLevelEditorWorld::LoadWorldObjects(cXmlElement *apWorldObjectsElement) {
    ...
    cEntityWrapperTypeDecal::SetGlobalMaxTriangles(
        pMapData->GetAttributeInt("GlobalDecalMaxTris", cEntityWrapperTypeDecal::GetGlobalMaxTriangles()));
...
void cLevelEditorWorld::ClearStaticObjectCombos() { STLDeleteAll(mlstStaticObjectCombos); }
...
int cLevelEditorWorld::GetStaticObjectComboNum() { return (int)mlstStaticObjectCombos.size(); }
