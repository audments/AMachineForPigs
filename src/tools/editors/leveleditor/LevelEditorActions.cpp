...
cLevelEditorActionGroupDeselectEntities::cLevelEditorActionGroupDeselectEntities(iEditorBase *apEditor,
                                                                                 unsigned int alID)
...
cLevelEditorActionGroupSetName::cLevelEditorActionGroupSetName(iEditorBase *apEditor, unsigned int alID,
...
void cLevelEditorActionGroupSetName::Do() { ((cLevelEditor *)mpEditor)->GetGroup(mlID).SetName(msNewName); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionGroupSetName::Undo() { ((cLevelEditor *)mpEditor)->GetGroup(mlID).SetName(msOldName); }

//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------

cLevelEditorActionGroupSetVisibility::cLevelEditorActionGroupSetVisibility(iEditorBase *apEditor, unsigned int alID,
                                                                           bool abNewValue)
    : iEditorAction("Add group") {
    mpEditor = apEditor;
...
void cLevelEditorActionSetSkyboxActive::DoModify() { Apply(mbNewValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetSkyboxActive::UndoModify() { Apply(mbOldValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetSkyboxActive::Apply(bool abX) { mpEditorWorld->SetSkyboxActive(abX); }
...
void cLevelEditorActionSetSkyboxTexture::DoModify() { Apply(msNewValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetSkyboxTexture::UndoModify() { Apply(msOldValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetSkyboxTexture::Apply(const tString &asX) { mpEditorWorld->SetSkyboxTexture(asX); }
...
void cLevelEditorActionSetSkyboxColor::DoModify() { Apply(mNewValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetSkyboxColor::UndoModify() { Apply(mOldValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetSkyboxColor::Apply(const cColor &aX) { mpEditorWorld->SetSkyboxColor(aX); }

//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------

cLevelEditorActionSetFogBoolProperty::cLevelEditorActionSetFogBoolProperty(iEditorWorld *apWorld, eFogBoolProp aProp,
                                                                           bool abX)
    : iEditorActionWorldModifier("Set Skybox active", apWorld) {
    mProp = aProp;
...
void cLevelEditorActionSetFogBoolProperty::DoModify() { Apply(mbNewValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetFogBoolProperty::UndoModify() { Apply(mbOldValue); }
...
cLevelEditorActionSetFogFloatProperty::cLevelEditorActionSetFogFloatProperty(iEditorWorld *apWorld, eFogFloatProp aProp,
                                                                             float afX)
...
void cLevelEditorActionSetFogFloatProperty::DoModify() { Apply(mfNewValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetFogFloatProperty::UndoModify() { Apply(mfOldValue); }
...
void cLevelEditorActionSetFogColor::DoModify() { Apply(mNewValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetFogColor::UndoModify() { Apply(mOldValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetFogColor::Apply(const cColor &aX) { mpEditorWorld->SetFogColor(aX); }
...
void cLevelEditorActionSetGlobalMaxDecalTris::DoModify() { Apply(mNewValue); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionSetGlobalMaxDecalTris::UndoModify() { Apply(mOldValue); }
...
cLevelEditorActionRemoveStaticObjectCombo::cLevelEditorActionRemoveStaticObjectCombo(iEditorWorld *apWorld,
                                                                                     int alComboID)
...
cLevelEditorActionAddObjectToCombo::cLevelEditorActionAddObjectToCombo(iEditorWorld *apWorld,
                                                                       cLevelEditorStaticObjectCombo *apCombo,
                                                                       cEntityWrapperStaticObject *apObj)
...
void cLevelEditorActionAddObjectToCombo::DoModify() { Apply(mlOldComboID, mlNewComboID); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionAddObjectToCombo::UndoModify() { Apply(mlNewComboID, mlOldComboID); }
...
cLevelEditorActionRemoveObjectFromCombo::cLevelEditorActionRemoveObjectFromCombo(iEditorWorld *apWorld,
                                                                                 cLevelEditorStaticObjectCombo *apCombo,
                                                                                 cEntityWrapperStaticObject *apObj)
    : iEditorActionWorldModifier("Add object to combo", apWorld) {
    ////////////////////////////////////////////////////////////
...
cLevelEditorActionComboSetColor::cLevelEditorActionComboSetColor(iEditorWorld *apWorld, int alComboID,
                                                                 const cColor &aCol)
...
void cLevelEditorActionComboSetColor::DoModify() { Apply(mNewColor); }

//--------------------------------------------------------------------------------------

void cLevelEditorActionComboSetColor::UndoModify() { Apply(mOldColor); }
