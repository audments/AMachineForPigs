...
cLevelEditorStaticObjectCombo::cLevelEditorStaticObjectCombo(cLevelEditorWorld *apWorld, int alComboID) {
    ...
    mpDrawProg = mpWorld->GetEditor()->GetEngine()->GetGraphics()->CreateGpuProgramFromShaders(
        "ComboDrawProg", "flat_color_vtx.glsl", "flat_color_frag.glsl", &vars);
...
iEditorAction *cLevelEditorStaticObjectCombo::CreateActionAddObject(iEntityWrapper *apObj) {
    if (IsValidObject(apObj) == false || HasObject((cEntityWrapperStaticObject *)apObj))
        return NULL;

    iEditorAction *pAction =
        hplNew(cLevelEditorActionAddObjectToCombo, (mpWorld, this, (cEntityWrapperStaticObject *)apObj));
...
iEditorAction *cLevelEditorStaticObjectCombo::CreateActionRemoveObject(iEntityWrapper *apObj) {
    ...
    iEditorAction *pAction =
        hplNew(cLevelEditorActionRemoveObjectFromCombo, (mpWorld, this, (cEntityWrapperStaticObject *)apObj));
...
bool cLevelEditorStaticObjectCombo::IsValidObject(iEntityWrapper *apObj) {
    return apObj != NULL &&
           (apObj->GetTypeID() == eEditorEntityType_StaticObject || apObj->GetTypeID() == eEditorEntityType_Primitive);
}
