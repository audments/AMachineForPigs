...
enum eFogFloatProp { eFogFloatProp_Start, eFogFloatProp_End, eFogFloatProp_FalloffExp };
...
class cLevelEditorActionAddObjectToCombo : public iEditorActionWorldModifier {
  public:
    cLevelEditorActionAddObjectToCombo(iEditorWorld *apWorld, cLevelEditorStaticObjectCombo *apCombo,
...
class cLevelEditorActionRemoveObjectFromCombo : public iEditorActionWorldModifier {
  public:
    cLevelEditorActionRemoveObjectFromCombo(iEditorWorld *apWorld, cLevelEditorStaticObjectCombo *apCombo,
                                            cEntityWrapperStaticObject *apObj);
