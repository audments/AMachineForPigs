...
cParticleEditor::~cParticleEditor() { OnSaveConfig(); }
...
bool cParticleEditor::MainMenu_ItemClick(iWidget *apWidget, const cGuiMessageData &aData) {
    ...
    else if (apWidget == mpMISetColor[0] || apWidget == mpMISetColor[1] || apWidget == mpMISetColor[2]) {
...
iEditorWorld *cParticleEditor::CreateSpecificWorld() { return hplNew(cParticleEditorWorld, (this)); }
