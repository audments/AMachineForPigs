...
cParticleEditorWorld::~cParticleEditorWorld() { mpEditor->GetEngine()->GetResources()->DestroyXmlDocument(mpTestData); }
...
cColor cParticleEditorWorld::GetBGColor() { return mpWorld->GetSkyBoxColor(); }
