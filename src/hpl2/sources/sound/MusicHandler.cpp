...
void cMusicHandler::Lock(cMusicLock *apLock) { mpLock = apLock; }

//-----------------------------------------------------------------------

void cMusicHandler::UnLock() { mpLock = NULL; }
...
cMusicEntry *cMusicHandler::GetCurrentSong() { return mpMainSong; }
...
void cMusicHandler::ResetResumeData() { STLDeleteAll(mlstResumeEntries); }
