...
cPhysicsJointBallNewton::cPhysicsJointBallNewton(const tString &asName, iPhysicsBody *apParentBody,
...
cVector3f cPhysicsJointBallNewton::GetVelocity() { return cVector3f(0, 0, 0); }
...
float cPhysicsJointBallNewton::GetDistance() { return 0; }
float cPhysicsJointBallNewton::GetAngle() { return 0; }
