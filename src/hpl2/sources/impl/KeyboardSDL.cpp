...
bool cKeyboardSDL::KeyIsDown(eKey aKey) { return mvKeyArray[aKey]; }
...
bool cKeyboardSDL::KeyIsPressed() { return mlstKeysPressed.empty() == false; }
...
bool cKeyboardSDL::KeyIsReleased() { return mlstKeysReleased.empty() == false; }
...
void cKeyboardSDL::ClearKeyList() { mvKeyArray.assign(mvKeyArray.size(), false); }
