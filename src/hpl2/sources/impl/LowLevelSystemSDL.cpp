...
void SetLogFile(const tWString &asFile) { gLogWriter.SetFileName(asFile); }
...
void SetUpdateLogFile(const tWString &asFile) { gUpdateLogWriter.SetFileName(asFile); }
...
extern void SetLogOutputOverrideFunction(tLogOutputOverrideFunction apFunc) { gpOutputOverrideFunc = apFunc; }
