...
void cOpenALSoundChannel::Play() {
    // Log("Playing %s - Source %d Ref %d\n",mpData->GetName().c_str(), mlChannel & 0xFFF, (mlChannel & 0x7ffff000) >>
    // 12);
...
void cOpenALSoundChannel::Set3D(bool ab3D) { mb3D = ab3D; }
...
void cOpenALSoundChannel::SetMinDistance(float afMin) { mfMinDistance = afMin; }

//-----------------------------------------------------------------------

void cOpenALSoundChannel::SetMaxDistance(float afMax) { mfMaxDistance = afMax; }
//-----------------------------------------------------------------------

bool cOpenALSoundChannel::IsPlaying() { return OAL_Source_IsPlaying(mlChannel); }

//-----------------------------------------------------------------------

bool cOpenALSoundChannel::IsBufferUnderrun() { return OAL_Source_IsBufferUnderrun(mlChannel); }
double cOpenALSoundChannel::GetElapsedTime() { return OAL_Source_GetElapsedTime(mlChannel); }
double cOpenALSoundChannel::GetTotalTime() { return OAL_Source_GetTotalTime(mlChannel); }
...
int cOpenALSoundChannel::GetPriority() { return OAL_Source_GetPriority(mlChannel); }
