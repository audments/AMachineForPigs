...
cPhysicsJointHingeNewton::cPhysicsJointHingeNewton(const tString &asName, iPhysicsBody *apParentBody,
...
void cPhysicsJointHingeNewton::SetMaxAngle(float afAngle) { mfMaxAngle = afAngle; }
void cPhysicsJointHingeNewton::SetMinAngle(float afAngle) { mfMinAngle = afAngle; }
float cPhysicsJointHingeNewton::GetMaxAngle() { return mfMaxAngle; }
float cPhysicsJointHingeNewton::GetMinAngle() { return mfMinAngle; }

//-----------------------------------------------------------------------

cVector3f cPhysicsJointHingeNewton::GetVelocity() { return cVector3f(0, 0, 0); }
...
float cPhysicsJointHingeNewton::GetDistance() { return 0; }
    ...
    if (mfMinAngle != 0 || mfMaxAngle != 0) {
        ...
        // Max
            ...
            if (mpParentBody == NULL || mpParentBody->GetMass() == 0) {
                if (bSkipLimitCheck == false && ((mbStickyMaxLimit && mfPreviousAngle > mfMaxAngle) ||
