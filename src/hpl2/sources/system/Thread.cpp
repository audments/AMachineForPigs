...
void iThread::SetUpdateRate(float afUpdateRate) { SetSleepTime(cMath::RoundToInt(1000.0f / afUpdateRate)); }

//-----------------------------------------------------------------------

void iThread::SetPriority(eThreadPrio aPrio) { mPrio = aPrio; }
