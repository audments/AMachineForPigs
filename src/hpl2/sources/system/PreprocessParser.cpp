...
void cParserVarContainer::Add(const tString &asName, int alVal) { Add(asName, cString::ToString(alVal)); }
...
void cParserVarContainer::Clear() { m_mapVars.clear(); }
...
cParserSymbolText *iParserSymbol::ToText() { return static_cast<cParserSymbolText *>(this); }

cParserSymbolKeyword *iParserSymbol::ToKeyword() { return static_cast<cParserSymbolKeyword *>(this); }

cParserSymbolOperator *iParserSymbol::ToOperator() { return static_cast<cParserSymbolOperator *>(this); }

cParserSymbolVariable *iParserSymbol::ToVariable() { return static_cast<cParserSymbolVariable *>(this); }
...
cPreprocessParser::~cPreprocessParser() { STLDeleteAll(mlstSymbols); }
...
bool cPreprocessParser::Parse(const tString *apInput, tString *apOutput, cParserVarContainer *apVarContainer,
...
bool cPreprocessParser::VariableExists(const tString &asName) { return GetVar(asName) != NULL; }
...
bool cPreprocessParser::EndOfSymbols() { return mSymbolIt == mlstSymbols.end(); }
        ...
        if (cPlatform::FileExists(sPath)) {
            ...
            *mpCurrentOutput += sFileData;
            ...
            Error("Parser failed: Could not find include file '%s' in path: '%s' at line %d!\n", sFile.c_str(),
                  cString::To8Char(sPath).c_str(), apKeyword->mlRow);
            return false;
        }
