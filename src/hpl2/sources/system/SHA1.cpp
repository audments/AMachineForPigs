...
void SHA1::Input(const tString &message) { Input((const unsigned char *)message.data(), message.length()); }

void SHA1::Input(const tWString &message) { Input(cString::To8Char(message)); }
...
SHA1 &SHA1::operator<<(SHA1 &(*__mf)(SHA1 &)) { return __mf(*this); }
