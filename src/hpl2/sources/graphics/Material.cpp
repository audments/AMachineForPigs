...
void cMaterial::SetTexture(eMaterialTexture aType, iTexture *apTexture) { mvTextures[aType] = apTexture; }

//-----------------------------------------------------------------------

iTexture *cMaterial::GetTexture(eMaterialTexture aType) { return mvTextures[aType]; }
