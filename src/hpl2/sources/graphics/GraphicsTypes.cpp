...
cVideoMode::cVideoMode(const cVector2l &avScreenSize, int alBitsPerPixel, int alRefreshRate)
    : mvScreenSize(avScreenSize), mlBitsPerPixel(alBitsPerPixel), mlRefreshRate(alRefreshRate), mlDisplay(0),
      mbCustom(false) {}

cVideoMode::cVideoMode(int alDisplay, const cVector2l &avScreenSize, int alBitsPerPixel, int alRefreshRate)
    : mvScreenSize(avScreenSize), mlBitsPerPixel(alBitsPerPixel), mlRefreshRate(alRefreshRate), mlDisplay(alDisplay),
      mbCustom(false) {}

cVideoMode::cVideoMode(const cVector2l &avScreenSize)
    : mvScreenSize(avScreenSize), mlBitsPerPixel(-1), mlRefreshRate(-1), mlDisplay(0), mbCustom(true) {}

cVideoMode::cVideoMode()
    : mvScreenSize(cVector2l(-1, -1)), mlBitsPerPixel(-1), mlRefreshRate(-1), mlDisplay(0), mbCustom(true) {}
