...
const cMatrixf &cBone::GetLocalTransformUnscaled() { return m_mtxTransformUnscaled; }
...
const cMatrixf &cBone::GetLocalTransform() { return m_mtxTransform; }
...
cBoneIterator cBone::GetChildIterator() { return cBoneIterator(&mlstChildren); }
