...
bool cRendererSimple::LoadData() {
    ...
    mpFlatProgram = mpGraphics->CreateGpuProgramFromShaders("DiffuseShader", "deferred_base_vtx.glsl",
    ...
    mpDiffuseProgram = mpGraphics->CreateGpuProgramFromShaders("DiffuseShader", "deferred_base_vtx.glsl",
                                                               "deferred_base_frag.glsl", &programVars);
...
void cRendererSimple::SetupRenderList() {
    ...
    mpCurrentRenderList->Compile(eRenderListCompileFlag_Z | eRenderListCompileFlag_Diffuse |
                                 eRenderListCompileFlag_Decal | eRenderListCompileFlag_Translucent);
}
...
void cRendererSimple::RenderObjects() {
    ...
    // Diffuse Objects
    {
        SetDepthTestFunc(eDepthTestFunc_Equal); // Setting equal here so that alpha works. It only draws on pixel that
                                                // he Z prepass drew to.
        SetDepthWrite(false);
