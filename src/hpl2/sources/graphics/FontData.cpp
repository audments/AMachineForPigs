...
void iFontData::GetWordWrapRows(float afLength, float afFontHeight, cVector2f avSize, const tWString &asString,
...
void iFontData::AddGlyph(cGlyph *apGlyph) { mvGlyphs.push_back(apGlyph); }
