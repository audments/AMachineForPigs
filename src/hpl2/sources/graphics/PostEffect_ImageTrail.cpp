...
cPostEffectType_ImageTrail::cPostEffectType_ImageTrail(cGraphics *apGraphics, cResources *apResources)
    ...
    mpProgram = mpGraphics->CreateGpuProgramFromShaders("ImageTrail", "deferred_base_vtx.glsl",
                                                        "posteffect_image_trail_frag.glsl", &vars);
    if (mpProgram) {
...
void cPostEffect_ImageTrail::Reset() { mbClearFrameBuffer = true; }
