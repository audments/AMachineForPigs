...
cPostEffectType_ColorGrading::cPostEffectType_ColorGrading(cGraphics *apGraphics, cResources *apResources)
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        mpProgram[i] =
            mpGraphics->CreateGpuProgramFromShaders("ColorGrading" + cString::ToString(i), "deferred_base_vtx.glsl",
...
cPostEffect_ColorGrading::cPostEffect_ColorGrading(cGraphics *apGraphics, cResources *apResources,
