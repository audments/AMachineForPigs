...
void iMaterialType::AddVar(const tString &asName, eVariableType aType, const tString &asDefaultValue,
                           const tString &asDesc, const tStringVec &avEnumValues) {
...
void iMaterialType::AddVarVec2(const tString &asName, const cVector2f &avDefaultValue, const tString &asDesc) {
    tString sValue =
        cString::ToString(avDefaultValue.x, -1, true) + " " + cString::ToString(avDefaultValue.y, -1, true);
...
void iMaterialType::AddVarColor(const tString &asName, const cColor &aDefaultValue, const tString &asDesc) {
    tString sValue = cString::ToString(aDefaultValue.r, -1, true) + " " + cString::ToString(aDefaultValue.g, -1, true) +
...
void iMaterialType::AddVarEnum(const tString &asName, const tString &asDefaultValue, const tStringVec &avEnumValues,
