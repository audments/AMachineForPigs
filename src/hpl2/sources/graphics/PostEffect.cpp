...
iTexture *iPostEffect::Render(cPostEffectComposite *apComposite, iTexture *apInputTexture,
                              iFrameBuffer *apFinalTempBuffer, bool abLastEffect) {
    ///////////////////////////
...
void iPostEffect::DrawQuad(const cVector3f &avPos, const cVector2f &avSize, iTexture *apTexture, bool abFlipY) {
    ...
    mpCurrentComposite->DrawQuad(avPos, avSize, cVector2f(vUvPos.x, (vTexSize.y - vUvSize.y) - vUvPos.y),
                                 cVector2f(vUvPos.x + vUvSize.x, vTexSize.y - vUvPos.y), abFlipY);
}
...
void iPostEffect::DrawQuad(const cVector3f &avPos, const cVector2f &avSize, iTexture *apTexture0, iTexture *apTexture1,
    ...
    mpCurrentComposite->DrawQuad(cVector2f(0, 0), 1, vTexMin[0], vTexMax[0], vTexMin[1], vTexMax[1], abFlipY0,
                                 abFlipY1);
}
