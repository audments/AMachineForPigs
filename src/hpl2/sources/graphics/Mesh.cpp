...
cMesh::cMesh(const tString &asName, const tWString &asFullPath, cMaterialManager *apMaterialManager,
...
bool cMesh::CreateFromFile(const tString asFile) { return false; }
...
int cMesh::GetSubMeshNum() { return (int)mvSubMeshes.size(); }
...
void cMesh::SetSkeleton(cSkeleton *apSkeleton) { mpSkeleton = apSkeleton; }

cSkeleton *cMesh::GetSkeleton() { return mpSkeleton; }
//-----------------------------------------------------------------------
...
cAnimation *cMesh::GetAnimation(int alIndex) { return mvAnimations[alIndex]; }
...
int cMesh::GetAnimationNum() { return (int)mvAnimations.size(); }
...
cNode3D *cMesh::GetRootNode() { return mpRootNode; }

void cMesh::AddNode(cNode3D *apNode) { mvNodes.push_back(apNode); }

int cMesh::GetNodeNum() { return (int)mvNodes.size(); }
...
cNode3D *cMesh::GetNode(int alIdx) { return mvNodes[alIdx]; }
