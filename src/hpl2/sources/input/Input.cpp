...
iKeyboard *cInput::GetKeyboard() { return mpKeyboard; }

//-----------------------------------------------------------------------

iMouse *cInput::GetMouse() { return mpMouse; }
...
int cInput::GetGamepadNum() { return (int)mlstGamepads.size(); }
...
void cInput::AppDeviceWasPlugged() { RefreshGamepads(); }

void cInput::AppDeviceWasRemoved() { RefreshGamepads(); }

//-----------------------------------------------------------------------

bool cInput::isQuitMessagePosted() { return mpLowLevelInput->isQuitMessagePosted(); }

void cInput::resetQuitMessagePosted() { mpLowLevelInput->resetQuitMessagePosted(); }
