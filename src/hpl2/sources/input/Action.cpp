...
void iSubAction::Update(float afTimeStep) { UpdateLogic(afTimeStep); }
...
cAction::~cAction() { STLDeleteAll(mvSubActions); }
...
void cAction::AddKey(eKey aKey) { AddSubAction(hplNew(cActionKeyboard, (mpInput, aKey))); }

void cAction::AddMouseButton(eMouseButton aButton) { AddSubAction(hplNew(cActionMouseButton, (mpInput, aButton))); }
...
void cAction::AddGamepadAxis(int alPadIndex, eGamepadAxis aAxis, eGamepadAxisRange aRange, float afMinThreshold,
...
void cAction::AddSubAction(iSubAction *apSubAction) { mvSubActions.push_back(apSubAction); }

//-----------------------------------------------------------------------

void cAction::ClearSubActions() { STLDeleteAll(mvSubActions); }

//-----------------------------------------------------------------------

bool cAction::IsTriggerd() { return mbIsDown; }
