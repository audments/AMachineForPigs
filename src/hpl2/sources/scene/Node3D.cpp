...
void cNode3D::ClearEntities() { mlstEntity.clear(); }

//-----------------------------------------------------------------------

cNode3DIterator cNode3D::GetChildIterator() { return cNode3DIterator(&mlstNode); }

cEntity3DIterator cNode3D::GetEntityIterator() { return cEntity3DIterator(&mlstEntity); }
...
cVector3f cNode3D::GetLocalPosition() { return m_mtxLocalTransform.GetTranslation(); }

//-----------------------------------------------------------------------

cMatrixf &cNode3D::GetLocalMatrix() { return m_mtxLocalTransform; }
...
const tString &cNode3D::GetName() { return msName; }

//-----------------------------------------------------------------------

cNode3D *cNode3D::GetParent() { return mpParent; }
...
void cNode3D::AddChild(cNode3D *apChild) { mlstNode.push_back(apChild); }
...
void cNode3D::AddRotation(const cQuaternion &aqRotation) { mqRotation = cMath::QuaternionMul(aqRotation, mqRotation); }

void cNode3D::AddScale(const cVector3f &avScale) { mvScale *= avScale; }

void cNode3D::AddTranslation(const cVector3f &avTrans) { mvTranslation += avTrans; }
