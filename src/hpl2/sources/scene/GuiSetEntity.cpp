...
cGuiSetEntity::cGuiSetEntity(const tString asName, cGuiSet *apSet) : iRenderable(asName) {
    mpGuiSet = apSet;
...
int cGuiSetEntity::GetMatrixUpdateCount() { return GetTransformUpdateCount(); }
