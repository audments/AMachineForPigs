...
cParticleSystemData::~cParticleSystemData() { STLDeleteAll(mvEmitterData); }

//-----------------------------------------------------------------------

void cParticleSystemData::AddEmitterData(iParticleEmitterData *apData) { mvEmitterData.push_back(apData); }
...
cParticleSystem::cParticleSystem(const tString asName, cParticleSystemData *apData, cResources *apResources,
...
iParticleEmitter *cParticleSystem::GetEmitter(int alIdx) { return mvEmitters[alIdx]; }

//-----------------------------------------------------------------------

int cParticleSystem::GetEmitterNum() { return (int)mvEmitters.size(); }
