...
cViewport::~cViewport() { hplDelete(mpRenderSettings); }
...
void cViewport::AddGuiSet(cGuiSet *apSet) { mlstGuiSets.push_back(apSet); }
void cViewport::RemoveGuiSet(cGuiSet *apSet) { STLFindAndRemove(mlstGuiSets, apSet); }
cGuiSetListIterator cViewport::GetGuiSetIterator() { return cGuiSetListIterator(&mlstGuiSets); }

//-----------------------------------------------------------------------

void cViewport::AddViewportCallback(iViewportCallback *apCallback) { mlstCallbacks.push_back(apCallback); }

void cViewport::RemoveViewportCallback(iViewportCallback *apCallback) { STLFindAndRemove(mlstCallbacks, apCallback); }
...
void cViewport::AddRendererCallback(iRendererCallback *apCallback) { mlstRendererCallbacks.push_back(apCallback); }
