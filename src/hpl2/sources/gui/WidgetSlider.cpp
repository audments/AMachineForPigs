...
void cWidgetSlider::SetButtonValueAdd(int alAdd) { mlButtonValueAdd = alAdd; }

void cWidgetSlider::SetBarClickValueAdd(int alAdd) { mlBarClickValueAdd = alAdd; }
...
void cWidgetSlider::OnChangePosition() { UpdateBarProperties(); }
...
bool cWidgetSlider::OnMouseEnter(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool cWidgetSlider::OnMouseLeave(const cGuiMessageData &aData) { return false; }

bool cWidgetSlider::OnMouseDoubleClick(const cGuiMessageData &aData) { return false; }
...
bool cWidgetSlider::OnUIArrowRelease(const cGuiMessageData &aData) { return true; }

//-----------------------------------------------------------------------

bool cWidgetSlider::OnUIButtonPress(const cGuiMessageData &aData) { return false; }

bool cWidgetSlider::OnUIButtonRelease(const cGuiMessageData &aData) { return false; }
