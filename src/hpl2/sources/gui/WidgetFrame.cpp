...
void cWidgetFrame::OnAttachChild(iWidget *apChild) { mbScrollBarsNeedUpdate = true; }

//-----------------------------------------------------------------------

void cWidgetFrame::OnRemoveChild(iWidget *apChild) { mbScrollBarsNeedUpdate = true; }
...
void cWidgetFrame::OnChildUpdate(iWidget *apChild) { mbScrollBarsNeedUpdate = true; }
...
bool cWidgetFrame::OnMouseMove(const cGuiMessageData &aData) { return true; }
...
bool cWidgetFrame::OnMouseUp(const cGuiMessageData &aData) { return true; }

//-----------------------------------------------------------------------

bool cWidgetFrame::OnMouseEnter(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool cWidgetFrame::OnMouseLeave(const cGuiMessageData &aData) { return false; }
