...
void cWidgetContextMenu::AddSeparator() { AddMenuItem(_W("")); }
...
void cWidgetContextMenu::SavePrevAttentionWidget() { mpPrevAttention = mpSet->GetAttentionWidget(); }
...
void cWidgetContextMenu::UpdateMenuWidth(float afItemTextWidth) {
    ...
    float fNonTextWidth = mfItemHPadding + mfItemCheckIconSize + mfItemTextLeftPadding + mfItemTextRightPadding +
                          mfItemArrowIconSize + mfItemHPadding;
...
void cWidgetContextMenu::OnChildMenuHide() { mpSet->SetFocusedWidget(this); }
...
bool cWidgetContextMenu::OnMouseEnter(const cGuiMessageData &aData) { return true; }
