...
int iWidgetListBoxBase::GetMultiSelectionNum() { return (int)mlstSelectedItems.size(); }
//-----------------------------------------------------------------------
...
cVector3f iWidgetListBoxBase::GetItemStartPos() { return GetGlobalPosition() + cVector3f(0, 2, 0.01f); }
...
void iWidgetListBoxBase::AddItemToSelection(cWidgetItem *apItem) { mlstSelectedItems.push_back(apItem->GetIndex()); }
...
void iWidgetListBoxBase::OnDraw(float afTimeStep, cGuiClipRegion *apClipRegion) {
    ...
    DrawBordersAndCorners(NULL, mvGfxBorders, mvGfxCorners,
                          GetGlobalPosition() -
                              cVector3f(mvGfxCorners[0]->GetActiveSize().x, mvGfxCorners[0]->GetActiveSize().y, 0),
...
bool iWidgetListBoxBase::OnMouseMove(const cGuiMessageData &aData) { return true; }
...
bool iWidgetListBoxBase::OnMouseUp(const cGuiMessageData &aData) { return true; }
...
bool iWidgetListBoxBase::OnMouseEnter(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool iWidgetListBoxBase::OnMouseLeave(const cGuiMessageData &aData) { return false; }
...
bool iWidgetListBoxBase::OnUIArrowRelease(const cGuiMessageData &aData) { return false; }
...
bool iWidgetListBoxBase::OnUIButtonRelease(const cGuiMessageData &aData) { return HasFocus(); }
