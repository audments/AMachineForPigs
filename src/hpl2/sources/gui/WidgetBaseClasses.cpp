...
cWidgetItem::~cWidgetItem() { STLDeleteAll(mvProperties); }
...
int cWidgetItem::GetPropertyNum() { return (int)mvProperties.size(); }
...
void cWidgetItem::SetText(const tWString &asText) { msText = asText; }
...
iWidgetItemContainer::~iWidgetItemContainer() { STLDeleteAll(mvItems); }

//-----------------------------------------------------------------------

cWidgetItem *iWidgetItemContainer::AddItem(const tString &asText) { return AddItem(cString::To16Char(asText)); }
...
cWidgetItem *iWidgetItemContainer::AddItem() { return AddItem(_W("")); }
...
int iWidgetItemContainer::GetItemNum() const { return (int)mvItems.size(); }
...
bool iWidgetItemContainer::HasItem(const tString &asItem) { return HasItem(cString::To16Char(asItem)); }
...
iFileBrowser::~iFileBrowser() { STLDeleteAll(mvCategories); }
 ...
 */
bool iFileBrowser::NavigateUp() { return NavigateTo(_W("..")); }
