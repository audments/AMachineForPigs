...
bool cWidgetImage::OnMouseMove(const cGuiMessageData &aData) { return true; }
...
bool cWidgetImage::OnMouseEnter(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool cWidgetImage::OnMouseLeave(const cGuiMessageData &aData) { return false; }
