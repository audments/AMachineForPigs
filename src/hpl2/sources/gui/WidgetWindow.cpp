...
void cWidgetWindow::SetDrawLabel(bool abX) { mbDrawLabel = abX; }
...
void cWidgetWindow::OnDraw(float afTimeStep, cGuiClipRegion *apClipRegion) {
    ...
    DrawSkinText(msText, eGuiSkinFont_WindowLabel,
                 GetGlobalPosition() + cVector3f(mvGfxCorners[0]->GetActiveSize().x + mvLabelTextOffset.x,
...
bool cWidgetWindow::OnMouseEnter(const cGuiMessageData &aData) { return false; }
