...
iGuiMaterial *cGui::GetMaterial(eGuiMaterial aType) { return mvMaterials[aType]; }
...
cGuiGfxElement *cGui::CreateGfxImage(const tString &asFile, eGuiMaterial aMaterial, const cColor &aColor,
                                     bool abAddToList) {
    ////////////////////////////
    // Load image
...
cGuiGfxElement *cGui::CreateGfxTexture(const tString &asFile, eGuiMaterial aMaterial, eTextureType aTextureType,
...
cGuiGfxElement *cGui::CreateGfxTexture(iTexture *apTexture, bool abAutoDestroyTexture, eGuiMaterial aMaterial,
                                       const cColor &aColor, bool abAddToList, const cVector2f &avStartUV,
...
cGuiGfxElement *cGui::CreateGfxImageBuffer(const tString &asFile, eGuiMaterial aMaterial, bool abCreateAnimation,
...
#define AddAttribute(name)                                                                                             \
    m_mapSkinAttributeStrings.insert(tGuiSkinAttributeMap::value_type(#name, eGuiSkinAttribute_##name))
