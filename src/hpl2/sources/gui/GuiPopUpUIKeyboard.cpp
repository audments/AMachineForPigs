...
cGuiPopUpUIKeyboard::~cGuiPopUpUIKeyboard() { mpTargetTextBox->OnUIKeyboardClose(); }
...
bool cGuiPopUpUIKeyboard::Button_Pressed(iWidget *apWidget, const cGuiMessageData &aData) { return true; }
...
void cGuiPopUpUIKeyboard::ClosePopUp() { SelfDestruct(); }
