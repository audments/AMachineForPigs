...
void cWidgetLabel::DrawText(float afTimeStep, cGuiClipRegion *apClipRegion) {
    ...
    if (mbWordWrap) {
        ...
        for (size_t i = 0; i < vRows.size(); ++i) {
            ...
            if (bEnabled)
                DrawDefaultText(vRows[i], GetGlobalPosition() + vOffset - cVector3f(0, mfWordWrapOffset, 0),
                                mTextAlign);
            else {
...
void cWidgetLabel::OnLoadGraphics() { mpGfxBackground = mpSkin->GetGfx(eGuiSkinGfx_FrameBackground); }
...
bool cWidgetLabel::OnMouseMove(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool cWidgetLabel::OnMouseDown(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool cWidgetLabel::OnMouseUp(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool cWidgetLabel::OnMouseEnter(const cGuiMessageData &aData) { return false; }

//-----------------------------------------------------------------------

bool cWidgetLabel::OnMouseLeave(const cGuiMessageData &aData) { return false; }
