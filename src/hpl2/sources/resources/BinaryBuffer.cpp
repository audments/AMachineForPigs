...
cBinaryBuffer::cBinaryBuffer() { InitAndAllocData(); }
...
void cBinaryBuffer::AddRawData(void *apData, size_t alSize) { AddData(apData, alSize); }

//-----------------------------------------------------------------------

void cBinaryBuffer::AddChar(char alX) { AddData(&alX, sizeof(char)); }

//-----------------------------------------------------------------------

void cBinaryBuffer::AddUnsignedChar(unsigned char alX) { AddData(&alX, sizeof(char)); }
...
void cBinaryBuffer::AddCharArray(const char *apData, size_t alSize) { AddData(apData, sizeof(char) * alSize); }
...
void cBinaryBuffer::GetRawData(void *apData, size_t alSize) { GetData(apData, alSize); }
...
void cBinaryBuffer::GetMatrixf(cMatrixf *apX) { GetFloat32Array(apX->v, 16); }
...
void cBinaryBuffer::GetCharArray(char *apData, size_t alSize) { GetData(apData, sizeof(char) * alSize); }
