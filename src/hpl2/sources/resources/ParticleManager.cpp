...
cParticleSystem *cParticleManager::CreatePS(const tString &asName, const tString &asDataName, cXmlElement *apElement,
                                            cVector3f avSize) {
...
void cParticleManager::AddData(cParticleSystemData *apData) { AddResource(apData); }
