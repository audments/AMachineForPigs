...
void cResources::Init(cGraphics *apGraphics, cSystem *apSystem, cSound *apSound, cScene *apScene, cGui *apGui,
                      cPhysics *apPhysics) {
    ...
    mpGpuShaderManager =
        hplNew(cGpuShaderManager, (mpFileSearcher, mpLowLevelGraphics, mpLowLevelResources, mpLowLevelSystem));
...
cFileSearcher *cResources::GetFileSearcher() { return mpFileSearcher; }
...
void cResources::ClearResourceDirs() { mpFileSearcher->ClearDirectories(); }
...
void cResources::DestroyXmlDocument(iXmlDocument *apDoc) { STLFindAndDelete(mlstXmlDocuments, apDoc); }
...
void cResources::DestroyBinaryBuffer(cBinaryBuffer *apFile) { STLFindAndDelete(mlstBinBuffers, apFile); }

//-----------------------------------------------------------------------

iLowLevelResources *cResources::GetLowLevel() { return mpLowLevelResources; }
