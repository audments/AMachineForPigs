...
// Serialize iSaveGame
kBeginSerializeBaseVirtual(iSaveData) kSerializeVar(mlSaveDataId, eSerializeType_Int32) kEndSerialize()
...
void iSaveObject::SaveToSaveData(iSaveData *apSaveData) { apSaveData->mlSaveDataId = mlSaveObjectId; }
...
cSaveObjectIterator cSaveObjectHandler::GetIterator() { return cSaveObjectIterator(&m_mapSaveObjects); }
...
void cSaveObjectHandler::Clear() { m_mapSaveObjects.clear(); }

//------------------------------------------------------------------------

size_t cSaveObjectHandler::Size() { return m_mapSaveObjects.size(); }
...
cSaveDataIterator cSaveDataHandler::GetIterator() { return cSaveDataIterator(&m_mapSaveData); }

void cSaveDataHandler::Clear() { m_mapSaveData.clear(); }

size_t cSaveDataHandler::Size() { return m_mapSaveData.size(); }
...
iContainerIterator *cSaveDataHandler::CreateIteratorPtr() { return hplNew(cSaveDataIterator, (&m_mapSaveData)); }
