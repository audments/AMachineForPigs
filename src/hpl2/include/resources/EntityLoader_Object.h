...
class cEntityLoader_Object : public iEntityLoader {
  public:
    ...
    iEntity3D *Load(const tString &asName, int alID, bool abActive, cXmlElement *apRootElem,
                    ...
                    const tString &asFileName, const tWString &asFullPath, cResourceVarsObject *apInstanceVars);

  protected:
    virtual void BeforeLoad(cXmlElement *apRootElem, const cMatrixf &a_mtxTransform, cWorld *apWorld,
                            cResourceVarsObject *apInstanceVars) = 0;
    virtual void AfterLoad(cXmlElement *apRootElem, const cMatrixf &a_mtxTransform, cWorld *apWorld,
                           cResourceVarsObject *apInstanceVars) = 0;
