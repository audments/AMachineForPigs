...
class iWidget {
  ...
  public:
    ...
    virtual cGuiGlobalShortcut *AddShortcut(int alKeyModifiers, eKey aKey, eGuiMessage aMsg = eGuiMessage_ButtonPressed,
  ...
  protected:
    ...
    void DrawBordersAndCorners(cGuiGfxElement *apBackground, cGuiGfxElement **apBorderVec, cGuiGfxElement **apCornerVec,
    ...
    void
    DrawDefaultTextHighlight(const tWString &asText, const cVector3f &avPosition,
