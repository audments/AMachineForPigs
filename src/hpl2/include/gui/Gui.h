...
class cGui : public iUpdateable {
  public:
    ...
    cGuiGfxElement *CreateGfxImage(const tString &asFile, eGuiMaterial aMaterial, const cColor &aColor = cColor(1, 1),
                                   bool abAddToList = true);

    cGuiGfxElement *CreateGfxTexture(const tString &asFile, eGuiMaterial aMaterial,
                                     eTextureType aTextureType = eTextureType_2D, const cColor &aColor = cColor(1, 1),
                                     bool abMipMaps = false, bool abAddToList = true);

    cGuiGfxElement *CreateGfxTexture(iTexture *apTexture, bool abAutoDestroyTexture, eGuiMaterial aMaterial,
     ...
     */
    cGuiGfxElement *CreateGfxImageBuffer(const tString &asFile, eGuiMaterial aMaterial, bool abCreateAnimation = true,
                                         const cColor &aColor = cColor(1, 1), bool abAddToList = true);
