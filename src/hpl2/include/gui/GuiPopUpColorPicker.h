...
class iGraphicPickerMode {
  public:
    iGraphicPickerMode(cGuiPopUpColorPicker *apPicker, const tWString &asName, int alSliderParamIndex,
...
class cGuiPopUpColorPicker : public iGuiPopUp {
  ...
  public:
    cGuiPopUpColorPicker(cGraphics *apGraphics, cGuiSet *apSet, cColor *apDestColor, void *apCallbackObject,
                         tGuiCallbackFunc apCallback, void *apUpdateColorCallbackObject,
  ...
  protected:
    ...
    void CreateInputs(iWidget *apParent, cVector3f &avPos, tGuiCallbackFunc apCallback, const tFloatVec &avMin,
                      const tFloatVec &avMax, std::vector<cWidgetTextBox *> &avContainer, tBoolVec &avUpdatedContainer,
