...
class cGuiRenderObject {
  public:
    cGuiRenderObject()
        : mpGfx(NULL), mvPos(0), mvSize(0), mColor(0, 0), mpCustomMaterial(NULL), mpClipRegion(NULL), mbRotated(false),
          mfAngle(0.0f), mvPivot(0.0f) {}
...
class cGuiGlobalShortcut {
  public:
    cGuiGlobalShortcut(int alKeyModifiers, eKey aKey, iWidget *apWidget, eGuiMessage aMessage, bool abBypassVisiblity,
...
class cGuiSet {
  ...
  public:
    cGuiSet(const tString &asName, cGui *apGui, cGuiSkin *apSkin, cResources *apResources, cGraphics *apGraphics,
    ...
    void DrawGfx(cGuiGfxElement *apGfx, const cVector3f &avPos, const cVector2f &avSize = -1,
                 const cColor &aColor = cColor(1, 1), eGuiMaterial aMaterial = eGuiMaterial_LastEnum,
                 float afRotationAngle = 0, bool abUseCustomPivot = false, const cVector3f &avCustomPivot = 0);

    void DrawFont(const tWString &asText, iFontData *apFont, const cVector3f &avPos, const cVector2f &avSize,
                  const cColor &aColor, eFontAlign aAlign = eFontAlign_Left,
                  eGuiMaterial aMaterial = eGuiMaterial_FontNormal);

    void DrawFont(iFontData *apFont, const cVector3f &avPos, const cVector2f &avSize, const cColor &aColor,
    ...
    cWidgetWindow *CreateWidgetWindow(tWidgetWindowButtonFlag alFlags = eWidgetWindowButtonFlag_None,
                                      const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                      const tWString &asText = _W(""), iWidget *apParent = NULL,
                                      const tString &asName = "");

    cWidgetFrame *CreateWidgetFrame(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                    bool abDrawFrame = false, iWidget *apParent = NULL, bool abHScrollBar = false,
                                    bool abVScrollBar = false, const tString &asName = "");

    cWidgetButton *CreateWidgetButton(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                      const tWString &asText = _W(""), iWidget *apParent = NULL,
                                      bool abToggleable = false, const tString &asName = "");

    cWidgetLabel *CreateWidgetLabel(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                    const tWString &asText = _W(""), iWidget *apParent = NULL,
                                    const tString &asName = "");

    cWidgetSlider *CreateWidgetSlider(eWidgetSliderOrientation aOrientation, const cVector3f &avLocalPos = 0,
                                      const cVector2f &avSize = 0, int alMaxValue = 10, iWidget *apParent = NULL,
                                      const tString &asName = "");

    cWidgetTextBox *CreateWidgetTextBox(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                        const tWString &asText = _W(""), iWidget *apParent = NULL,
                                        eWidgetTextBoxInputType aType = eWidgetTextBoxInputType_Normal,
                                        float afNumericAdd = 1.0f, bool abShowButtons = true,
                                        const tString &asName = "");

    cWidgetCheckBox *CreateWidgetCheckBox(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                          const tWString &asText = _W(""), iWidget *apParent = NULL,
                                          const tString &asName = "");

    cWidgetImage *CreateWidgetImage(const tString &asFile = "", const cVector3f &avLocalPos = 0,
                                    const cVector2f &avSize = -1, eGuiMaterial aMaterial = eGuiMaterial_Alpha,
                                    bool abAnimate = false, iWidget *apParent = NULL, const tString &asName = "");

    cWidgetListBox *CreateWidgetListBox(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                        iWidget *apParent = NULL, const tString &asName = "");

    cWidgetMultiPropertyListBox *CreateWidgetMultiPropertyListBox(const cVector3f &avLocalPos = 0,
                                                                  const cVector2f &avSize = 0, iWidget *apParent = NULL,
                                                                  const tString &asName = "");

    cWidgetComboBox *CreateWidgetComboBox(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                          const tWString &asText = _W(""), iWidget *apParent = NULL,
                                          const tString &asName = "");

    cWidgetMenuItem *CreateWidgetMenuItem(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                          const tWString &asText = _W(""), iWidget *apParent = NULL,
                                          const tString &asName = "");

    cWidgetContextMenu *CreateWidgetContextMenu(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                                const tWString &asText = _W(""), iWidget *apParent = NULL,
                                                const tString &asName = "");

    cWidgetMainMenu *CreateWidgetMainMenu(iWidget *apParent = NULL, const tString &asName = "");

    cWidgetTabLabel *CreateWidgetTabLabel(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                          const tWString &asText = _W(""), iWidget *apParent = NULL,
                                          const tString &asName = "");

    cWidgetTab *CreateWidgetTab(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                const tWString &asText = _W(""), iWidget *apParent = NULL, const tString &asName = "");

    cWidgetTabFrame *CreateWidgetTabFrame(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                          const tWString &asText = _W(""), iWidget *apParent = NULL,
                                          bool abAllowHScroll = true, bool abAllowVScroll = true,
                                          const tString &asName = "");

    cWidgetGroup *CreateWidgetGroup(const cVector3f &avLocalPos = 0, const cVector2f &avSize = 0,
                                    const tWString &asText = _W(""), iWidget *apParent = NULL,
                                    const tString &asName = "");

    cWidgetDummy *CreateWidgetDummy(const cVector3f &avLocalPos = 0, iWidget *apParent = NULL,
                                    const tString &asName = "");
    ...
    cGuiPopUpColorPicker *CreatePopUpColorPicker(cColor *apDestColor, const cVector3f &avPos, void *apCallbackObject,
                                                 tGuiCallbackFunc apCallback);
  ...
  private:
    void DrawTextFromCharArry(const wchar_t *apString, iFontData *apFont, const cVector2f &avSize,
