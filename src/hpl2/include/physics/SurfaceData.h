...
class cSurfaceData {
  public:
    ...
    /**
     * Gets the the appropriate impact data depending on speed. It gets the data with highest speed not higher than
     * afSpeed \param afSpeed The speed value. \return
     */
