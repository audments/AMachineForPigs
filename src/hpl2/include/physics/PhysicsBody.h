...
class iPhysicsBodyCallback {
  public:
    ...
    virtual void OnBodyCollide(iPhysicsBody *apBody, iPhysicsBody *apCollideBody,
...
struct cPhysicsBody_Buoyancy {
    cPhysicsBody_Buoyancy() : mbActive(false), mfDensity(1), mfLinearViscosity(1), mfAngularViscosity(1) {}
