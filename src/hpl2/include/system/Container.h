...
template <class T> class cContainerVecIterator : public iContainerIterator {
...
template <class T> class cContainerVec : public iContainer {
  private:
...
template <class T> class cContainerListIterator : public iContainerIterator {
    void *NextPtr() { return &Next(); }
...
template <class T> class cContainerList : public iContainer {
  private:
    void AddVoidPtr(void **apPtr) { mvVector.push_back(*((T *)apPtr)); }
    void AddVoidClass(void *apClass) { mvVector.push_back(*((T *)apClass)); }
