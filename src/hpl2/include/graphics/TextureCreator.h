...
class cTextureCreator {
  public:
    ...
    /**
     * Creates a 3d texture with alSize * alSize number of scatter disks with a certain number of samples. The samples
     * are uniformly distribute on the disk. \param *apOffsetTexture A 3d texture where the data will be placed. \param
     * alSize The number of scatter disks per axis (16 creates a texture with height and with 16). Must be power of two.
