...
class cProgramComboManager {
  public:
    ...
    void SetupGenerateProgramData(int alMainMode, const tString &asModeName, const tString &asVtxShaderName,
                                  const tString &asFragShaderName, cProgramComboFeature *apFeatures, int alFeatureNum,
    ...
    iGpuShader *CreateShader(const tString &asName, eGpuShaderType aType, cParserVarContainer *apVars,
                             bool abAddtoList);
    ...
    iGpuProgram *CreateProgramFromShaders(const tString &asProgramName, const tString &asVtxShaderName,
                                          const tString &asFragShaderName, cParserVarContainer *apVars,
                                          bool abAddtoList);
    iGpuProgram *CreateProgramFromShaders(const tString &asProgramName, iGpuShader *apVtxShader,
  ...
  private:
    ...
    iGpuShader *CreateShaderFromFeatures(const tString &asShaderFile, tFlag aShaderType, int alBitFlags,
