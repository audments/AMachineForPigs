...
class iLowLevelHaptic {
  public:
    ...
    virtual iHapticSurface *CreateSimpleSurface(const tString &asName, float afDamping = 0.0f,
                                                float afStiffness = 0.9f) = 0;

    virtual iHapticSurface *CreateFrictionalSurface(const tString &asName, float afDamping = 0.0f,
                                                    float afStiffness = 0.9f, float afDynamicFriction = 0.2f,
                                                    float afStartingFriction = 0.3f, float afTangentStiffness = 0.7f,
                                                    float afStoppingFriction = 0.1f) = 0;

    virtual iHapticSurface *CreateRoughSurface(const tString &asName, float afDeviation = 0.1f, float afMean = 0.5f,
    ...
    virtual iHapticSurface *CreateStickySurface(const tString &asName, float afDeadHeight = 0.004f,
                                                float afStickyStiffness = 0.6f, float afDamping = 0.0f,
                                                float afStiffness = 0.9f, float afDynamicFriction = 0.2f,
                                                float afStartingFriction = 0.3f, float afTangentStiffness = 0.7f,
                                                float afStoppingFriction = 0.1f) = 0;
    ...
    virtual iHapticShape *CreateCylinderShape(const tString &asName, float afRadius, float afHeight,
                                              cMatrixf *apOffsetMtx) = 0;
    virtual iHapticShape *CreateCapsuleShape(const tString &asName, float afRadius, float afHeight,
                                             cMatrixf *apOffsetMtx) = 0;
    ...
    virtual iHapticForce *CreateViscosityForce(const cVector3f &avVelocity, float afMass, float afStiffness,
                                               float afDamping) = 0;
