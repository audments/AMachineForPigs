...
enum eLightType { eLightType_Point, eLightType_Spot, eLightType_Box, eLightType_LastEnum };
...
class iLight : public iRenderable {
  ...
  public:
    ...
    inline void RenderShadow(iRenderable *apObject, cRenderSettings *apRenderSettings,
    ...
    void SetFlicker(const cColor &aOffCol, float afOffRadius, float afOnMinLength, float afOnMaxLength,
