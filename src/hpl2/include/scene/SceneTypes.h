...
enum eLightBoxBlendFunc { eLightBoxBlendFunc_Replace, eLightBoxBlendFunc_Add, eLightBoxBlendFunc_LastEnum };

//-----------------------------------------

enum eViewportMessage { eViewportMessage_OnPreWorldDraw, eViewportMessage_OnPostWorldDraw, eViewportMessage_LastEnum };
...
enum eBillboardType { eBillboardType_Point, eBillboardType_Axis, eBillboardType_FixedAxis, eBillboardType_LastEnum };
