...
template <typename T> class iPhysicsJointNewton : public T {
  public:
  ...
  protected:
    ...
    void CreateCustomJoint(int alMaxDOF) {
        mlMaxDOF = alMaxDOF;
        mpNewtonJoint = NewtonConstraintCreateUserJoint(mpNewtonWorld, mlMaxDOF, StaticSubmitConstraints, StaticGetInfo,
