...
class cPhysicsMaterialNewton : public iPhysicsMaterial {
  ...
  private:
    ...
    static int OnAABBOverlapCallback(const NewtonMaterial *apMaterial, const NewtonBody *apBody0,
                                     const NewtonBody *apBody1, int alThreadIndex);
    ...
    static void EndContactCallback(		const NewtonMaterial* apMaterial, const NewtonBody* apBody0, const NewtonBody*
    apBody1, int alThreadIndex);*/
