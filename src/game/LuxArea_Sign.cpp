...
bool cLuxArea_Sign::CanInteract(iPhysicsBody *apBody) { return true; }

//-----------------------------------------------------------------------

bool cLuxArea_Sign::OnInteract(iPhysicsBody *apBody, const cVector3f &avPos) { return false; }
...
tWString cLuxArea_Sign::GetFocusText() { return kTranslate(msTextCat, msTextEntry); }
...
kBeginSerialize(cLuxArea_Sign_SaveData, iLuxArea_SaveData)
    ...
    kSerializeVar(msTextCat, eSerializeType_String) kSerializeVar(msTextEntry, eSerializeType_String)
...
iLuxEntity_SaveData *cLuxArea_Sign::CreateSaveData() { return hplNew(cLuxArea_Sign_SaveData, ()); }
...
void cLuxArea_Sign::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
