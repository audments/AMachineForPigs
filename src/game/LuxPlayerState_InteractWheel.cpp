...
void cLuxPlayerState_InteractWheel::EnterRotateBase(eLuxPlayerState aPrevState) { mlstMoveAdds.clear(); }
...
kBeginSerialize(cLuxPlayerState_InteractWheel_SaveData, iLuxPlayerState_InteractRotateBase_SaveData) kEndSerialize()
