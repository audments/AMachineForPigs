...
class cLuxLoadScreenHandler_SaveData : public iSerializable {
    kSerializableClassInit(cLuxLoadScreenHandler_SaveData) public
...
class cLuxGlobalDataHandler_SaveData : public iSerializable {
    kSerializableClassInit(cLuxGlobalDataHandler_SaveData) public
...
class cLuxEffectHandler_SoundMul_SaveData : public iSerializable {
    kSerializableClassInit(cLuxEffectHandler_SoundMul_SaveData) public
