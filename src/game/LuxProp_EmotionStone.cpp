...
bool cLuxProp_EmotionStone::CanInteract(iPhysicsBody *apBody) { return true; }
...
void cLuxProp_EmotionStone::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
