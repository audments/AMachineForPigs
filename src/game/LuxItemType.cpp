...
cLuxItemType_Note::cLuxItemType_Note() : iLuxItemType("Note", eLuxItemType_Note) { mbShowPickUpMessage = false; }
...
cLuxItemType_Diary::cLuxItemType_Diary() : iLuxItemType("Diary", eLuxItemType_Diary) { mbShowPickUpMessage = false; }
