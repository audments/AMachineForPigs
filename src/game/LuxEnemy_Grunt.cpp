...
// Alert
    ...
    kLuxOnMessage(eLuxEnemyMessage_PlayerDetected) kLuxOnMessage(eLuxEnemyMessage_HelpMe)
        ...
        ///////////////////////
        // Enter
        kLuxOnEnter SendMessage(eLuxEnemyMessage_TimeOut_2, cMath::RandRectf(mfHuntPauseMinTime, mfHuntPauseMaxTime),
                                true);
    mpPathfinder->Stop();
...
void cLuxEnemy_Grunt::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
