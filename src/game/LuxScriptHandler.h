...
class cLuxScriptHandler : public iLuxUpdateable {
  ...
  private:
    ...
    // Game
    static void __stdcall StartCredits(string &asMusic, bool abLoopMusic, string &asTextCat, string &asTextEntry,
                                       int alEndNum);
     ...
     */
    static void __stdcall CheckPoint(string &asName, string &asStartPos, string &asCallback, string &asDeathHintCat,
                                     string &asDeathHintEntry, bool abKeepPlayerInLimbo);
    ...
    /**
     * This caches all current textures and models and they are not released until destroy is called. If there is
     * already cached data it is destroyed.
     */
    ...
    static void __stdcall ShowScreenImage(string &asImageName, float afX, float afY, float afScale,
    ...
    // This adds a voice + effect to be played. It is okay to call this many times in order to play many voices in a
    // row. The EffectVoiceOverCallback is not called until ALL voices have finished.
    static void __stdcall AddEffectVoice(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                         string &asTextEntry, bool abUsePostion, string &asPosEnitity,
                                         float afMinDistance, float afMaxDistance);

    static void __stdcall AddEffectVoice2(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                          string &asTextEntry, float afTextDelay, string &asText2Entry,
                                          float afText2Delay, bool abUsePostion, string &asPosEnitity,
                                          float afMinDistance, float afMaxDistance);

    static void __stdcall AddEffectVoice3(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                          string &asTextEntry, float afTextDelay, string &asText2Entry,
                                          float afText2Delay, string &asText3Entry, float afText3Delay,
                                          bool abUsePostion, string &asPosEnitity, float afMinDistance,
                                          float afMaxDistance);

    static void __stdcall AddEffectVoice4(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                          string &asTextEntry, float afTextDelay, string &asText2Entry,
                                          float afText2Delay, string &asText3Entry, float afText3Delay,
                                          string &asText4Entry, float afText4Delay, bool abUsePostion,
                                          string &asPosEnitity, float afMinDistance, float afMaxDistance);

    static void __stdcall AddEffectVoice5(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                          string &asTextEntry, float afTextDelay, string &asText2Entry,
                                          float afText2Delay, string &asText3Entry, float afText3Delay,
                                          string &asText4Entry, float afText4Delay, string &asText5Entry,
                                          float afText5Delay, bool abUsePostion, string &asPosEnitity,
                                          float afMinDistance, float afMaxDistance);

    static void __stdcall AddEffectVoice6(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                          string &asTextEntry, float afTextDelay, string &asText2Entry,
                                          float afText2Delay, string &asText3Entry, float afText3Delay,
                                          string &asText4Entry, float afText4Delay, string &asText5Entry,
    ...
    static void __stdcall AddEffectVoice7(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                          string &asTextEntry, float afTextDelay, string &asText2Entry,
                                          float afText2Delay, string &asText3Entry, float afText3Delay,
                                          string &asText4Entry, float afText4Delay, string &asText5Entry,
                                          float afText5Delay, string &asText6Entry, float afText6Delay,
    ...
    static void __stdcall AddEffectVoiceExt(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                            string &asTextEntry, bool abUsePostion, string &asPosEnitity,
    ...
    static void __stdcall StartPlayerLookAt(string &asEntityName, float afSpeedMul, float afMaxSpeed,
    ...
    static void __stdcall SetLanternFlickerTimes(float afMinTimeInFailureFlickering,
                                                 float afMaxTimeInFailureFlickering);
    static void __stdcall SetLanternDefaultFlickerTimes();

    static void __stdcall SetLanternFailureToFailureTransitionChances(float afChanceFlickerComesAfterDeadFailure,
                                                                      float afChanceDeadComesAfterFlickerFailure);
    ...
    static void __stdcall GiveItem(string &asName, string &asType, string &asSubTypeName, string &asImageName,
                                   float afAmount);
     ...
     */
    static void __stdcall AddCombineCallback(string &asName, string &asItemA, string &asItemB, string &asFunction,
                                             bool abAutoDestroy);
     ...
     */
    static void __stdcall AddUseItemCallback(string &asName, string &asItem, string &asEntity, string &asFunction,
                                             bool abAutoDestroy);
    ...
    static void __stdcall CreateParticleSystemAtEntity(string &asPSName, string &asPSFile, string &asEntity,
                                                       bool abSavePS);
    static void __stdcall CreateParticleSystemAtEntityExt(string &asPSName, string &asPSFile, string &asEntity,
                                                          bool abSavePS, float afR, float afG, float afB, float afA,
                                                          bool abFadeAtDistance, float afFadeMinEnd,
    ...
    // asEntity can be "Player". If abSaveSound = true the sound is never attached to the entity! Also note that saving
    // should on be used on looping sounds!
    static void __stdcall PlaySoundAtEntity(string &asSoundName, string &asSoundFile, string &asEntity,
                                            float afFadeTime, bool abSaveSound);
    static void __stdcall PlaySoundAtPosition(string &asSoundName, string &asSoundFile, float afX, float afY, float afZ,
                                              float afFadeTime, bool abSaveSound);
    ...
    static void __stdcall PlayMusic(string &asMusicFile, bool abLoop, float afVolume, float afFadeTime, int alPrio,
                                    bool abResume);
     ...
     */
    static void __stdcall FadeLightTo(string &asLightName, float afR, float afG, float afB, float afA, float afRadius,
                                      float afTime);
    static void __stdcall SetLightFlickerActive(string &asLightName, bool abActive);

    static void __stdcall FadeLampTo(string &asName, float afR, float afG, float afB, float afA, float afRadius,
                                     float afTime);
    ...
    static void __stdcall CreateEntityAtArea(string &asEntityName, string &asEntityFile, string &asAreaName,
     ...
     */
    static void __stdcall SetEntityPlayerInteractCallback(string &asName, string &asCallback,
                                                          bool abRemoveOnInteraction);
    /**
     * Callback syntax: MyFunc(string &in entity, string &in type). Type depends on entity type and includes:
     * "OnPickup", "Break", "OnIgnite", etc
     */
    static void __stdcall SetEntityCallbackFunc(string &asName, string &asCallback);
    /**
     * A callback called when ever the connection state changes (button being switched on). Syntax: void Func(string &in
     * EntityName, int alState). alState: -1=off, 0=between 1=on
     */
     ...
     */
    static void __stdcall RotatePropToSpeed(string &asName, float afAcc, float afGoalSpeed, float afAxisX,
                                            float afAxisY, float afAxisZ, bool abResetSpeed, string &asOffsetArea);
    static void __stdcall StopPropMovement(string &asName);

    static void __stdcall AttachPropToBone(string &asChildEntityName, string &asParentEntityName,
                                           string &asParentBoneName, float fPosX, float fPosY, float fPosZ, float fRotX,
                                           float fRotY, float fRotZ);
    static void __stdcall DetachPropFromBone(string &asChildEntityName);

    static void __stdcall AddAttachedPropToProp(string &asPropName, string &asAttachName, string &asAttachFile,
                                                float afPosX, float afPosY, float afPosZ, float afRotX, float afRotY,
                                                float afRotZ);
    ...
    static void __stdcall SetSwingDoorOpenAmount(string &asName, float afOpenAmount, float afDuration,
     ...
     */
    static void __stdcall PlayPropAnimation(string &asProp, string &asAnimation, float afFadeTime, bool abLoop,
                                            string &asCallback);
    ...
    static void __stdcall SetMoveObjectStateExt(string &asName, float afState, float afAcc, float afMaxSpeed,
    ...
    /**
     * Do not use this on joints in SwingDoors, Levers, Wheels, etc where the joint is part of an interaction. That will
     * make the game crash.
     */
    static void __stdcall BreakJoint(string &asName);

    // Parent can have asterix in name but mot child! Entity callbacks alStates = 1=only enter, -1=only leave 0=both.
    // Syntax: void Func(string &in asParent, string &in asChild, int alState). alState: 1=enter, -1=leave.
    static void __stdcall AddEntityCollideCallback(string &asParentName, string &asChildName, string &asFunction,
    ...
    // Entity connections
    static void __stdcall InteractConnectPropWithRope(string &asName, string &asPropName, string &asRopeName,
                                                      bool abInteractOnly, float afSpeedMul, float afToMinSpeed,
                                                      float afToMaxSpeed, bool abInvert, int alStatesUsed);
    /**
     * This one should only be used if there must be an exact correspondance to prope "amount" and the moveobject open
     * amount. It is best used for Wheel-door connections!
     */
    static void __stdcall InteractConnectPropWithMoveObject(string &asName, string &asPropName,
                                                            string &asMoveObjectName, bool abInteractOnly,
                                                            bool abInvert, int alStatesUsed);
    /**
     * Callback Syntax: MyFunc(string &in asConnectionName, string &in asMainEntity, string &in asConnectEntity, int
     * alState). State is what is sent to connection entity and will be inverted if abInvertStateSent=true!
     */
    static void __stdcall ConnectEntities(string &asName, string &asMainEntity, string &asConnectEntity,
