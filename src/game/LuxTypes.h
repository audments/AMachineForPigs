...
enum eLuxEnemyMusic { eLuxEnemyMusic_Search, eLuxEnemyMusic_Attack, eLuxEnemyMusic_LastEnum };
...
class cLuxHeadPosAdd : public iSerializable {
    kSerializableClassInit(cLuxHeadPosAdd) public : cLuxHeadPosAdd() : mvAdd(0), mbMoving(false) {}
...
class cLuxHint : public iSerializable {
    kSerializableClassInit(cLuxHint) public : cLuxHint() : mbHasBeenRead(true) {}
...
class cLuxProp_AttachedProp : public iSerializable {
    kSerializableClassInit(cLuxProp_AttachedProp) public : cLuxProp_AttachedProp() : mpProp(NULL) {}
