...
void cLuxPlayerState_Ladder::OnEnterState(eLuxPlayerState aPrevState) {
    ...
    cLuxMoveState_Normal *pMoveState =
...
void cLuxPlayerState_Ladder::Update(float afTimeStep) {
    ...
    // Move On Ladder
        ...
        ///////////////////////////
        // Check if at bottom
        else if (mfMoveMul < 0 && ((mvCharPosition.y - pCharBody->GetSize().y / 2) < mpLadder->GetMinY() ||
...
cGuiGfxElement *cLuxPlayerState_Ladder::GetCrosshair() { return NULL; }
...
bool cLuxPlayerState_Ladder::OnRun(bool abPressed) { return false; }
...
bool cLuxPlayerState_Ladder::OnCrouch(bool abPressed) { return true; }
...
float cLuxPlayerState_Ladder::DrawDebug(cGuiSet *apSet, iFontData *apFont, float afStartY) { return afStartY; }
...
kBeginSerialize(cLuxPlayerState_Ladder_SaveData, iLuxPlayerState_DefaultBase_SaveData)
    kSerializeVar(mlState, eSerializeType_Int32) kSerializeVar(mvStartPosition, eSerializeType_Vector3f)
        ...
        kSerializeVar(mlLadderID, eSerializeType_Int32)
            ...
            kSerializeVar(mfTimeCount, eSerializeType_Float32)
                ...
                kSerializeVar(mvCharPosition, eSerializeType_Vector3f)
                    ...
                    kSerializeVar(mvGoalPos, eSerializeType_Vector3f) kSerializeVar(mvGoalRot, eSerializeType_Vector3f)
...
void cLuxPlayerState_Ladder::LoadFromSaveDataBeforeEnter(cLuxMap *apMap, iLuxPlayerState_SaveData *apSaveData) {
    ...
    ///////////////////////
    // Load vars
    iLuxEntity *pEntity = gpBase->mpMapHandler->GetCurrentMap()->GetEntityByID(pData->mlLadderID, eLuxEntityType_Area,
                                                                               eLuxAreaType_Ladder);
    if (pEntity) {
