...
cLuxGlobalDataHandler::cLuxGlobalDataHandler() : iLuxUpdateable("LuxGlobalDataHandler") {
    ...
    mfLightLampMaxInfectionIncrease =
        gpBase->mpGameCfg->GetFloat("Player_Infection", "LightLampMaxInfectionIncrease", 0);
    mfLightLampMinInfectionIncrease =
        gpBase->mpGameCfg->GetFloat("Player_Infection", "LightLampMinInfectionIncrease", 0);
}
...
bool cLuxGlobalDataHandler::GetEnemyActivateSoundAllowed() { return mfEnemyActivateSoundCount <= 0; }

void cLuxGlobalDataHandler::SetEnemyActivateSoundMade() { mfEnemyActivateSoundCount = 5.0f; }
