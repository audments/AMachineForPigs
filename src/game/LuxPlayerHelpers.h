...
class cLuxPlayerStamina : public iLuxPlayerHelper {
  ...
  private:
    float mfTimeSinceLastSound, mfStaminaTimer, mfSprintSlowdownStartTime, mfSprintExhaustionTime,
        mfExhaustionSpeedMultiplier, mfSprintRecoverySpeed;
};
...
class cLuxPlayerVoiceFlashback : public iLuxPlayerHelper {
  ...
  public:
    ...
    void StopPlaying();
    void Start(const tString &asVoiceFile, const tString &asTextEntry1, float afDelay1, const tString &asTextEntry2,
               float afDelay2, const tString &asTextEntry3, float afDelay3, const tString &asTextEntry4, float afDelay4,
               const tString &asTextEntry5, float afDelay5, const tString &asTextEntry6, float afDelay6,
               const tString &asTextEntry7, float afDelay7, bool abUseEffects, bool abObstructMovement);
    void StartEffects();
    void StopEffects();
    ...
    void SetMouseSensitivityModifier(float afMouseSensitivityModifier) {
        mfMouseSensitivityModifier = afMouseSensitivityModifier;
    }

  private:
    bool mbIsDelaying, mbIsPlaying, mbUseEffects, mbObstructMovement;
    float mfEffectFadeInTime, mfEffectFadeOutTime, mfSepiaAmount, mfLightFadeAmount, mfImageTrailAmount,
        mfBlurStartDistance, mfBlurAmount, mfFovMultiplier, mfMoveSpeedMultiplier, mfMouseSensitivityModifier;
