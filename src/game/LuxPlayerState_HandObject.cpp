...
void cLuxPlayerState_HandObject::ImplementedOnLeaveState(eLuxPlayerState aNewState) {
    ...
    if (aNewState == eLuxPlayerState_Normal || aNewState == eLuxPlayerState_InteractPush ||
...
kBeginSerialize(cLuxPlayerState_HandObject_SaveData, iLuxPlayerState_DefaultBase_SaveData) kEndSerialize()
