...
void cLuxAnimatedPropLoader::BeforeLoad(cXmlElement *apRootElem, const cMatrixf &a_mtxTransform, cWorld *apWorld,
                                        cResourceVarsObject *apInstanceVars) {}

//-----------------------------------------------------------------------

void cLuxAnimatedPropLoader::AfterLoad(cXmlElement *apRootElem, const cMatrixf &a_mtxTransform, cWorld *apWorld,
                                       cResourceVarsObject *apInstanceVars) {
...
kBeginSerializeBase(iLuxAnimatedProp_SaveData)
    ...
    kSerializeVar(msName, eSerializeType_String) kSerializeVar(mlID, eSerializeType_Int32)
