...
bool cLuxProp_OilBarrel::CanInteract(iPhysicsBody *apBody) { return false; }
...
kBeginSerialize(cLuxProp_OilBarrel_SaveData, iLuxProp_SaveData)
    ...
    kSerializeVar(mbAmountCalculated, eSerializeType_Bool) kSerializeVar(mfOilAmount, eSerializeType_Float32)
...
void cLuxProp_OilBarrel::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
