...
kBeginSerialize(cLuxArea_Sticky_SaveData, iLuxArea_SaveData)
    ...
    kSerializeVar(msAttachFunction, eSerializeType_String) kSerializeVar(msDetachFunction, eSerializeType_String)

        kSerializeVar(msAttachSound, eSerializeType_String) kSerializeVar(msDetachSound, eSerializeType_String)

            kSerializeVar(msAttachPS, eSerializeType_String) kSerializeVar(msDetachPS, eSerializeType_String)
...
iLuxEntity_SaveData *cLuxArea_Sticky::CreateSaveData() { return hplNew(cLuxArea_Sticky_SaveData, ()); }
...
void cLuxArea_Sticky::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
