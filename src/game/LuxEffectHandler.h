...
class iLuxEffect {
  ...
  protected:
    ...
    float mfValueAtInfectionLevelOne, mfValueAtInfectionLevelTwo, mfValueAtInfectionLevelThree,
...
class cLuxEffect_ScreenImage : public iLuxEffect {
  public:
    ...
    void ShowImage(const tString &asImageName, float afX, float afY, float afScale, bool abUseRelativeCoordinates,
                   float afDuration, float afFadeIn, float afFadeOut);
...
//
//	void ShowImage(string & imageFileName, float xPos, float yPos, float xSize, float ySize, bool
...
class cLuxEffect_PlayVoice : public iLuxEffect {
  ...
  public:
    ...
    void AddVoice(const tString &asVoiceFile, const tString &asEffectFile, const tString &asTextCat,
                  const tString &asTextEntry, bool abUsePostion, const cVector3f &avPosition, float afMinDistance,
                  float afMaxDistance, int alPriority = 0, bool abRemoveInterrupted = true);

    // yes, there are much more elegant ways, but I have a 2 hour deadline and a save system that doesn't like
    // stringlists.
    void AddMultiSubbedVoice(const tString &asVoiceFile, const tString &asEffectFile, const tString &asTextCat,
                             const tString &asTextEntry, float afTextDelay, const tString &asText2Entry,
                             float afText2Delay, const tString &asText3Entry, float afText3Delay,
                             const tString &asText4Entry, float afText4Delay, const tString &asText5Entry,
                             float afText5Delay, const tString &asText6Entry, float afText6Delay,
                             const tString &asText7Entry, float afText7Delay, bool abUsePostion,
                             const cVector3f &avPosition, float afMinDistance, float afMaxDistance, int alPriority = 0,
