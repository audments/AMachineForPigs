...
kBeginSerialize(cLuxRope_SaveData, iLuxEntity_SaveData)
    ...
    kSerializeVar(mbRopeCreated, eSerializeType_Bool)
        ...
        kSerializeVar(mvStartPos, eSerializeType_Vector3f) kSerializeVar(mvEndPos, eSerializeType_Vector3f)
            ...
            kSerializeVar(msEndPosNode, eSerializeType_String) kSerializeVar(msStartBody, eSerializeType_String)
                kSerializeVar(msEndBody, eSerializeType_String)
                    ...
                    kSerializeVar(mfMinTotalLength, eSerializeType_Float32)
                        kSerializeVar(mfMaxTotalLength, eSerializeType_Float32)
                            kSerializeVar(mfSegmentLength, eSerializeType_Float32) kSerializeVar(mfDamping,
                                                                                                 eSerializeType_Float32)
                                kSerializeVar(mfStrength, eSerializeType_Float32) kSerializeVar(mfStiffness,
                                                                                                eSerializeType_Float32)
...
iLuxEntity_SaveData *cLuxRope::CreateSaveData() { return hplNew(cLuxRope_SaveData, ()); }
