...
kBeginSerialize(cLuxProp_Lever_SaveData, iLuxProp_SaveData) kSerializeVar(mlCurrentState, eSerializeType_Int32)
    kSerializeVar(mlStuckState, eSerializeType_Int32) kSerializeVar(mbInteractionDisablesStuck, eSerializeType_Bool)
        kSerializeVar(mfMiddleAngleAmount, eSerializeType_Float32) kSerializeVar(mbAutoMoveToAngle, eSerializeType_Bool)
            kSerializeVar(mlAutoMoveGoal, eSerializeType_Int32) kEndSerialize()
...
void cLuxProp_Lever::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
