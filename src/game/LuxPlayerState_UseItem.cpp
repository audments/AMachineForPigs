...
void cLuxPlayerState_UseItem::ImplementedUpdate(float afTimeStep) { mFlashOscill.Update(afTimeStep); }
...
bool cLuxPlayerState_UseItem::ShowOutlineOnEntity(iLuxEntity *apEntity, iPhysicsBody *apBody,
...
kBeginSerialize(cLuxPlayerState_UseItem_SaveData, iLuxPlayerState_DefaultBase_SaveData) kEndSerialize()
