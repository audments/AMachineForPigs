...
void cLuxProp_Button::SetCanBeSwitchedOn(bool abX) { mbCanBeSwitchedOn = abX; }

//-----------------------------------------------------------------------

void cLuxProp_Button::SetCanBeSwitchedOff(bool abX) { mbCanBeSwitchedOff = abX; }
...
kBeginSerialize(cLuxProp_Button_SaveData, iLuxProp_SaveData) kSerializeVar(mbSwitchedOn, eSerializeType_Bool)
    kSerializeVar(mbCanBeSwitchedOn, eSerializeType_Bool) kSerializeVar(mbCanBeSwitchedOff, eSerializeType_Bool)
        kEndSerialize()
...
void cLuxProp_Button::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
