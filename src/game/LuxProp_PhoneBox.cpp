...
bool cLuxProp_PhoneBox::CanInteract(iPhysicsBody *apBody) { return !mbPlayerHasInteracted && mbIsRinging; }
...
bool cLuxProp_PhoneBox::OnInteract(iPhysicsBody *apBody, const cVector3f &avPos) {
    ...
    pVoiceFlashback->Start(msVoiceFile, msTextEntry1, mfDelay1, msTextEntry2, mfDelay2, msTextEntry3, mfDelay3,
                           msTextEntry4, mfDelay4, msTextEntry5, mfDelay5, msTextEntry6, mfDelay6, msTextEntry7,
                           mfDelay7, false, true);
...
kBeginSerialize(cLuxProp_PhoneBox_SaveData, iLuxProp_SaveData) kSerializeVar(msVoiceFile, eSerializeType_String)
    kSerializeVar(msTextEntry1, eSerializeType_String) kSerializeVar(mfDelay1, eSerializeType_Float32)
        kSerializeVar(msTextEntry2, eSerializeType_String) kSerializeVar(mfDelay2, eSerializeType_Float32)
            kSerializeVar(msTextEntry3, eSerializeType_String) kSerializeVar(mfDelay3, eSerializeType_Float32)
                kSerializeVar(msTextEntry4, eSerializeType_String) kSerializeVar(mfDelay4, eSerializeType_Float32)
                    kSerializeVar(msTextEntry5, eSerializeType_String) kSerializeVar(mfDelay5, eSerializeType_Float32)
                                    ...
                                    kSerializeVar(mfDelay7, eSerializeType_Float32)
                                        kSerializeVar(mbIsRinging, eSerializeType_Bool)
                                            kSerializeVar(mbPlayerHasInteracted, eSerializeType_Bool)
                                                kSerializeVar(mbIsPlayingVoice, eSerializeType_Bool) kEndSerialize()
...
void cLuxProp_PhoneBox::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
...
void cLuxProp_PhoneBox::StartRinging() {
    ...
    //   mpRingingSound = gpBase->mpMapHandler->GetCurrentMap()->GetWorld()->CreateSoundEntity("zephoneizringing",
    //   "telephone_ring_loop",false);
    //
    //   if( mpRingingSound )
    //{
