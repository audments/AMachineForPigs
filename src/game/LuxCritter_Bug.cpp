...
void cLuxCritter_Bug::UpdateCritterSpecific(float afTimeStep) { UpdateVelocity(afTimeStep); }
...
kBeginSerialize(cLuxCritter_Bug_SaveData, iLuxProp_CritterBase_SaveData)
    kSerializeVar(mfPlaySoundCount, eSerializeType_Float32) kEndSerialize()
...
void cLuxCritter_Bug::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
