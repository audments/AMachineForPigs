...
class cLuxArea_Infection_SaveData : public iLuxArea_SaveData {
    ...
    float mfIncrementSpeed, mfTotalIncrementApplied, mfTotalIncrementBound, mfInfectionLevelLowerBound,
...
class cLuxArea_Infection : public iLuxArea {
  ...
  private:
    ...
    /////////////////////////
    // Variables
    float mfCollisionCheckTimer, mfCheckTimeMin, mfCheckTimeMax, mfIncrementSpeed, mfTotalIncrementApplied,
        mfTotalIncrementBound, mfInfectionLevelLowerBound, mfInfectionLevelUpperBound;
