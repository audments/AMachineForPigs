...
bool cLuxArea_Ladder::CanInteract(iPhysicsBody *apBody) { return true; }
...
iLuxEntity_SaveData *cLuxArea_Ladder::CreateSaveData() { return hplNew(cLuxArea_Ladder_SaveData, ()); }
...
void cLuxArea_Ladder::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
