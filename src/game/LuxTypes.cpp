...
kBeginSerializeBase(cLuxIdPair) kSerializeVar(mlParentId, eSerializeType_Int32)
    kSerializeVar(mlChildId, eSerializeType_Int32) kEndSerialize()
...
iLuxCollideCallbackContainer::iLuxCollideCallbackContainer() { mbUpdatingCollideCallbacks = false; }
        ...
        if ((bCollide && pCallback->mbColliding == false) || (bCollide == false && pCallback->mbColliding)) {
            ...
            if (lState == pCallback->mlStates || pCallback->mlStates == 0) {
                ...
                if (pCallback->mbDeleteWhenColliding) {
                    ...
                    for (tLuxCollideCallbackListIt it = mlstDeleteCallbacks.begin(); it != mlstDeleteCallbacks.end();
                         ++it) {
    ...
    for (int i = 0; i < GetBodyNum(); ++i) {
        for (int j = 0; j < apEntity->GetBodyNum(); ++j) {
            ...
            if (cMath::CheckBVIntersection(*pBodyA->GetBoundingVolume(), *pBodyB->GetBoundingVolume())) {
                bool bCollide =
                    pPhysicsWorld->CheckShapeCollision(pBodyA->GetShape(), pBodyA->GetLocalMatrix(), pBodyB->GetShape(),
                                                       pBodyB->GetLocalMatrix(), collideData, 1, false);
                if (bCollide)
                    return true;
            }
        }
...
kBeginSerializeBase(cLuxHeadPosAdd) kSerializeVar(mvAdd, eSerializeType_Vector3f)
    kSerializeVar(mbMoving, eSerializeType_Bool) kSerializeVar(mvMoveGoal, eSerializeType_Vector3f)
        kSerializeVar(mfMoveSpeed, eSerializeType_Float32) kSerializeVar(mfMoveSlowDownDist, eSerializeType_Float32)
            kEndSerialize()
    ...
    kBeginSerializeBase(cLuxEventTimer) kSerializeVar(msName, eSerializeType_String)
        kSerializeVar(msFunction, eSerializeType_String) kSerializeVar(mfCount, eSerializeType_Float32)
            kSerializeVar(mbDestroyMe, eSerializeType_Bool) kEndSerialize()
    ...
    kBeginSerializeBase(cLuxCombineItemsCallback) kSerializeVar(msName, eSerializeType_String)
        kSerializeVar(msItemA, eSerializeType_String) kSerializeVar(msItemB, eSerializeType_String)
            kSerializeVar(msFunction, eSerializeType_String) kSerializeVar(mbAutoDestroy, eSerializeType_Bool)
                kEndSerialize()
    ...
    kBeginSerializeBase(cLuxUseItemCallback) kSerializeVar(msName, eSerializeType_String)
        kSerializeVar(msItem, eSerializeType_String) kSerializeVar(msEntity, eSerializeType_String)
            kSerializeVar(msFunction, eSerializeType_String) kSerializeVar(mbAutoDestroy, eSerializeType_Bool)
                kEndSerialize()
    ...
    kBeginSerializeBase(cLuxNote) kSerializeVar(msNameEntry, eSerializeType_String)
        kSerializeVar(msTextEntry, eSerializeType_String)
            ...
            kSerializeVar(msIconFile, eSerializeType_String) kSerializeVar(msImageFile, eSerializeType_String)
                kEndSerialize()
    //-----------------------------------------------------------------------
    ...
    kBeginSerializeBase(cLuxHint) kSerializeVar(msNameEntry, eSerializeType_String)
        kSerializeVar(msTextEntry, eSerializeType_String)
            ...
            kSerializeVar(msIconFile, eSerializeType_String) kSerializeVar(msImageFile, eSerializeType_String)
                kSerializeVar(mbHasBeenRead, eSerializeType_Bool) kEndSerialize()
    //-----------------------------------------------------------------------
    ...
    kBeginSerializeBase(cLuxQuestNote) kSerializeVar(mbActive, eSerializeType_Bool)
        kSerializeVar(msName, eSerializeType_String) kSerializeVar(msNameEntry, eSerializeType_String)
            kSerializeVar(msTextEntry, eSerializeType_String) kEndSerialize()
    ...
    kBeginSerializeBase(cLuxScriptVar) kSerializeVar(msName, eSerializeType_String)
        kSerializeVar(msVal, eSerializeType_String) kEndSerialize()
    ...
    kBeginSerializeBase(cTextQueueEntry) kSerializeVar(msTextEntry, eSerializeType_WString)
        kSerializeVar(mfDelay, eSerializeType_Float32) kEndSerialize()

    //-----------------------------------------------------------------------
    kBeginSerializeBase(cLuxVoiceData)

        kSerializeVar(msText, eSerializeType_WString) kSerializeVar(mfTextDelay, eSerializeType_Float32)
            kSerializeVar(msText2, eSerializeType_WString) kSerializeVar(mfText2Delay, eSerializeType_Float32)
                kSerializeVar(msText3, eSerializeType_WString) kSerializeVar(mfText3Delay, eSerializeType_Float32)
                    kSerializeVar(msText4, eSerializeType_WString) kSerializeVar(mfText4Delay, eSerializeType_Float32)
...
kBeginSerializeBase(cLuxCollideCallback_SaveData) kSerializeVar(mlCollideEntity, eSerializeType_Int32)
    kSerializeVar(msCallbackFunc, eSerializeType_String) kSerializeVar(mbDeleteWhenColliding, eSerializeType_Bool)
        kSerializeVar(mlStates, eSerializeType_Int32) kSerializeVar(mbColliding, eSerializeType_Bool) kEndSerialize()
    ...
    kBeginSerializeBase(cLuxProp_AttachedProp) kSerializeVar(msFileName, eSerializeType_String)
        kSerializeVar(msName, eSerializeType_String) kSerializeVar(m_mtxOffset, eSerializeType_Matrixf) kEndSerialize()
