...
bool cLuxHandObject_LightSource::DoAction(eLuxPlayerAction aAction, bool abPressed) { return false; }

//-----------------------------------------------------------------------

bool cLuxHandObject_LightSource::AnimationIsOver() { return true; }
