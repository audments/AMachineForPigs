...
kBeginSerialize(cLuxPlayerState_InteractSwingDoor_SaveData, iLuxPlayerState_InteractRotateBase_SaveData) kEndSerialize()
...
void cLuxPlayerState_InteractSwingDoor::SaveToSaveData(iLuxPlayerState_SaveData *apSaveData) {
    ...
    cLuxPlayerState_InteractSwingDoor_SaveData *pData =
        static_cast<cLuxPlayerState_InteractSwingDoor_SaveData *>(apSaveData);
...
void cLuxPlayerState_InteractSwingDoor::LoadFromSaveDataBeforeEnter(cLuxMap *apMap,
...
void cLuxPlayerState_InteractSwingDoor::LoadFromSaveDataAfterEnter(cLuxMap *apMap,
                                                                   iLuxPlayerState_SaveData *apSaveData) {
    ///////////////////////
    // Init
