...
class cLuxInventory : public iLuxUpdateable {
  ...
  public:
    ...
    cLuxInventory_Item *AddItem(const tString &asName, eLuxItemType aType, const tString &asSubTypeName,
                                const tString &asImageName, float afAmount, const tString &asVal,
                                const tString &asExtraVal, bool *apRemoveItemProp = NULL);
    ...
    void AddCombineCallback(const tString &asName, const tString &asItemA, const tString &asItemB,
  ...
  private:
    ...
    void DrawElementAtCenter(const cVector3f &avCenter, cGuiGfxElement *apGfx, float afAlpha,
                             const cVector2f &avSize = -1, bool abMulColWithAlpha = false);
     ...
     */
    void DrawFrameAroundWidget(cGuiGfxElement **apGfxCorners, cGuiGfxElement **apGfxBorders, iWidget *apWidget,
     ...
     */
    void DrawFrame(cGuiGfxElement **apGfxFrameCorners, cGuiGfxElement **apGfxFrameBorders, const cVector3f &avPosition,
