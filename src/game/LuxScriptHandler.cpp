...
static iLuxArea *ToArea(iLuxEntity *apEntity) { return static_cast<iLuxArea *>(apEntity); }

static cLuxArea_Sticky *ToStickyArea(iLuxEntity *apEntity) { return static_cast<cLuxArea_Sticky *>(apEntity); }

static iLuxProp *ToProp(iLuxEntity *apEntity) { return static_cast<iLuxProp *>(apEntity); }

static cLuxProp_Object *ToObject(iLuxEntity *apEntity) { return static_cast<cLuxProp_Object *>(apEntity); }

static cLuxProp_Lamp *ToLamp(iLuxEntity *apEntity) { return static_cast<cLuxProp_Lamp *>(apEntity); }
static cLuxProp_SwingDoor *ToSwingDoor(iLuxEntity *apEntity) { return static_cast<cLuxProp_SwingDoor *>(apEntity); }
static cLuxProp_Lever *ToLever(iLuxEntity *apEntity) { return static_cast<cLuxProp_Lever *>(apEntity); }
static cLuxProp_Wheel *ToWheel(iLuxEntity *apEntity) { return static_cast<cLuxProp_Wheel *>(apEntity); }
static cLuxProp_MoveObject *ToMoveObject(iLuxEntity *apEntity) { return static_cast<cLuxProp_MoveObject *>(apEntity); }
static iLuxEnemy *ToEnemy(iLuxEntity *apEntity) { return static_cast<iLuxEnemy *>(apEntity); }
static cLuxEnemy_ManPig *ToManPig(iLuxEntity *apEntity) { return static_cast<cLuxEnemy_ManPig *>(apEntity); }
static cLuxProp_LevelDoor *ToLevelDoor(iLuxEntity *apEntity) { return static_cast<cLuxProp_LevelDoor *>(apEntity); }
static cLuxProp_Button *ToButton(iLuxEntity *apEntity) { return static_cast<cLuxProp_Button *>(apEntity); }

static cLuxProp_NPC *ToNPC(iLuxEntity *apEntity) { return static_cast<cLuxProp_NPC *>(apEntity); }
...
bool cLuxScriptHandler::GetEntities(const tString &asName, tLuxEntityList &alstEntities, eLuxEntityType aType,
                                    int alSubType) {
...
#define BEGIN_ITERATE_PARTICLESYSTEM()                                                                                 \
    ...
    if (GetParticleSystems(asName, lstParticleSystems) == false)                                                       \
        return;                                                                                                        \
    for (std::list<cParticleSystem *>::iterator it = lstParticleSystems.begin(); it != lstParticleSystems.end();       \
         ++it) {                                                                                                       \
...
void cLuxScriptHandler::InitScriptFunctions() {
    ...
    AddFunc("void CheckPoint(string &in asString1, string &in asString2, string &in asString3, string &in asString4, "
            "string &in asString5)",
            (void *)CheckPoint);
    ...
    AddFunc("void StartCredits(string &in asMusic, bool abLoopMusic, string &in asTextCat, string &in asTextEntry, int "
            "alEndNum)",
            (void *)StartCredits);
    ...
    AddFunc("void CheckPoint(string &in asName,string &in asStartPos ,string &in asCallback, string &in "
            "asDeathHintCat, string &in asDeathHintEntry, bool abPlayerDark)",
            (void *)CheckPoint);
    ...
    AddFunc("void SetFogProperties(float afStart, float afEnd, float afFalloffExp, bool abCulling)",
    ...
    AddFunc("void StartEffectEmotionFlash(string &in asTextCat, string &in asTextEntry, string &in asSound)",
            (void *)StartEffectEmotionFlash);

    AddFunc("void AddEffectVoice(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
            "asTextEntry, bool abUsePostion,  string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
            (void *)AddEffectVoice);
    AddFunc("void AddEffectVoice(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
            "asTextEntry, bool abUsePostion,  string &in asPosEnitity, float afMinDistance, float afMaxDistance, int "
            "alPriority, bool abStopInterrupted)",
            (void *)AddEffectVoiceExt);

    AddFunc("void AddEffectVoice2(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
            "asTextEntry, float afTextDelay, string &in asText2Entry, float afText2Delay, bool abUsePostion,  string "
            "&in asPosEnitity, float afMinDistance, float afMaxDistance)",
            (void *)AddEffectVoice2);
    AddFunc(
        "void AddEffectVoice3(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
        "asTextEntry, float afTextDelay, string &in asText2Entry, float afText2Delay, string &in asText3Entry, float "
        "afText3Delay, bool abUsePostion,  string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
        (void *)AddEffectVoice3);
    AddFunc("void AddEffectVoice4(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
            "asTextEntry, float afTextDelay, string &in asText2Entry, float afText2Delay, string &in asText3Entry, "
            "float afText3Delay, string &in asText4Entry, float afText4Delay, bool abUsePostion, string &in "
            "asPosEnitity, float afMinDistance, float afMaxDistance)",
            (void *)AddEffectVoice4);
    AddFunc("void AddEffectVoice5(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
            "asTextEntry, float afTextDelay, string &in asText2Entry, float afText2Delay, string &in asText3Entry, "
            "float afText3Delay, string &in asText4Entry, float afText4Delay, string &in asText5Entry, float "
            "afText5Delay, bool abUsePostion, string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
            (void *)AddEffectVoice5);
    AddFunc("void AddEffectVoice6(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
            "asTextEntry, float afTextDelay, string &in asText2Entry, float afText2Delay, string &in asText3Entry, "
            "float afText3Delay, string &in asText4Entry, float afText4Delay, string &in asText5Entry, float "
            "afText5Delay, string &in asText6Entry, float afText6Delay, bool abUsePostion, string &in asPosEnitity, "
            "float afMinDistance, float afMaxDistance)",
            (void *)AddEffectVoice6);
    AddFunc("void AddEffectVoice7(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in "
            "asTextEntry, float afTextDelay, string &in asText2Entry, float afText2Delay, string &in asText3Entry, "
            "float afText3Delay, string &in asText4Entry, float afText4Delay, string &in asText5Entry, float "
            "afText5Delay, string &in asText6Entry, float afText6Delay, string &in asText7Entry, float afText7Delay, "
            "bool abUsePostion, string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
    ...
    AddFunc("void StartScreenShake(float afAmount, float afTime, float afFadeInTime,float afFadeOutTime)",
            (void *)StartScreenShake);
    AddFunc("bool GetFlashbackIsActive()", (void *)GetFlashbackIsActive);

    AddFunc("void ShowScreenImage(string &in asImageName, float afX, float afY, float afScale, bool "
            "abUseRelativeCoordinates, float afDuration, float afFadeIn, float afFadeOut)",
    ...
    AddFunc("void AddPlayerBodyForce(float afX, float afY, float afZ, bool abUseLocalCoords)",
            (void *)AddPlayerBodyForce);
    ...
    AddFunc("void GivePlayerDamage(float afAmount, string &in asType, bool abSpinHead, bool abLethal)",
    ...
    AddFunc("void MovePlayerHeadPos(float afX, float afY, float afZ, float afSpeed, float afSlowDownDist)",
            (void *)MovePlayerHeadPos);

    AddFunc("void StartPlayerLookAt(string &in asEntityName, float afSpeedMul, float afMaxSpeed,string &in "
            "asAtTargetCallback)",
    ...
    AddFunc("void GiveHint(string &in asName, string &in asMessageCat, string &in asMessageEntry, float afTimeShown)",
            (void *)GiveHint);
    ...
    // AddFunc("void SetInventoryMessage(string &in asTextCategory, string &in asTextEntry, float afTime)",(void
    // *)SetInventoryMessage);

    AddFunc("void GiveItem(string &in asName, string &in asType, string &in asSubTypeName, string &in asImageName, "
            "float afAmount)",
            (void *)GiveItem);
    ...
    AddFunc("void AddCombineCallback(string &in asName, string &in asItemA, string &in asItemB, string &in asFunction, "
            "bool abAutoDestroy)",
            (void *)AddCombineCallback);
    AddFunc("void RemoveCombineCallback(string &in asName)", (void *)RemoveCombineCallback);

    AddFunc("void AddUseItemCallback(string &in asName, string &in asItem, string &in asEntity, string &in asFunction, "
            "bool abAutoDestroy)",
    ...
    AddFunc("void CreateParticleSystemAtEntity(string &in asPSName, string &in asPSFile, string &in asEntity, bool "
            "abSavePS)",
            (void *)CreateParticleSystemAtEntity);
    AddFunc("void CreateParticleSystemAtEntityExt(	string &in asPSName, string &in asPSFile, string &in asEntity, "
            "bool abSavePS, float afR, float afG, float afB, float afA, bool abFadeAtDistance, float afFadeMinEnd, "
            "float afFadeMinStart, float afFadeMaxStart, float afFadeMaxEnd)",
    ...
    AddFunc("void PlaySoundAtEntity(string &in asSoundName, string &in asSoundFile, string &in asEntity, float "
            "afFadeSpeed, bool abSaveSound)",
            (void *)PlaySoundAtEntity);
    AddFunc("void PlaySoundAtPosition(string &in asSoundName, string &in asSoundFile, float afX, float afY, float afZ, "
            "float afFadeSpeed, bool abSaveSound)",
    ...
    AddFunc("void PlayMusic(string &in asMusicFile, bool abLoop, float afVolume, float afFadeTime, int alPrio, bool "
            "abResume)",
            (void *)PlayMusic);
    ...
    AddFunc("void FadeLightTo(string &in asLightName, float afR, float afG, float afB, float afA, float afRadius, "
            "float afTime)",
            (void *)FadeLightTo);
    ...
    AddFunc("void SetEntityCustomFocusCrossHair(string &in asName, string &in asCrossHair)",
            (void *)SetEntityCustomFocusCrossHair);
    AddFunc("void CreateEntityAtArea(string &in asEntityName, string &in asEntityFile, string &in asAreaName, bool "
            "abFullGameSave, float afPosX, float afPosY, float afPosZ, float afRotX, float afRotY, float afRotZ)",
            (void *)CreateEntityAtArea);
    AddFunc("void SetEntityPlayerLookAtCallback(string &in asName, string &in asCallback, bool abRemoveWhenLookedAt)",
    ...
    AddFunc("void SetEntityConnectionStateChangeCallback(string &in asName, string &in asCallback)",
            (void *)SetEntityConnectionStateChangeCallback);
    AddFunc("void SetEntityInteractionDisabled(string &in asName, bool abDisabled)",
    ...
    AddFunc("void SetPropEffectActive(string &in asName, bool abActive, bool abFadeAndPlaySounds)",
            (void *)SetPropEffectActive);
    AddFunc("void SetPropActiveAndFade(string &in asName, bool abActive, float afFadeTime)",
    ...
    AddFunc("void RotatePropToSpeed(string &in asName, float afAcc, float afGoalSpeed, float afAxisX, float afAxisY, "
            "float afAxisZ, bool abResetSpeed, string &in asOffsetArea)",
            (void *)RotatePropToSpeed);
    AddFunc("void StopPropMovement(string &in asName)", (void *)StopPropMovement);

    AddFunc("void AttachPropToBone(string &in asChildEntityName, string &in asParentEntityName, string &in "
            "asParentBoneName, float fPosX, float fPosY, float fPosZ, float fRotX, float fRotY, float fRotZ)",
            (void *)AttachPropToBone);
    AddFunc("void DetachPropFromBone(string &in asChildEntityName)", (void *)DetachPropFromBone);

    AddFunc("void AddAttachedPropToProp(string &in asPropName, string &in asAttachName, string &in asAttachFile, float "
            "fPosX, float fPosY, float fPosZ, float fRotX, float fRotY, float fRotZ)",
            (void *)AddAttachedPropToProp);
    AddFunc("void RemoveAttachedPropFromProp(string &in asPropName, string &in asAttachName)",
    ...
    AddFunc("void SetSwingDoorDisableAutoClose(string &in asName, bool abDisableAutoClose)",
            (void *)SetSwingDoorDisableAutoClose);
    AddFunc("void SetSwingDoorOpenAmount(string &in asName, float afOpenAmount, float afDuration, bool "
            "abOpenTowardsMaxAngle)",
            (void *)SetSwingDoorOpenAmount);
    ...
    AddFunc("void SetLevelDoorLockedText(string &in asName, string &in asTextCat, string &in asTextEntry)",
            (void *)SetLevelDoorLockedText);
    ...
    AddFunc("void SetWheelInteractionDisablesStuck(string &in asName, bool abX)",
            (void *)SetWheelInteractionDisablesStuck);
    AddFunc("void SetLeverInteractionDisablesStuck(string &in asName, bool abX)",
            (void *)SetLeverInteractionDisablesStuck);
    AddFunc("int GetLeverState(string &in asName)", (void *)GetLeverState);

    AddFunc("void SetMultiSliderStuckState(string &in asName, int alStuckState, bool abEffects)",
            (void *)SetMultiSliderStuckState);
    AddFunc("void SetMultiSliderCallback(string &in asName, string &in asCallback)", (void *)SetMultiSliderCallback);

    AddFunc("void SetButtonSwitchedOn(string &in asName, bool abSwitchedOn, bool abEffects)",
            (void *)SetButtonSwitchedOn);
    AddFunc("void SetButtonCanBeSwitchedOn(string &in asName, bool abCanBeSwitchedOn)",
            (void *)SetButtonCanBeSwitchedOn);
    AddFunc("void SetButtonCanBeSwitchedOff(string &in asName, bool abCanBeSwitchedOff)",
            (void *)SetButtonCanBeSwitchedOff);
    ...
    AddFunc("void AddEnemyPatrolNode(string &in asEnemyName, string &in asNodeName, float afWaitTime, string &in "
            "asAnimation, bool abLoopAnimation)",
            (void *)AddEnemyPatrolNode);
    AddFunc("void ClearEnemyPatrolNodes(string &in asEnemyName)", (void *)ClearEnemyPatrolNodes);
    AddFunc("void PlayEnemyAnimation(string &in asEnemyName, string &in asAnimName, bool abLoop, float afFadeTime)",
            (void *)PlayEnemyAnimation);
    AddFunc("void TeleportEnemyToNode(string &in asEnemyName, string &in asNodeName, bool abChangeY)",
            (void *)TeleportEnemyToNode);
    ...
    AddFunc("void PlayScriptedAnimation(string &in asEnemyName, string &in asAnimationName, bool abLoopAnimation)",
    ...
    AddFunc("void PlayPropAnimation(string &in asProp, string &in asAnimation, float afFadeTime, bool abLoop, string "
            "&in asCallback)",
            (void *)PlayPropAnimation);
    AddFunc("void StopPropAnimation(string &in asProp)", (void *)StopPropAnimation);
    AddFunc("void PlayCurrentPropAnimation(string &in asProp, float afFadeTime, bool abLoop)",
    ...
    AddFunc("void SetMoveObjectStateExt(string &in asName, float afState, float afAcc, float afMaxSpeed, float "
            "afSlowdownDist, bool abResetSpeed)",
            (void *)SetMoveObjectStateExt);

    AddFunc("void AddPropForce(string &in asName, float afX, float afY, float afZ, string &in asCoordSystem)",
            (void *)AddPropForce);
    AddFunc("void AddPropImpulse(string &in asName, float afX, float afY, float afZ, string &in asCoordSystem)",
            (void *)AddPropImpulse);
    AddFunc("void AddBodyForce(string &in asName, float afX, float afY, float afZ, string &in asCoordSystem)",
            (void *)AddBodyForce);
    AddFunc("void AddBodyImpulse(string &in asName, float afX, float afY, float afZ, string &in asCoordSystem)",
            (void *)AddBodyImpulse);
    AddFunc("void BreakJoint(string &in asName)", (void *)BreakJoint);

    AddFunc("void AddEntityCollideCallback(string &in asParentName, string &in asChildName, string &in asFunction, "
            "bool abDeleteOnCollide, int alStates)",
            (void *)AddEntityCollideCallback);
    AddFunc("void RemoveEntityCollideCallback(string &in asParentName, string &in asChildName)",
            (void *)RemoveEntityCollideCallback);

    // AddFunc("void CreateRope(string &in asName,string &in asStartArea, string &in asEndArea, string &in asStartBody,
    // string &in asEndBody,float afMinTotalLength, float afMaxTotalLength,float afSegmentLength, float afDamping,float
    // afStrength, float afStiffness, string &in asMaterial, float afRadius, float afLengthTileAmount, float
    // afLengthTileSize, string &in asSound,float afSoundStartSpeed, float afSoundStopSpeed,bool abAutoMove, float
    // afAutoMoveAcc, float afAutoMoveMaxSpeed)",(void *)CreateRope);

    AddFunc("void InteractConnectPropWithRope(string &in asName, string &in asLeverName, string &in asPropName, bool "
            "abInteractOnly, float afSpeedMul,float afMinSpeed, float afMaxSpeed, bool abInvert, int alStatesUsed)",
            (void *)InteractConnectPropWithRope);
    AddFunc("void InteractConnectPropWithMoveObject(string &in asName, string &in asPropName, string &in "
            "asMoveObjectName, bool abInteractOnly,bool abInvert, int alStatesUsed)",
            (void *)InteractConnectPropWithMoveObject);
    AddFunc("void ConnectEntities(string &in asName, string &in asMainEntity, string &in asConnectEntity, bool "
            "abInvertStateSent, int alStatesUsed, string &in asCallbackFunc)",
...
void __stdcall cLuxScriptHandler::Print(string &asString) { Log("%s", asString.c_str()); }
...
bool __stdcall cLuxScriptHandler::ScriptDebugOn() { return gpBase->mpDebugHandler->GetScriptDebugOn(); }

//-----------------------------------------------------------------------

float __stdcall cLuxScriptHandler::RandFloat(float afMin, float afMax) { return cMath::RandRectf(afMin, afMax); }

int __stdcall cLuxScriptHandler::RandInt(int alMin, int alMax) { return cMath::RandRectl(alMin, alMax); }
...
void __stdcall cLuxScriptHandler::StartCredits(string &asMusic, bool abLoopMusic, string &asTextCat,
                                               string &asTextEntry, int alEndNum) {
...
void __stdcall cLuxScriptHandler::AddKeyPart(int alKeyPart) { gpBase->mpCredits->AddKeyPart(alKeyPart); }
...
void __stdcall cLuxScriptHandler::AutoSave() { gpBase->mpSaveHandler->AutoSave(); }

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::CheckPoint(string &asName, string &asStartPos, string &asCallback,
...
void __stdcall cLuxScriptHandler::ReleasePlayerFromLimbo() { gpBase->mpPlayer->ReleasePlayerFromLimbo(); }

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::ChangeMap(string &asMapName, string &asStartPos, string &asStartSound,
                                            string &asEndSound) {
...
void __stdcall cLuxScriptHandler::ClearSavedMaps() { gpBase->mpMapHandler->ClearSaveMapCollection(); }

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::CreateDataCache() { gpBase->mpMapHandler->CreateDataCache(); }

void __stdcall cLuxScriptHandler::DestroyDataCache() { gpBase->mpMapHandler->DestroyDataCache(); }
...
void __stdcall cLuxScriptHandler::SetupLoadScreen(string &asTextCat, string &asTextEntry, int alRandomNum,
                                                  string &asImageFile) {
...
void __stdcall cLuxScriptHandler::FadeIn(float afTime) { gpBase->mpEffectHandler->GetFade()->FadeIn(afTime); }

void __stdcall cLuxScriptHandler::FadeOut(float afTime) { gpBase->mpEffectHandler->GetFade()->FadeOut(afTime); }
...
void __stdcall cLuxScriptHandler::ShowScreenImage(string &asImageName, float afX, float afY, float afScale,
                                                  bool abUseRelativeCoordinates, float afDuration, float afFadeIn,
                                                  float afFadeOut) {
    gpBase->mpEffectHandler->GetScreenImage()->ShowImage(asImageName, afX, afY, afScale, abUseRelativeCoordinates,
                                                         afDuration, afFadeIn, afFadeOut);
}
...
void __stdcall cLuxScriptHandler::AddEffectVoice(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                 string &asTextEntry, bool abUsePostion, string &asPosEntity,
                                                 float afMinDistance, float afMaxDistance) {
    cVector3f vPos(0);
    if (abUsePostion) {
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, abUsePostion,
                                                      vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice2(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                  string &asTextEntry, float afTextDelay, string &asText2Entry,
                                                  float afText2Delay, bool abUsePostion, string &asPosEntity,
                                                  float afMinDistance, float afMaxDistance) {
    cVector3f vPos(0);
    if (abUsePostion) {
        iLuxEntity *pEntity = GetEntity(asPosEntity, eLuxEntityType_LastEnum, -1);
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(
        asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, "", 0, "", 0, "", 0,
        "", 0, "", 0, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice3(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                  string &asTextEntry, float afTextDelay, string &asText2Entry,
                                                  float afText2Delay, string &asText3Entry, float afText3Delay,
                                                  bool abUsePostion, string &asPosEntity, float afMinDistance,
                                                  float afMaxDistance) {
    cVector3f vPos(0);
    if (abUsePostion) {
        iLuxEntity *pEntity = GetEntity(asPosEntity, eLuxEntityType_LastEnum, -1);
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(
        asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
        afText3Delay, "", 0, "", 0, "", 0, "", 0, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice4(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                  string &asTextEntry, float afTextDelay, string &asText2Entry,
                                                  float afText2Delay, string &asText3Entry, float afText3Delay,
                                                  string &asText4Entry, float afText4Delay, bool abUsePostion,
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(
        asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
        afText3Delay, asText4Entry, afText4Delay, "", 0, "", 0, "", 0, abUsePostion, vPos, afMinDistance,
        afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice5(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                  string &asTextEntry, float afTextDelay, string &asText2Entry,
                                                  float afText2Delay, string &asText3Entry, float afText3Delay,
                                                  string &asText4Entry, float afText4Delay, string &asText5Entry,
                                                  float afText5Delay, bool abUsePostion, string &asPosEntity,
                                                  float afMinDistance, float afMaxDistance) {
    cVector3f vPos(0);
    if (abUsePostion) {
        iLuxEntity *pEntity = GetEntity(asPosEntity, eLuxEntityType_LastEnum, -1);
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(
        asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
        afText3Delay, asText4Entry, afText4Delay, asText5Entry, afText5Delay, "", 0, "", 0, abUsePostion, vPos,
        afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice6(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                  string &asTextEntry, float afTextDelay, string &asText2Entry,
                                                  float afText2Delay, string &asText3Entry, float afText3Delay,
                                                  string &asText4Entry, float afText4Delay, string &asText5Entry,
                                                  float afText5Delay, string &asText6Entry, float afText6Delay,
                                                  bool abUsePostion, string &asPosEntity, float afMinDistance,
                                                  float afMaxDistance) {
    cVector3f vPos(0);
    if (abUsePostion) {
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(
        asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
        afText3Delay, asText4Entry, afText4Delay, asText5Entry, afText5Delay, asText6Entry, afText6Delay, "", 0,
        abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice7(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                  string &asTextEntry, float afTextDelay, string &asText2Entry,
                                                  float afText2Delay, string &asText3Entry, float afText3Delay,
                                                  string &asText4Entry, float afText4Delay, string &asText5Entry,
                                                  float afText5Delay, string &asText6Entry, float afText6Delay,
                                                  string &asText7Entry, float afText7Delay, bool abUsePostion,
                                                  string &asPosEntity, float afMinDistance, float afMaxDistance) {
    cVector3f vPos(0);
    if (abUsePostion) {
        iLuxEntity *pEntity = GetEntity(asPosEntity, eLuxEntityType_LastEnum, -1);
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(
        asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
        afText3Delay, asText4Entry, afText4Delay, asText5Entry, afText5Delay, asText6Entry, afText6Delay, asText7Entry,
        afText7Delay, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoiceExt(string &asVoiceFile, string &asEffectFile, string &asTextCat,
                                                    string &asTextEntry, bool abUsePostion, string &asPosEntity,
                                                    float afMinDistance, float afMaxDistance, int alPriority,
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, abUsePostion,
                                                      vPos, afMinDistance, afMaxDistance, alPriority, abStopInterrupt);
}
...
bool __stdcall cLuxScriptHandler::GetEffectVoiceActive() { return gpBase->mpEffectHandler->GetPlayVoice()->IsActive(); }
...
void __stdcall cLuxScriptHandler::StopPlayerSpawnPS() { gpBase->mpPlayer->GetHelperSpawnPS()->Stop(); }
...
void __stdcall cLuxScriptHandler::StartScreenShake(float afAmount, float afTime, float afFadeInTime,
                                                   float afFadeOutTime) {
...
bool __stdcall cLuxScriptHandler::GetFlashbackIsActive() { return gpBase->mpPlayer->GetHelperFlashback()->IsActive(); }
...
void __stdcall cLuxScriptHandler::SetPlayerActive(bool abActive) { gpBase->mpPlayer->SetActive(abActive); }

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::ChangePlayerStateToNormal() { gpBase->mpPlayer->ChangeState(eLuxPlayerState_Normal); }
...
void __stdcall cLuxScriptHandler::SetPlayerCrouching(bool abCrouch) {
    ...
    cLuxMoveState_Normal *pState =
        static_cast<cLuxMoveState_Normal *>(gpBase->mpPlayer->GetMoveStateData(eLuxMoveState_Normal));
...
void __stdcall cLuxScriptHandler::SetPlayerInfection(float afInfection) { gpBase->mpPlayer->SetInfection(afInfection); }

void __stdcall cLuxScriptHandler::AddPlayerInfection(float afInfection) { gpBase->mpPlayer->AddInfection(afInfection); }

float __stdcall cLuxScriptHandler::GetPlayerInfection() { return gpBase->mpPlayer->GetInfection(); }

void __stdcall cLuxScriptHandler::SetPlayerHealth(float afHealth) { gpBase->mpPlayer->SetHealth(afHealth); }

void __stdcall cLuxScriptHandler::AddPlayerHealth(float afHealth) { gpBase->mpPlayer->AddHealth(afHealth); }

float __stdcall cLuxScriptHandler::GetPlayerHealth() { return gpBase->mpPlayer->GetHealth(); }
...
void __stdcall cLuxScriptHandler::MovePlayerHeadPos(float afX, float afY, float afZ, float afSpeed,
...
void __stdcall cLuxScriptHandler::StartPlayerLookAt(string &asEntityName, float afSpeedMul, float afMaxSpeed,
...
void __stdcall cLuxScriptHandler::StopPlayerLookAt() { gpBase->mpPlayer->GetHelperLookAt()->SetActive(false); }

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::SetPlayerMoveSpeedMul(float afMul) { gpBase->mpPlayer->SetScriptMoveSpeedMul(afMul); }

void __stdcall cLuxScriptHandler::SetPlayerRunSpeedMul(float afMul) { gpBase->mpPlayer->SetScriptRunSpeedMul(afMul); }

void __stdcall cLuxScriptHandler::SetPlayerLookSpeedMul(float afMul) { gpBase->mpPlayer->SetLookSpeedMul(afMul); }

void __stdcall cLuxScriptHandler::SetPlayerJumpDisabled(bool abX) { gpBase->mpPlayer->SetJumpDisabled(abX); }

void __stdcall cLuxScriptHandler::SetPlayerCrouchDisabled(bool abX) { gpBase->mpPlayer->SetCrouchDisabled(abX); }
...
bool __stdcall cLuxScriptHandler::GetLanternActive() { return gpBase->mpPlayer->GetHelperLantern()->IsActive(); }
...
bool __stdcall cLuxScriptHandler::GetJournalDisabled() { return gpBase->mpJournal->GetDisabled(); }

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::SetJournalDisabled(bool abX) { gpBase->mpJournal->SetDisabled(abX); }
//-----------------------------------------------------------------------
...
void __stdcall cLuxScriptHandler::DisableDeathStartSound() { gpBase->mpPlayer->GetHelperDeath()->DisableStartSound(); }
...
void __stdcall cLuxScriptHandler::RemoveAllHints() { gpBase->mpJournal->RemoveAllHints(); }
...
void __stdcall cLuxScriptHandler::GiveHint(string &asName, string &asMessageCat, string &asMessageEntry,
                                           float afTimeShown) {
    gpBase->mpHintHandler->Add(asName, kTranslate(asMessageCat, asMessageEntry), afTimeShown);
}

void __stdcall cLuxScriptHandler::BlockHint(string &asName) { gpBase->mpHintHandler->Block(asName); }

void __stdcall cLuxScriptHandler::UnBlockHint(string &asName) { gpBase->mpHintHandler->UnBlock(asName); }
...
void __stdcall cLuxScriptHandler::SetInventoryDisabled(bool abX) { gpBase->mpInventory->SetDisabled(abX); }
...
void __stdcall cLuxScriptHandler::GiveItem(string &asName, string &asType, string &asSubTypeName, string &asImageName,
                                           float afAmount) {
    ...
    if (pEntity) {
        if (pEntity->GetEntityType() == eLuxEntityType_Prop) {
            ...
            if (pProp->GetPropType() == eLuxPropType_Item) {
                ...
                gpBase->mpInventory->AddItem(asName, pItem->GetItemType(), pItem->GetSubItemTypeName(),
...
void __stdcall cLuxScriptHandler::RemoveItem(string &asName) { gpBase->mpInventory->RemoveItem(asName); }

bool __stdcall cLuxScriptHandler::HasItem(string &asName) { return gpBase->mpInventory->GetItem(asName) != NULL; }

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddCombineCallback(string &asName, string &asItemA, string &asItemB,
...
void __stdcall cLuxScriptHandler::AddUseItemCallback(string &asName, string &asItem, string &asEntity,
                                                     string &asFunction, bool abAutoDestroy) {
    cLuxMap *pMap = gpBase->mpMapHandler->GetCurrentMap();
    if (pMap == NULL)
        return;
...
void __stdcall cLuxScriptHandler::CreateParticleSystemAtEntity(string &asPSName, string &asPSFile, string &asEntity,
                                                               bool abSavePS) {
    CreateParticleSystemAtEntityExt(asPSName, asPSFile, asEntity, abSavePS, 1, 1, 1, 1, false, 1, 2, 100, 110);
}

void __stdcall cLuxScriptHandler::CreateParticleSystemAtEntityExt(string &asPSName, string &asPSFile, string &asEntity,
                                                                  bool abSavePS, float afR, float afG, float afB,
                                                                  float afA, bool abFadeAtDistance, float afFadeMinEnd,
                                                                  float afFadeMinStart, float afFadeMaxStart,
                                                                  float afFadeMaxEnd) {
    cLuxMap *pMap = gpBase->mpMapHandler->GetCurrentMap();
    if (pMap == NULL)
        return;
...
void __stdcall cLuxScriptHandler::PlaySoundAtPosition(string &asSoundName, string &asSoundFile, float afX, float afY,
                                                      float afZ, float afFadeTime, bool abSaveSound) {
...
void __stdcall cLuxScriptHandler::PlaySoundAtEntity(string &asSoundName, string &asSoundFile, string &asEntity,
                                                    float afFadeTime, bool abSaveSound) {
    float fFadeSpeed = afFadeTime == 0 ? 0 : 1.0f / afFadeTime;
...
void __stdcall cLuxScriptHandler::FadeLightTo(string &asLightName, float afR, float afG, float afB, float afA,
    ...
    cColor newColor(afR >= 0 ? afR : pLight->GetDiffuseColor().r, afG >= 0 ? afG : pLight->GetDiffuseColor().g,
                    afB >= 0 ? afB : pLight->GetDiffuseColor().b, afA >= 0 ? afA : pLight->GetDiffuseColor().a);
...
void __stdcall cLuxScriptHandler::PlayMusic(string &asMusicFile, bool abLoop, float afVolume, float afFadeTime,
                                            int alPrio, bool abResume) {
...
void __stdcall cLuxScriptHandler::FadeGlobalSoundVolume(float afDestVolume, float afTime) {
    ...
    pSoundHandler->FadeGlobalVolume(afDestVolume, fSpeed, eSoundEntryType_World, eLuxGlobalVolumeType_Script,
                                    abDestroy);
}
...
void __stdcall cLuxScriptHandler::CreateEntityAtArea(string &asEntityName, string &asEntityFile, string &asAreaName,
                                                     bool abFullGameSave, float afPosX, float afPosY, float afPosZ,
    ...
    cMatrixf mtxTransform =
        cMath::MatrixRotate(cMath::Vector3ToRad(cVector3f(afRotX, afRotY, afRotZ)), eEulerRotationOrder_XYZ);
    mtxTransform.SetTranslation(cVector3f(afPosX, afPosY, afPosZ));

    pMap->ResetLatestEntity();
    pMap->CreateEntity(asEntityName, asEntityFile, cMath::MatrixMul(pArea->GetBody()->GetWorldMatrix(), mtxTransform),
                       1);
...
void __stdcall cLuxScriptHandler::SetEntityPlayerLookAtCallback(string &asName, string &asCallback,
...
void __stdcall cLuxScriptHandler::SetEntityPlayerInteractCallback(string &asName, string &asCallback,
...
void __stdcall cLuxScriptHandler::RotatePropToSpeed(string &asName, float afAcc, float afGoalSpeed, float afAxisX,
                                                    float afAxisY, float afAxisZ, bool abResetSpeed,
                                                    string &asOffsetArea) {
    iLuxArea *pArea = NULL;
    if (asOffsetArea != "") {
...
void __stdcall cLuxScriptHandler::AttachPropToBone(string &asChildEntityName, string &asParentEntityName,
                                                   string &asParentBoneName, float fPosX, float fPosY, float fPosZ,
    ...
    cMatrixf mtxTransform =
        cMath::MatrixRotate(cMath::Vector3ToRad(cVector3f(fRotX, fRotY, fRotZ)), eEulerRotationOrder_XYZ);
...
void __stdcall cLuxScriptHandler::AddAttachedPropToProp(string &asPropName, string &asAttachName, string &asAttachFile,
                                                        float afPosX, float afPosY, float afPosZ, float afRotX,
                                                        float afRotY, float afRotZ) {
...
void __stdcall cLuxScriptHandler::FadeLampTo(string &asName, float afR, float afG, float afB, float afA, float afRadius,
                                             float afTime) {
    BEGIN_SET_PROPERTY(eLuxEntityType_Prop, eLuxPropType_Lamp)
...
void __stdcall cLuxScriptHandler::SetSwingDoorOpenAmount(string &asName, float afOpenAmount, float afDuration,
                                                         bool abOpenTowardsMaxAngle) {
    BEGIN_SET_PROPERTY(eLuxEntityType_Prop, eLuxPropType_SwingDoor)
...
void __stdcall cLuxScriptHandler::SetAllowStickyAreaAttachment(bool abX) { cLuxArea_Sticky::SetAllowAttachment(abX); }
...
int __stdcall cLuxScriptHandler::StringToInt(string &asString) { return atoi(asString.c_str()); }
...
void __stdcall cLuxScriptHandler::ShowEnemyPlayerPosition(string &asName) {
    ...
    if (state != eLuxEnemyState_Hunt && state != eLuxEnemyState_HuntPause && state != eLuxEnemyState_AttackMeleeLong &&
        state != eLuxEnemyState_AttackMeleeShort && state != eLuxEnemyState_BreakDoor) {
...
void __stdcall cLuxScriptHandler::AddEnemyPatrolNode(string &asName, string &asNodeName, float afWaitTime,
                                                     string &asAnimation, bool abLoopAnimation) {
    BEGIN_SET_PROPERTY(eLuxEntityType_Enemy, -1)
...
void __stdcall cLuxScriptHandler::PlayEnemyAnimation(string &asName, string &asAnimName, bool abLoop,
                                                     float afFadeTime) {
    BEGIN_SET_PROPERTY(eLuxEntityType_Enemy, -1)
...
void __stdcall cLuxScriptHandler::SetMoveObjectStateExt(string &asName, float afState, float afAcc, float afMaxSpeed,
                                                        float afSlowdownDist, bool abResetSpeed) {
    BEGIN_SET_PROPERTY(eLuxEntityType_Prop, eLuxPropType_MoveObject)
...
void __stdcall cLuxScriptHandler::SetPlayerUsesDragFootsteps(bool abX) { gpBase->mpPlayer->SetUsesDragFootsteps(abX); }
...
void __stdcall cLuxScriptHandler::PlayPropAnimation(string &asProp, string &asAnimation, float afFadeTime, bool abLoop,
                                                    string &asCallback) {
...
void __stdcall cLuxScriptHandler::AddEntityCollideCallback(string &asName, string &asChildName, string &asFunction,
                                                           bool abDeleteOnCollide, int alStates) {
...
void __stdcall cLuxScriptHandler::AddPropImpulse(string &asName, float afX, float afY, float afZ,
                                                 string &asCoordSystem) {
    BEGIN_SET_PROPERTY(eLuxEntityType_Prop, -1)
...
void __stdcall cLuxScriptHandler::AddBodyImpulse(string &asName, float afX, float afY, float afZ,
                                                 string &asCoordSystem) {
    cLuxMap *pMap = gpBase->mpMapHandler->GetCurrentMap();
    iPhysicsBody *pBody = pMap->GetPhysicsWorld()->GetBody(asName);
    if (pBody == NULL) {
...
void __stdcall cLuxScriptHandler::InteractConnectPropWithRope(string &asName, string &asPropName, string &asRopeName,
                                                              bool abInteractOnly, float afSpeedMul, float afMinSpeed,
                                                              float afMaxSpeed, bool abInvert, int alStatesUsed) {
    cLuxMap *pMap = gpBase->mpMapHandler->GetCurrentMap();
    ...
    cLuxInteractConnection_Rope *pConnection =
        hplNew(cLuxInteractConnection_Rope, (asName, pProp, pRope, afSpeedMul, -cMath::Abs(afMinSpeed),
                                             cMath::Abs(afMaxSpeed), abInvert, alStatesUsed));
...
void __stdcall cLuxScriptHandler::InteractConnectPropWithMoveObject(string &asName, string &asPropName,
    ...
    cLuxProp_MoveObject *pSwingDoor =
        ToMoveObject(GetEntity(asMoveObjectName, eLuxEntityType_Prop, eLuxPropType_MoveObject));
    if (pSwingDoor == NULL) {
        return;
    }

    cLuxInteractConnection_MoveObject *pConnection =
        hplNew(cLuxInteractConnection_MoveObject, (asName, pProp, pSwingDoor, abInvert, alStatesUsed));
    pConnection->SetInteractionOnly(abInteractOnly);
...
void __stdcall cLuxScriptHandler::ConnectEntities(string &asName, string &asMainEntity, string &asConnectEntity,
                                                  bool abInvertStateSent, int alStatesUsed, string &asCallbackFunc) {
