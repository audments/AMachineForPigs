...
bool cLuxMoveState_ClimbLedge::GetAllowsInteraction() { return false; }

//-----------------------------------------------------------------------

bool cLuxMoveState_ClimbLedge::OnMove(eCharDir aDir, float afMul) { return false; }
bool cLuxMoveState_ClimbLedge::OnAddYaw(float afAmount) { return true; }
bool cLuxMoveState_ClimbLedge::OnAddPitch(float afAmount) { return true; }
