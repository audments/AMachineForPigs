...
bool cLuxArea_Examine::CanInteract(iPhysicsBody *apBody) { return true; }
...
kBeginSerialize(cLuxArea_Examine_SaveData, iLuxArea_SaveData)
    ...
    kSerializeVar(msDescCat, eSerializeType_String) kSerializeVar(msDescEntry, eSerializeType_String)

        kSerializeVar(msDescInfectedCat, eSerializeType_String)
            kSerializeVar(msDescInfectedEntry, eSerializeType_String)

                kSerializeVar(msSound, eSerializeType_String) kSerializeVar(msInfectedSound, eSerializeType_String)
...
iLuxEntity_SaveData *cLuxArea_Examine::CreateSaveData() { return hplNew(cLuxArea_Examine_SaveData, ()); }
...
void cLuxArea_Examine::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
