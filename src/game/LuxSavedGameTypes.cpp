...
kBeginSerializeBase(cLuxLoadScreenHandler_SaveData)
    ...
    kSerializeVar(msLoadTextCat, eSerializeType_String) kSerializeVar(msLoadTextEntry, eSerializeType_String)
        kSerializeVar(msLoadTextImage, eSerializeType_String) kSerializeVar(mlTextRandomNum, eSerializeType_Int32)
...
void cLuxEffectHandler_SaveData::ToEffectHandler(cLuxMap *apMap, cLuxEffectHandler *apEffects) {
    ...
    if (msVoice_Name != "") {
        if (mbVoice_3D == false) {
            apEffects->GetPlayVoice()->mpVoiceEntry =
                apEffects->GetPlayVoice()->mpSoundHandler->PlayGuiStream(msVoice_Name, false, 1.0f);
            ...
            if (msEffect_Name != "") {
                apEffects->GetPlayVoice()->mpEffectEntry =
                    apEffects->GetPlayVoice()->mpSoundHandler->PlayGuiStream(msEffect_Name, false, 1.0f);
        ...
        // 3D sound with position
            ...
            apEffects->GetPlayVoice()->mpVoiceEntry = apEffects->GetPlayVoice()->mpSoundHandler->Play(
                msVoice_Name, false, 1.0f, mvVoice_Position, mfVoice_MinDistance, mfVoice_MaxDistance,
            ...
            if (msEffect_Name != "") {
                apEffects->GetPlayVoice()->mpEffectEntry = apEffects->GetPlayVoice()->mpSoundHandler->Play(
                    msEffect_Name, false, 1.0f, mvVoice_Position, mfVoice_MinDistance, mfVoice_MaxDistance,
                    eSoundEntryType_Gui, false, true, 0, true);
                if (apEffects->GetPlayVoice()->mpEffectEntry) {
                    apEffects->GetPlayVoice()->mlEffectEntryID = apEffects->GetPlayVoice()->mpEffectEntry->GetId();
                    apEffects->GetPlayVoice()->mpEffectEntry->GetSoundChannel()->SetElapsedTime(mfVoice_ElapsedTime);
...
kBeginSerializeBase(cLuxEffectHandler_SoundMul_SaveData) kSerializeVar(mbActive, eSerializeType_Bool) kSerializeVar(
    mfVal, eSerializeType_Float32) kSerializeVar(mfDest, eSerializeType_Float32) kSerializeVar(mfSpeed,
                                                                                               eSerializeType_Float32)
    kSerializeVar(mTypes, eSerializeType_Int32) kSerializeVar(mbDestroyAtDest, eSerializeType_Bool) kEndSerialize()

        kBeginSerializeBase(cLuxEffectHandler_SaveData) kSerializeVar(mbFade_Active, eSerializeType_Bool) kSerializeVar(
            mfFade_GoalAlpha,
            eSerializeType_Float32) kSerializeVar(mfFade_Alpha,
                                                  eSerializeType_Float32) kSerializeVar(mfFade_FadeSpeed,
                                                                                        eSerializeType_Float32)

            kSerializeVar(mbImageTrail_Active, eSerializeType_Bool) kSerializeVar(mfImageTrail_Amount,
                                                                                  eSerializeType_Float32)
                kSerializeVar(mfImageTrail_AmountGoal, eSerializeType_Float32) kSerializeVar(mfImageTrail_FadeSpeed,
                                                                                             eSerializeType_Float32)

                    kSerializeVar(mbSepiaColor_Active, eSerializeType_Bool) kSerializeVar(mfSepiaColor_Amount,
                                                                                          eSerializeType_Float32)
                        kSerializeVar(mfSepiaColor_AmountGoal,
                                      eSerializeType_Float32) kSerializeVar(mfSepiaColor_FadeSpeed,
                                                                            eSerializeType_Float32)

                            kSerializeVar(mbRadialBlur_Active,
                                          eSerializeType_Bool) kSerializeVar(mfRadialBlur_Size, eSerializeType_Float32)
                                kSerializeVar(mfRadialBlur_BlurStartDist, eSerializeType_Float32) kSerializeVar(
                                    mfRadialBlur_SizeGoal, eSerializeType_Float32) kSerializeVar(mfRadialBlur_FadeSpeed,
                                                                                                 eSerializeType_Float32)

                                    kSerializeVar(msVoiceOverCallback,
                                                  eSerializeType_String) kSerializeVar(mbVoiceActive,
                                                                                       eSerializeType_Bool)
                                                            ...
                                                            kSerializeVar(mfVoice_MaxDistance, eSerializeType_Float32)
                                                                kSerializeVar(mvVoice_Position, eSerializeType_Vector3f)
                                                                    kSerializeVar(mbVoice_3D, eSerializeType_Bool)
                                                                        kSerializeVar(msEffect_Name,
                                                                                      eSerializeType_String)

                                                                            kSerializeClassContainer(
                                                                                mvGlobalSoundVolumeMul,
                                                                                cLuxEffectHandler_SoundMul_SaveData,
                                                                                eSerializeType_Class)
                                                                                kSerializeClassContainer(
                                                                                    mvGlobalSoundSpeedMul,
                                                                                    cLuxEffectHandler_SoundMul_SaveData,
                                                                                    eSerializeType_Class)
...
void cLuxMusicHandler_SaveData::ToMusicHandler(cLuxMap *apMap, cLuxMusicHandler *apMusic) {
    ...
    if (msCurrentMusic != "") {
        bool bRet =
            apMusic->mpMusicHandler->Play(msCurrentMusic, mfCurrentMusicMaxVolume, 0.1f, mbCurrentMusicLoop, false);
        if (bRet) {
            cMusicEntry *pMusicEntry = apMusic->mpMusicHandler->GetCurrentSong();
            if (pMusicEntry) {
...
kBeginSerializeBase(cLuxMusicHandler_Music_SaveData) kSerializeVar(msFile, eSerializeType_String)
    kSerializeVar(mfVolume, eSerializeType_Float32) kSerializeVar(mbLoop, eSerializeType_Bool)
        kSerializeVar(mbResume, eSerializeType_Bool) kSerializeVar(mbSpecialEffect, eSerializeType_Bool) kEndSerialize()
                                ...
                                kSerializeVar(mbEnemyClosePlaying, eSerializeType_Bool)
                                    kSerializeVar(mbAttackPlaying, eSerializeType_Bool)
                                        kSerializeVar(mbSearchPlaying, eSerializeType_Bool)
                                            ...
                                            kSerializeClassContainer(mvMusic, cLuxMusicHandler_Music_SaveData,
                                                                     eSerializeType_Class)
...
kBeginSerializeBase(cLuxJournal_SaveData) kSerializeVar(mlLastReadTextCat, eSerializeType_Int32)
    kSerializeVar(mlLastReadTextEntry, eSerializeType_Int32) kSerializeVar(mlLastReadTextType, eSerializeType_Int32)
        kSerializeVar(mlLastReadHint, eSerializeType_Int32) kSerializeVar(mlLastReadDocument, eSerializeType_Int32)
            kSerializeClassContainer(mvNotes, cLuxNote, eSerializeType_Class)
                kSerializeClassContainer(mvDiaryConts, cLuxJournal_DiaryCont_SaveData, eSerializeType_Class)
                    kSerializeClassContainer(mvQuestNotes, cLuxQuestNote, eSerializeType_Class)
                        kSerializeClassContainer(mvHints, cLuxHint, eSerializeType_Class) kEndSerialize()
...
kBeginSerializeBase(cLuxInventory_Item_SaveData) kSerializeVar(msName, eSerializeType_String)
    kSerializeVar(mlType, eSerializeType_Int32) kSerializeVar(msSubType, eSerializeType_String)
        kSerializeVar(msVal, eSerializeType_String) kSerializeVar(msExtraVal, eSerializeType_String)

            kSerializeVar(msImageFile, eSerializeType_String)

                kSerializeVar(mfAmount, eSerializeType_Float32) kSerializeVar(mlCount, eSerializeType_Int32)
                    kSerializeVar(msGameNameEntry, eSerializeType_String)
                        kSerializeVar(msGameDescEntry, eSerializeType_String) kEndSerialize()
...
void cLuxInventory_SaveData::ToInventory(cLuxMap *apMap, cLuxInventory *apInventory) {
    ...
    for (size_t i = 0; i < mvItems.Size(); ++i) {
        ...
        cLuxInventory_Item *pItem =
            apInventory->AddItem(saveItem.msName, (eLuxItemType)saveItem.mlType, saveItem.msSubType,
...
kBeginSerializeBase(cLuxInventory_SaveData) kSerializeVar(mbDisabled, eSerializeType_Bool)
    kSerializeVar(mlEquippedHandItem, eSerializeType_Int32)
        kSerializeClassContainer(mvItems, cLuxInventory_Item_SaveData, eSerializeType_Class)
            kSerializeClassContainer(mvCombineCallbacks, cLuxCombineItemsCallback, eSerializeType_Class) kEndSerialize()
...
kBeginSerializeBase(cLuxPlayerHands_SaveData) kSerializeVar(mlState, eSerializeType_Int32)
    kSerializeVar(msCurrentHandObject, eSerializeType_String) kSerializeVar(msCurrentAnim, eSerializeType_String)
                ...
                kSerializeVar(mlHandObjectState, eSerializeType_Int32)
                    kSerializeVar(mbHandObjectAttackDown, eSerializeType_Bool)
                        kSerializeVar(mbHandObjectInteractDown, eSerializeType_Bool)
                            kSerializeVar(mfHandObjectAlpha, eSerializeType_Float32) kEndSerialize()
...
void cLuxPlayer_SaveData::FromPlayer(cLuxPlayer *apPlayer) {
    ...
    cLuxMoveState_Normal *pMoveNormal =
        static_cast<cLuxMoveState_Normal *>(apPlayer->GetMoveStateData(eLuxMoveState_Normal));
    ...
    //////////////////////
    /// Collide callbacks
    for (tLuxCollideCallbackListIt it = apPlayer->mlstCollideCallbacks.begin();
         it != apPlayer->mlstCollideCallbacks.end(); ++it) {
...
void cLuxPlayer_SaveData::ToPlayer(cLuxMap *apMap, cLuxPlayer *apPlayer) {
    ...
    while (flashIt.HasNext()) {
        ...
        apPlayer->GetHelperFlashback()->mlstFlashbackQueue.push_back(
            cLuxFlashbackData(saveData.msFile, saveData.msCallback));
    }
...
kBeginSerializeBase(cLuxFlashbackData_SaveData)
    ...
    kSerializeVar(msFile, eSerializeType_String) kSerializeVar(msCallback, eSerializeType_String)

        kEndSerialize()

            kBeginSerializeBase(cLuxPlayer_SaveData)

                kSerializeVar(mlState, eSerializeType_Int32) kSerializeVar(mpStateData, eSerializeType_ClassPointer)

                    kSerializeVar(mbActive, eSerializeType_Bool)

                        kSerializeVar(mfHealth, eSerializeType_Float32) kSerializeVar(mfInfection, eSerializeType_Float32) kSerializeVar(
                            mfTerror,
                            eSerializeType_Float32) kSerializeVar(mlCoins,
                                                                  eSerializeType_Int32) kSerializeVar(mlTinderboxes,
                                                                                                      eSerializeType_Int32)

                            kSerializeVar(mbIsInWater, eSerializeType_Bool) kSerializeVar(
                                msWaterStepSound, eSerializeType_String) kSerializeVar(mfWaterSpeedMul,
                                                                                       eSerializeType_Float32)

                                kSerializeVar(mbJumpDisabled, eSerializeType_Bool) kSerializeVar(mbCrouchDisabled,
                                                                                                 eSerializeType_Bool)

                                    kSerializeVar(mbCrouching, eSerializeType_Bool)

                                        kSerializeVar(mfInteractionMoveSpeedMul, eSerializeType_Float32) kSerializeVar(
                                            mfEventMoveSpeedMul,
                                            eSerializeType_Float32) kSerializeVar(mfEventRunSpeedMul,
                                                                                  eSerializeType_Float32) kSerializeVar(mfScriptMoveSpeedMul,
                                                                                                                        eSerializeType_Float32)
                                            kSerializeVar(mfScriptRunSpeedMul, eSerializeType_Float32) kSerializeVar(mfLookSpeedMul, eSerializeType_Float32) kSerializeVar(
                                                mfHurtMoveSpeedMul,
                                                eSerializeType_Float32) kSerializeVar(mfInfectionCollapseSpeedMul,
                                                                                      eSerializeType_Float32) kSerializeVar(mfStaminaSpeedMul,
                                                                                                                            eSerializeType_Float32)

                                                kSerializeVar(mfAspectMul, eSerializeType_Float32) kSerializeVar(
                                                    mfFOVMul,
                                                    eSerializeType_Float32) kSerializeVar(mfAspectMulGoal,
                                                                                          eSerializeType_Float32)
                                                    kSerializeVar(mfFOVMulGoal, eSerializeType_Float32) kSerializeVar(
                                                        mfAspectMulSpeed,
                                                        eSerializeType_Float32) kSerializeVar(mfFOVMulSpeed,
                                                                                              eSerializeType_Float32)

                                                        kSerializeVar(mfRoll, eSerializeType_Float32) kSerializeVar(mfRollGoal, eSerializeType_Float32) kSerializeVar(
                                                            mfRollSpeedMul,
                                                            eSerializeType_Float32) kSerializeVar(mfRollMaxSpeed,
                                                                                                  eSerializeType_Float32)

                                                            kSerializeVar(mbFadingPitch, eSerializeType_Bool) kSerializeVar(mfPitchGoal, eSerializeType_Float32) kSerializeVar(
                                                                mfPitchSpeedMul,
                                                                eSerializeType_Float32) kSerializeVar(mfPitchMaxSpeed, eSerializeType_Float32)

                                                                kSerializeVar(mvCamAnimPos, eSerializeType_Vector3f) kSerializeVar(
                                                                    mvCamAnimPosGoal,
                                                                    eSerializeType_Vector3f) kSerializeVar(mfCamAnimPosSpeedMul,
                                                                                                           eSerializeType_Float32) kSerializeVar(mfCamAnimPosMaxSpeed,
                                                                                                                                                 eSerializeType_Float32)

                                                                    kSerializeVar(mvHeadSpinSpeed,
                                                                                  eSerializeType_Vector2f)

                                                                        kSerializeVar(mbNoFallDamage,
                                                                                      eSerializeType_Bool)

                                                                            kSerializeVar(
                                                                                mbScriptShowFocusIconAndCrossHair,
                                                                                eSerializeType_Bool)

                                                                                kSerializeVar(
                                                                                    mbLanternOn,
                                                                                    eSerializeType_Bool) kSerializeVar(mbLanternDisabled, eSerializeType_Bool)

                                                                                    kSerializeVar(
                                                                                        mbLanternFlickering,
                                                                                        eSerializeType_Bool) kSerializeVar(mfLanternFlickeringSpeed,
                                                                                                                           eSerializeType_Float32)

                                                                                        kSerializeVar(msDeathHintCat, eSerializeType_String) kSerializeVar(
                                                                                            msDeathHintEntry,
                                                                                            eSerializeType_String)

                                                                                            kSerializeVar(
                                                                                                mbSpawnPSActive,
                                                                                                eSerializeType_Bool) kSerializeVar(mbSpawnPSFile, eSerializeType_String)

                                                                                                kSerializeVar(mbFlashbackActive, eSerializeType_Bool) kSerializeVar(
                                                                                                    mfFlashbackStartCount,
                                                                                                    eSerializeType_Float32)
                                                                                                    kSerializeVar(mfFlashDelay, eSerializeType_Float32) kSerializeVar(
                                                                                                        msFlashbackFile,
                                                                                                        eSerializeType_String)
                                                                                                        kSerializeVar(
                                                                                                            msFlashbackCallback,
                                                                                                            ...
                                                                                                            kSerializeClassContainer(
                                                                                                                ...
                                                                                                                kSerializeVar(
                                                                                                                    mbInfectionCollapse_Active,
                                                                                                                    eSerializeType_Bool)
                                                                                                                    kSerializeVar(
                                                                                                                        mlInfectionCollapse_State,
                                                                                                                        eSerializeType_Int32)
                                                                                                                        kSerializeVar(
                                                                                                                            mfInfectionCollapse_HeightAdd,
                                                                                                                            eSerializeType_Float32)
                                                                                                                            kSerializeVar(
                                                                                                                                mfInfectionCollapse_Roll,
                                                                                                                                eSerializeType_Float32)
                                                                                                                                kSerializeVar(
                                                                                                                                    mfInfectionCollapse_Timer,
                                                                                                                                    eSerializeType_Float32)

                                                                                                                                    kSerializeVar(
                                                                                                                                        mfVoiceFlashback_EffectFadeInTime,
                                                                                                                                        eSerializeType_Float32) kSerializeVar(mfVoiceFlashback_EffectFadeOutTime, eSerializeType_Float32) kSerializeVar(mfVoiceFlashback_SepiaAmount, eSerializeType_Float32) kSerializeVar(mfVoiceFlashback_LightFadeAmount, eSerializeType_Float32) kSerializeVar(mfVoiceFlashback_ImageTrailAmount, eSerializeType_Float32) kSerializeVar(mfVoiceFlashback_BlurStartDistance,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             eSerializeType_Float32)
                                                                                                                                        kSerializeVar(mfVoiceFlashback_BlurAmount, eSerializeType_Float32) kSerializeVar(
                                                                                                                                            mfVoiceFlashback_FovMultiplier,
                                                                                                                                            eSerializeType_Float32)
                                                                                                                                            kSerializeVar(
                                                                                                                                                mfVoiceFlashback_MoveSpeedMultiplier,
                                                                                                                                                eSerializeType_Float32)
                                                                                                                                                kSerializeVar(
                                                                                                                                                    mfVoiceFlashback_MouseSensitivityModifier,
                                                                                                                                                    eSerializeType_Float32)
                                                                                                                                                    kSerializeVar(
                                                                                                                                                        mbVoiceFlashback_IsDelaying, eSerializeType_Bool) kSerializeVar(mbVoiceFlashback_IsPlaying,
                                                                                                                                                                                                                        eSerializeType_Bool) kSerializeVar(mbVoiceFlashback_UseEffects, eSerializeType_Bool) kSerializeVar(mbVoiceFlashback_ObstructMovement,
                                                                                                                                                                                                                                                                                                                           eSerializeType_Bool)
                                                                                                                                                        kSerializeVar(
                                                                                                                                                            msVoiceFlashback_StopSound,
                                                                                                                                                            eSerializeType_String)

                                                                                                                                                            kSerializeVar(
                                                                                                                                                                mfSanity_TimeAtHighInfection,
                                                                                                                                                                eSerializeType_Float32)

                                                                                                                                                                kSerializeVar(
                                                                                                                                                                    mbLookAt_Active,
                                                                                                                                                                    eSerializeType_Bool)
                                                                                                                                                                    kSerializeVar(mvLookAt_TargetPos,
                                                                                                                                                                                  eSerializeType_Vector3f)
                                                                                                                                                                        kSerializeVar(mvLookAt_CurrentSpeed, eSerializeType_Vector3f) kSerializeVar(mfLookAt_SpeedMul, eSerializeType_Float32) kSerializeVar(
                                                                                                                                                                            mfLookAt_MaxSpeed,
                                                                                                                                                                            eSerializeType_Float32)
                                                                                                                                                                            kSerializeVar(
                                                                                                                                                                                msLookAt_AtTargetCallback,
                                                                                                                                                                                eSerializeType_String)
                                                                                                                                                                                kSerializeVar(
                                                                                                                                                                                    mfLookAt_DestFovMul, eSerializeType_Float32) kSerializeVar(mfLookAt_Fov,
                                                                                                                                                                                                                                               eSerializeType_Float32) kSerializeVar(mfLookAt_FovSpeed, eSerializeType_Float32) kSerializeVar(mfLookAt_FovMaxSpeed,
                                                                                                                                                                                                                                                                                                                                              eSerializeType_Float32)
                                                                                                                                                                                    ...
                                                                                                                                                                                    kSerializeVar(
                                                                                                                                                                                        ...
                                                                                                                                                                                        kSerializeVar(
                                                                                                                                                                                            mvCameraAngles, eSerializeType_Vector3f)

                                                                                                                                                                                            kSerializeVar(mfPitchMaxLimit,
                                                                                                                                                                                                          eSerializeType_Float32) kSerializeVar(mfPitchMinLimit, eSerializeType_Float32) kSerializeVar(mfYawMaxLimit, eSerializeType_Float32) kSerializeVar(mfYawMinLimit,
                                                                                                                                                                                                                                                                                                                                                            eSerializeType_Float32)
...
kBeginSerializeBase(cLuxSaveGame_SaveData) kSerializeVar(msMapFolder, eSerializeType_String)
    kSerializeVar(mMap, eSerializeType_Class)
        ...
        kSerializeVar(mInventory, eSerializeType_Class) kSerializeVar(mJournal, eSerializeType_Class)
            kSerializeVar(mPlayer, eSerializeType_Class) kSerializeVar(mMusicHandler, eSerializeType_Class)
    ...
    kSerializeVar(mLoadScreenHandler, eSerializeType_Class) kSerializeVar(mSoundManager, eSerializeType_Class)
