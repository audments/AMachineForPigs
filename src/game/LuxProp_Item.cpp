...
kBeginSerialize(cLuxProp_Item_SaveData, iLuxProp_SaveData) kSerializeVar(msVal, eSerializeType_String)
    kSerializeVar(msExtraVal, eSerializeType_String) kSerializeVar(mlSpawnContainerID, eSerializeType_Int32)
        kSerializeVar(mfAmount, eSerializeType_Float32) kSerializeVar(msSubItemTypeName, eSerializeType_String)
            kEndSerialize()
...
void cLuxProp_Item::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
