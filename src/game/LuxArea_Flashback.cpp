...
kBeginSerialize(cLuxArea_Flashback_SaveData, iLuxArea_SaveData) kSerializeVar(msFlashbackFile, eSerializeType_String)
    kSerializeVar(msCallback, eSerializeType_String) kEndSerialize()
...
iLuxEntity_SaveData *cLuxArea_Flashback::CreateSaveData() { return hplNew(cLuxArea_Flashback_SaveData, ()); }
...
void cLuxArea_Flashback::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
