...
void cLuxPlayerHands::PostUpdate(float afTimeStep) { UpdatePlayerHandsPos(afTimeStep); }
...
bool cLuxPlayerHands::AnimOver() { return mpHandsEntity->AnimationIsOver(msCurrentAnim); }
...
void cLuxPlayerHands::SetState(eLuxHandsState aState) { mHandState = aState; }
