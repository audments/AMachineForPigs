...
void cLuxAreaLoader_SlimeDamage::LoadVariables(iLuxArea *apArea, cWorld *apWorld) {
    ...
    pFlashArea->mfCheckCollisionCount =
        cMath::RandRectf(pFlashArea->mfMinCheckAttackTime, pFlashArea->mfMaxCheckAttackTime);
...
kBeginSerialize(cLuxArea_SlimeDamage_SaveData, iLuxArea_SaveData)
    ...
    kSerializeVar(mlSlimeType, eSerializeType_Int32)
        ...
        kSerializeVar(mfMinCheckAttackTime, eSerializeType_Float32) kSerializeVar(mfMaxCheckAttackTime,
                                                                                  eSerializeType_Float32)
            kSerializeVar(mbDisableAfterAttack, eSerializeType_Bool) kSerializeVar(msCallback, eSerializeType_String)

                kSerializeVar(mfCheckCollisionCount, eSerializeType_Float32)

                    kSerializeVar(msAttackSound, eSerializeType_String) kSerializeVar(msAttackPS, eSerializeType_String)
...
iLuxEntity_SaveData *cLuxArea_SlimeDamage::CreateSaveData() { return hplNew(cLuxArea_SlimeDamage_SaveData, ()); }
...
void cLuxArea_SlimeDamage::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
