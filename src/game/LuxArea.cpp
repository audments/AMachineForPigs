...
bool iLuxArea::CanInteract(iPhysicsBody *apBody) { return false; }

//-----------------------------------------------------------------------

bool iLuxArea::OnInteract(iPhysicsBody *apBody, const cVector3f &avPos) { return false; }
...
iEntity3D *iLuxArea::GetAttachEntity() { return mpBody; }
...
kBeginSerializeVirtual(iLuxArea_SaveData, iLuxEntity_SaveData) kSerializeVar(mvSize, eSerializeType_Vector3f)
    kSerializeVar(m_mtxTransform, eSerializeType_Matrixf) kSerializeVar(mvRelativeOffset, eSerializeType_Vector3f)
        kSerializeVar(msPropName, eSerializeType_String) kSerializeVar(mlBodyId, eSerializeType_Int32) kEndSerialize()
