...
bool cLuxArea_Script::OnInteract(iPhysicsBody *apBody, const cVector3f &avPos) { return msInteractCallback != ""; }
...
kBeginSerialize(cLuxArea_Script_SaveData, iLuxArea_SaveData) kSerializeVar(mbItemInteraction, eSerializeType_Bool)
    kEndSerialize()
...
iLuxEntity_SaveData *cLuxArea_Script::CreateSaveData() { return hplNew(cLuxArea_Script_SaveData, ()); }
...
void cLuxArea_Script::SetupSaveData(iLuxEntity_SaveData *apSaveData) { super_class::SetupSaveData(apSaveData); }
