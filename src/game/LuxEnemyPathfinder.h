...
class cLuxEnemyPathfinder {
  ...
  public:
    ...
    cAINode *GetNodeAtPos(const cVector3f &avPos, float afMinDistance, float afMaxDistance, bool abGetClosest,
                          bool abPosToNodeFreePathCheck, bool abEnemyToNodeFreePathCheck, cAINode *apSkipNode,
                          int alFreePathRayNum = -1, tAIFreePathFlag alFreePathFlags = eAIFreePathFlag_SkipDynamic,
